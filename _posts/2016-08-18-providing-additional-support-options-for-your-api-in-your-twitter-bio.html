...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/Mailjet___mailjet____Twitter.png
---

<p><a href="https://twitter.com/mailjet/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/Mailjet___mailjet____Twitter.png" alt="" width="30%" align="right" /></a>
...
<p><a href="https://www.mailjet.com/">Mailjet</a> provides links to their status page, as well as a link where you can submit a trouble ticket in their Twitter bio. I would consider their Twitter bio pretty well crafted with the first half explaining what they do(for new users), and the second half providing information on how to get support(for existing users). It is a subtle, positive thing that all API providers should consider doing--thanks for the lead Mailjet.
