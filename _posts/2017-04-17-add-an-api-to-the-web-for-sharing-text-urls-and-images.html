...
image: http://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/share_mobile_web_native.png
---

<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/share_mobile_web_native.png" alt="" width="40%" align="right" />
...
<p>While monitoring the API space I came across "<a href="https://github.com/WICG/web-share">a proposal to add an API to the web for sharing text, URLs and images to an arbitrary destination of the user's choice</a>":
<p style="padding-left: 30px;"><em><a href="https://github.com/WICG/web-share">Web Share</a>&nbsp;is a proposed web API to enable a site to share data (text, URLs, images, etc) to an arbitrary destination of the user's choice. It could be a system service, a native app or another website. The goal is to enable web developers to build a generic "share" button that the user can click to trigger a system share dialog.</em>
<p><em>&nbsp;</em>The current options for sharing content from a web page are:
<ol>
...
<p><a href="https://github.com/WICG/web-share">Web Share</a> provides a pretty simple, yet useful example for sharing links. I'm adding it to <a href="http://embeddable.apievangelist.com/tools/">tmy toolbox for my embeddable research</a>. Once I gather a variety of other tools and standards I will step back to look at the 100K view. I'm hoping to stimulate a more embeddable approach to conversational interfaces, something that us asynchronous antisocial folk can work with, going beyond just voice, and messaging.&nbsp;
