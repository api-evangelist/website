...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-version.png" alt="" width="20%" align="right" />
...
<p>When it comes to their REST APIs Google puts the version in URL, and I'm still learning more about their approach to how it's applied to the proto package for gRPC APIs. They also have some good advice when it comes to what is breaking and non-breaking changes.
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-broken-gears.png" alt="" width="35%" align="right" />
<p>Backwards-compatible (non-breaking) changes:
<ul>
...
<p>Backwards-incompatible (breaking) changes:
<ul>
