...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/singly-logo-horizontal.png
---

<p><a title="Singly" href="https://singly.com" target="_blank"><img src="https://s3.amazonaws.com/kinlane-productions2/singly/Singly-Personal-Data-Explorer.png" alt="" width="200" align="right" /></a>
...
<p>Before diving in, let me start with the basics.  What is <a title="Singly" href="https://singly.com" target="_blank">Singly</a>?
...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/github/github-logo.png" alt="" width="120" align="right" />
...
<p><img style="display: block; margin-left: auto; margin-right: auto;" src="https://s3.amazonaws.com/kinlane-productions2/singly/Singly-App-Management.jpg" alt="" width="500" />
<p>Now I have a single API for accessing all six social APIs.  Singly provides consistent endpoints across these services:
<ul class="mainlist">
...
<p>Of course the objects you can work with across all of them aren&rsquo;t the same, as they can be very different services, but the patterns are consistent and Singly standardizes the authentication and objects as much as possible across all APIs.
<p>The first authentication and code library for Facebook took me about 10 minutes.  Then after that I was able to reuse my code and had all five other services up and running in another 10 minutes.
...
<p>I will be exploring this same approach, using the other blogging, productivity and quantified self services Singly offers.  I just wanted to get started with the social APIs, and begin wrapping my head around more efficient API development using a unified API like Singly.
