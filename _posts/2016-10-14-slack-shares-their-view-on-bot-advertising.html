...
image: http://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/1_z2iwyx5ebaipra4gsrrljw.png
---

<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/1_z2iwyx5ebaipra4gsrrljw.png" alt="" width="50%" align="right" />
...
<p class="graf graf--p graf-after--p">Here was Slack's view on advertising with bots by developers:
<p class="graf graf--p graf-after--p" style="padding-left: 30px;"><em>A bot should not serve ads unless it has a strong, expressed purpose that benefits the user in doing so, and even then only on B2C platforms. I would hate to see bots becoming the new tracking pixel. Bots should not be prompting users to click on things and buy things unless explicitly asked to do so.</em>
...
<p class="graf graf--p graf-after--p">From what I can tell, bot monetization will either be about mining data from users,&nbsp;paying for premium features, or a little of both. I'm still a few weeks off from having more examples of how the bots are generating revenue, but I wanted to make sure I recorded Slack's stance on the subject, for reference in future work.
