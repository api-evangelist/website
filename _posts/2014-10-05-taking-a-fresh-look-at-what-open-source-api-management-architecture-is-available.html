...
<p><img style="padding: 10px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-open.png" alt="" width="150" align="right" />
...
<p>Originally there is just one player on the space who was completely open source, and that is WSO2:
<table style="padding-left: 25px;" cellpadding="2" width="90%">
<tbody>
<tr>
<td width="100"><a href="http://wso2.com/"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/company/wso2-logo-white-800X360.jpg" alt="" width="100" align="center" /></a></td>
...
<p>I&rsquo;d call API Grove, enterprise fire sale open source, and while the code is out there (I think), there is nobody home, not an enterprise, or other community to be seen. This type of open source releases just make me sad.
<p>After WSO2 and API Grove, the only other player that saw emerg on the scene was ApiAxle:
<table style="padding-left: 25px;" cellpadding="2" width="90%">
<tbody>
<tr>
<td width="100"><a href="http://apiaxle.com/"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/company/logos/api-axle-logo-3.png" alt="" width="100" align="center" /></a></td>
...
<p>Beyond ApiAxle, there are two API management pioneers who been hard at work releasing open source tooling:
<table style="padding-left: 25px;" cellpadding="2" width="90%">
<tbody>
<tr>
<td width="100"><a href="https://www.3scale.net/api-management/api-proxy-for-api-traffic-management-by-3scale/"><img style="display: block; margin-left: auto; margin-right: auto;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/serviceproviders/3scale-logo.jpg" alt="" width="110" align="center" /></a></td>
<td>3Scale is one of the original API infrastructure providers, and has developed an <a href="https://www.3scale.net/api-management/api-proxy-for-api-traffic-management-by-3scale/">open source API proxy using the NGINX Web Server</a>, designed to work independently, but also be able to take advantage of freemium 3Scale API analytics, billing, etc.</td>
</tr>
<tr>
<td width="100"><a href="https://github.com/apigee-127/volos"><img style="display: block; margin-left: auto; margin-right: auto;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/serviceproviders/apigee-logo.gif" alt="" width="90" align="center" /></a></td>
...
<p>It can be hard to envision exactly how open source fits into 3Scale or Apigee&rsquo;s business model, but as the core features of API management become more commoditized, I can't help but think that open source tooling will increasingly be a reality on the front-line for these API infrastructure providers.
<p>After these projects from leading API management providers, I hadn't see any other open source API management tooling until I started to look closer at APIs in the public sector:
<table style="padding-left: 25px;" cellpadding="2" width="90%">
<tbody>
<tr>
<td width="100"><a href="http://www.socrata.com/products/open-data-portal/"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/serviceproviders/socrata_logo.jpg" alt="" width="100" align="center" /></a></td>
...
<tr>
<td width="100"><a href="https://nrel.github.io/api-umbrella/"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/company/logos/api-umbrella-logo.png" alt="" width="100" align="center" /></a></td>
<td><a href="https://nrel.github.io/api-umbrella/">API Umbrella</a> was born out of the National Renewable Energy Laboratory (NREL) to manage their own APIs, but then has evolved to be used by other agences, as well as being adopted by central data.gov efforts within the federal government.&nbsp;<span>API Umbrella is a proxy that sits in front of your APIs. It can seamlessly add common functionality like api keys, rate limiting, and analytics to any API.</span></td>
</tr>
</tbody>
</table>
...
<p>In doing this research, what has really caught my attention, is the number of new players that are picking up momentum in 2014:
<table style="padding-left: 25px;" cellpadding="2" width="90%">
<tbody>
<tr>
<td width="100"><a href="http://openrepose.org/"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/company/logos/repose-logo.png" alt="" width="100" align="center" /></a></td>
...
<tr>
<td width="100"><a href="https://tyk.io/"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/company/logos/tyk-dark.png" alt="" width="100" align="center" /></a></td>
<td><a href="https://tyk.io/">Tyk is an open source, lightweight, fast and scalable API gateway</a>. Set rate limiting, request throttling, and auto-renewing request quotas to manage how your users access your API. Tyk supports access tokens, HMAC request signing, basic authentication and OAuth 2.0 to integrate old and new services easily.</td>
</tr>
<tr>
<td width="100"><a href="http://www.gluu.org/"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/company/logos/gluu-logo.png" alt="" width="100" align="center" /></a></td>
...
<tr>
<td width="100"><a href="https://strongloop.com/node-js/loopback/"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/company/logos/strongloop-logo.png" alt="" width="100" align="center" /></a></td>
<td><a href="https://strongloop.com/node-js/loopback/">Loopback is an open source API framework</a> powered by Node for quickly creating APIs. Node is good for getting projects done quickly, leveraging the broad knowledge of JavaScript, and to scale to the concurrency that is well suited for web APIs.</td>
</tr>
</tbody>
</table>
...
<p>What else am I msising from the pool of open source API management tooling? I depend on my audience letting me know what they are using.
...
<p><strong>Disclosure:</strong><em> 3Scale and WSO2 are both API Evangelist partners.</em>
