...
image: http://kinlane-productions2.s3.amazonaws.com/ebay/ebay-developer-program-history.png
---

<img style="padding: 10px;" src="https://kinlane-productions2.s3.amazonaws.com/ebay/ebay-developer-program-history.png" alt="" width="250" align="right" />We hear a lot of talk about companies that were pioneers in the API space.  In an ongoing series we want to try to document the story behind these pioneers, and we are calling it History of APIs.<p>
...
Flickr was the clear leader in redefining what APIs could be used for, and establishing the <a class="zem_slink" title="Representational State Transfer" rel="wikipedia" href="https://en.wikipedia.org/wiki/Representational_State_Transfer">RESTful</a> movement with their dead simple API.<p>
The next major players in the social period were:
<img style="padding: 10px;" src="https://kinlane-productions2.s3.amazonaws.com/flickr/flickr-beta.png" alt="" width="250" align="right" />
<ul class="mainlist">
...
There are definitely other players in the social API period, but <a href="https://www.twitter.com" target="_blank">Twitter</a> and <a href="https://www.facebook.com" target="_blank">Facebook</a> obviously have come out as the clear leaders.<p>
