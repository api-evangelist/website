...
url: 'http://apievangelist.com/2013/04/14/reclaim-your-domain/'
image: 'http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/blog/person-spider-web.jpg'
---

<img src="https://s3.amazonaws.com/kinlane-productions/reclaimyourdomain/person-spider-web.jpg" alt="" width="275" align="right" />

Obligatory spider web photo, because Jim and Audrey did too!

The ability for me to own [kinlane.com][1], point it at a server, host a website and a blog has been an critical part of my online world and professional career for over 12 years now. My blog goes back to June of 2007, but I have had a site and portfolio up there since around 2000. Having control over my domain has enabled me to store years of my writing, research and projects in a central location that I have control over, allowing me to land jobs, contracts or evolve into entirely new domains that have expanded my audience in ways I never imagined, like with [API Evangelist][2].

Anytime I can teach this approach to someone else and empower them to own their own domain, I’ve jumped at the chance, resulting in numerous individuals who have their own thriving domains--including my girlfriend [Audrey Watters][3] with her blog [Hack Education][4]. Understanding what is necessary to purchase, own and manage your domain, servers, sites, applications and other portions of our digital lives is something everyone should do! But be careful, you just might change the world, and make a significant impact like Audrey ([@audrewyatters][5]) has.

<img class="c1" src="https://s3.amazonaws.com/kinlane-productions/reclaimyourdomain/mit-media-lab-phillip.jpg" alt="" width="200" align="right" />

Last weekend while at MIT, I had a chance to work on a project that takes this concept of owning your domain and looks to make it an educational resource anyone can take advantage of. I ended up at the MIT Media Lab after being summoned for an [open learning hackathon][6] by MIT and Phillip Schmidt ([@schmidtphi][7]) of [P2PU][8].  During the event I had the pleasure of plotting and scheming with infamous technology educator Jim Groom ([@jimgroom][9]) and education rabble rouser Audrey Watters on an [idea Jim brought with him][10], that was born out of the [University of Mary Washington Domain of One's Own Project][11].

<img class="c1" src="https://s3.amazonaws.com/kinlane-productions/reclaimyourdomain/kin-jim-brainstorming.jpg" alt="" width="200" align="right" />
...
Right now the #ReclaimYourDomain Hub will run as stand-alone service at [reclaimyourdomain.org][12], but eventually it will be available for anyone to deploy on any server. The #ReclaimYourDomain Hub will start with a simple home and about page, but focus on a simple wizard that will walk an individual through purchasing and setting up their own online domain.
...
[<img src="http://farm1.staticflickr.com/174/424399237_b60c7e1732.jpg" alt="Sir Edmund Hilary - Mount Cook" width="225" align="right" />][16]
...
[<img class="c2" src="https://s3.amazonaws.com/kinlane-productions/reclaimyourdomain/puzzle-cloud-services.png" alt="" width="325" align="right" />][17]
...
[<img class="c2" src="https://s3.amazonaws.com/kinlane-productions/fist.png" alt="" width="200" align="right" />][17]

Currently Jim, Audrey and I have a mocked up version of [#ReclaimYourDomain Hub][18] and a [#ReclaimYourDomain domain site][19].  All the buttons and lnks work, so make sure and click around to see it in action.  I need to gather my thoughts from the project, then I will be publishing all #ReclaimYourDomain code and a framework for planning via Github.
...
Stay tuned for more on #ReclaimYourDomain, and if you’d like to get involved feel free to [contact me][20] directly or stay tuned and I’ll have the Github project up shortly.

   [1]: /admin/blog/kinlane.com
   [2]: http://apievangelist.com
   [3]: http://audrewyatters.com (Audrey Watters)
   [4]: http://hackeducation.com (Hack Education)
   [5]: https://twitter.com/audreywatters
   [6]: http://open.media.mit.edu/hackathon.html (open learning hackathon)
   [7]: https://twitter.com/schmidtphi
   [8]: https://p2pu.org/en/
   [9]: https://twitter.com/jimgroom
   [10]: http://bavatuesdays.com/a-domain-of-ones-own-to-community-syndication-hubs/
   [11]: http://umwdomains.com/
   [12]: http://reclaimyourdomain.org (reclaimyourdomain.org)
   [13]: http://hackeducation.com/2013/04/11/reclaim-your-domain/
   [14]: http://bavatuesdays.com/reclaim-open-learning/
   [15]: http://fineartamerica.com/featured/4-brain-design-by-cogs-and-gears-setsiri-silapasuwanchai.html (Brain Gears)
   [16]: http://www.flickr.com/photos/vanchett/424399237/ (Sir Edmund Hilary - Mount Cook by Vanessa (EY), on Flickr)
   [17]: http://reclaimyourdomain.org (Reclaim)
   [18]: http://reclaimyourdomain.org/
   [19]: http://template.reclaimyourdomain.org/
   [20]: http://kinlane.com/contact/
