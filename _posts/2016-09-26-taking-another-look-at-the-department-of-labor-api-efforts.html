...
image: http://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/developer_dol_gov__united_states_department_of_labor_developer_portal.png
...
<p>The vibe when you land on <a href="http://developer.dol.gov">developer.dol.gov</a> (which is a great subdomain) is nice. It is clean&nbsp;and has all the links that I am looking for, providing access to their APIs, as well as supporting code, while allowing you to ask questions and report bugs.
<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/developer_dol_gov__united_states_department_of_labor_developer_portal.png" alt="" width="100%" />
<p>One thing I think is interesting in their approach is that they efficiently <a href="http://developer.dol.gov/sdk/">use Github in support of their code</a>, apply <a href="https://opendata.stackexchange.com/questions/ask?tags=labor">Stack Exchange in support of asking questions</a>, and <a href="https://github.com/USDepartmentofLabor/Developer/issues/new">employ Github issues for reporting bugs</a>. I understand that government agencies do not always have the resources necessary to support their API efforts, so this approach seems sensible to me when providing the minimum viable support for an API.
<p>The Department of Labor provides a number of APIs which provide access to some key economic data, broken down into four separate categories
<ul>
...
<li><strong><a href="http://developer.dol.gov/health-and-safety/dol-osha-compliance">OSHA Compliance</a></strong> - Inspection case detail for approximately 100,000 OSHA inspections conducted annually.</li>
...
<li><strong><a href="http://developer.dol.gov/others/vets100">VETS100</a></strong> - Required veteran employment data by federal contractors/subcontractors.</li>
