...
image: https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-evangelism-bubble.png
---

<p><a href="http://evangelism.apievangelist.com/"><img src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-evangelism-bubble.png" alt="" width="250" align="right" /></a>
...
<p>Wait...before we got going with a 101 API evangelism list, let's make sure the most essential element is present?
<ul>
<li><strong>Value</strong>&nbsp;- Check! Encryption for all your data in this climate is critical.</li>
</ul>
<p class="p2">Now, let's make sure the minimum viable&nbsp;<a href="http://management.apievangelist.com/building-blocks.html">API management building blocks</a>&nbsp;are in place to support evangelism efforts:
<ul>
...
<li><strong>Twitter -</strong>&nbsp;Check. SecureDB is available via an&nbsp;<a href="https://twitter.com/securedb">active Twitter account.</a></li>
</ul>
</li>
...
<p class="p2">With this base, now I can explore some initial&nbsp;<a href="http://evangelism.apievangelist.com/building-blocks.html">API evangelism building blocks</a>&nbsp;SecureDB can think about:
<ul>
