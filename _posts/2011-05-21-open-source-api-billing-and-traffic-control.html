...
image: http://kinlane-productions2.s3.amazonaws.com/google/Google-APIs-Console-1.png
---

<img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/google/Google-APIs-Console-1.png" alt="" width="350" align="right" />I was writing a story for <a title="ProgrammableWeb" href="http://www.programmableweb.com">ProgrammableWeb</a> tonight on the enhancements Google made recently to its API console.<p>
I hadn't properly covered the <a title="API Console" href="https://code.google.com/apis/console/">API Console</a>, <a title="API Explorer" href="https://code.google.com/apis/explorer/">API Explorer</a> here on <a title="API Evangelist" href="http://www.apievangelist.com">API Evangelist</a>, so I took the time, played with more, and wrote up overviews for each.<p>
...
Google is taking a similar approach to managing their APIs, as <a title="Apigee" href="https://www.apigee.com">Apigee</a>, <a title="Mashery" href="http://www.mashery.com">Mashery</a>, and <a title="3Scale" href="http://www.3Scale.net">3Scale</a> does for other API providers.<p>
...
And Apigee has one other piece that Mashery and 3Scale do not.  They have an <a title="API Explorer" href="https://apigee.com/about/products_togo.html">API Explorer</a>.<p>
<a title="Google provides an API explorer" href="http://blog.apievangelist.com/2011/05/21/google-apis-explorer/">Google provides an API Explorer</a>, and they have open sourced the code, and <a title="made it available at Google Code" href="https://code.google.com/p/google-apis-explorer/">made it available at Google Code</a>.<p>
