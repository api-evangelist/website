...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist/imgtocss/IMG-to-API-Conversion.png
---

<a href="http://www.imgtocss.com/" target="_blank"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/imgtocss/IMG-to-API-Conversion.png" alt="" align="right" /></a>The <a href="http://www.imgtocss.com/" target="_blank">IMG to CSS API</a> lets you convert images to html/css using a RESTful interface, with API keys for authentication, and responses in JSON and XML.<p>
