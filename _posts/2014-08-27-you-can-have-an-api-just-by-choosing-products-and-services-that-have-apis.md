...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-api-hold.png" alt="" width="250" align="right" />
<p>When it comes to APIs, the quickest way to get an API for your company, organization or government agency is to choose to only use online services that have APIs. Twitter, Facebook, Google, Dropbox, Github, Instagram, Flickr, and many other popular services you already use, all have APIs.
...
<p>We talk about APIs in the context of developers, using APIs to build applications for end-users, and provide system integrations. What if we talked about it in context of the users, and helping individual users aggregate their APIs into a single, personal API stack?
