...
image: https://s3.amazonaws.com/kinlane-productions2/algo-rotoscope/stories/containership_blue_circuit.jpg
---

<p><img src="https://s3.amazonaws.com/kinlane-productions2/algo-rotoscope/stories/containership_blue_circuit.jpg" align="right" width="45%" style="padding: 15px;" />
...
<p>This project reminded me that I need to make sure and add a reminder to pick my head up each week and spend time aggregating vendor extensions from across the API space. <a href="http://openapi.toolbox.apievangelist.com/">I have a section dedicated to them in my OpenAPI toolbox</a>, but I haven’t added anything to it recently. OpenAPI Vendor extensions are an important way to learn about how companies are extending the specification, and similar to what I’m doing for this individual project, it is important to aggregate and organize them so people in the community can learn from them, and reuse them whenever possible.
