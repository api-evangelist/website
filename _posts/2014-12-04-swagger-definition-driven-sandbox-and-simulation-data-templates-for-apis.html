...
<p><img src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-sandbox.png" alt="" width="250" align="right" />
<p>This is something I&rsquo;ve written about before in <a href="http://apievangelist.com/2014/11/05/api-sandbox-and-simulator-from-carvoyant/">API Sandbox And Simulator From Carvoyant</a>, and <a href="http://apievangelist.com/2013/05/24/salesforce-adds-sandbox-templates/">Salesforce Adds Sandbox Templates</a>. However it is something I&rsquo;d like to formalize, and get some new API service providers helping out in this area, or encourage the development of open source solutions.
<p>API service providers like <a href="https://apiary.io/">Apiary</a> and <a href="https://smartbear.com/">SmartBear</a> are providing some very interesting solutions for mocking, and virtualizing APIs from API Blueprint, Swagger, and RAML. What I would like to see is the emergence of standalone solutions, providing data sets templates, or whatever you want to call it for populating mock APIs for testing, and integration.
