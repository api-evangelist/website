...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/brandwatch-logo.jpeg
---

<p><a href="http://www.brandwatch.com/api/" target="_blank"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/brandwatch-logo.jpeg" alt="" width="200" align="right" /></a>
...
<p>The <a href="http://www.brandwatch.com/api/">Brandwatch API</a> itself isn't that groundbreaking, there are plenty of other social analysis APIs offering similar features, but the fact that it was an API built on top of Gnip, one of the only approved Twitter firehose providers remaining, I found to be interesting.
<p>Gnip is trusted Twitter provider, with firehose access to Twitter data, and Brandwatch is a trusted Gnip partner, providing an API with access to Twitter data. At this point I can't tell if I&rsquo;m in a dream, or a dream within a dream?
