...
<p><img src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-bot-api.png" alt="" width="250" align="right" />
<p>It has been acceptable for integration platform as a service providers (iPaaS) like IFTT and Zapier to focus on delivering the end-solutions that their consumers have needed, and requiring them to visit your domain to discover and then make the magic happen. While I have always been an advocate for more accessibility, I have to admin that the current "closed" approach <span style="text-decoration: underline;">has</span> brought a number of new people to the world of APIs, as people realize that IFTTT and Zapier are possible because of APIs!
