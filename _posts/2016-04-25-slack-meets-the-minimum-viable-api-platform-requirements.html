...
image: https://s3.amazonaws.com/kinlane-productions2/api-evangelist/slack/slack_api_logo.png
---

<p><a href="ps://api.slack.com"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/slack/slack_api_logo.png" alt="" width="200" align="right" /></a>
...
<p>Using my minimum viable API definition, I went through the Slack API portal looking for what I'd consider to be the essential building blocks that any modern API platform should have.
<table width="100%">
<tbody>
<tr>
