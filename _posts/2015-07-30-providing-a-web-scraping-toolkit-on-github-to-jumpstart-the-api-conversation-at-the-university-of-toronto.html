...
<p><a href="https://github.com/cobalt-io/cobalt"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-github.png" alt="" width="200" align="right" /></a>
...
<p>This API project I found, that is dedicated to the University of Toronto is interesting because they identify three target APIs that are being worked on.
<ul class="task-list">
...
<p>While this approach to doing APIs at the higher educational level may not be optimal, sometimes its all we have to stimulate the API discussion on campus, something that we just can't wait for--it needs to be set in motion as soon as possible..
