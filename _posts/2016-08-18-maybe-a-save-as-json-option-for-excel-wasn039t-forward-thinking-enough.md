...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-spreadsheet-to-json.png" alt="" width="30%" align="right" />
<p>In September of 2015, <a href="http://apievangelist.com/2015/09/08/when-are-we-going-to-get-a-save-as-json-in-our-spreadsheets/">I asked when are we going to get a save as JSON in our spreadsheets</a>? I was doing a lot of work saving spreadsheets as CSV files, something I can easily do programmatically, but I was doing it manually as part of a workshop. After I downloaded each CSV file, I then <a href="https://kinlane.github.io/csv-converter/">converted to a JSON file</a>--leaving me asking, "where is the save as JSON"?
