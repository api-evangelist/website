...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/Fed-API-Logo-2.png
---

<p><a href="http://fedapi.com/" target="_blank"><img style="padding: 10px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/serviceproviders/Fed-API-Logo-2.png" alt="" width="200" align="right" /></a>
...
<p>Fed{API} is looking to make government data more accessible and reusable by taking data from multiple sources, some easy to pull and some much more difficult, then collect, correlate and catalog into a single, aggregate API stack that developers can put to use.
<p><a href="http://fedapi.com/" target="_blank"><img style="padding: 10px; display: block; margin-left: auto; margin-right: auto;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/fedapi/fedapi-1.png" alt="" width="500" /></a>
...
<p>Even with the massive challenge ahead, I will be supporting FedAPI 100%, and doing what I can to make sure their initiative is successful. To do so, I think they will have to get two other groups involved:
<ul class="mainlist">
...
<p><a href="http://fedapi.com/" target="_blank"><img style="padding: 10px;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/fedapi/fedapi-capital.png" alt="" width="200" align="right" /></a>
...
<p>One thing I want to lend a hand with, when it comes to FedAPI, is help create the blueprint of which federal agencies already have APIs and open data sets, and where these exists.  I can also be the aggregator of news, analysis and best practices across the federal API landscape.
<p>I'm on board FedAPI, let's make this happen.
