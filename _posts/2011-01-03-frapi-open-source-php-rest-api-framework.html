...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist/FRAPI-REST-API.jpg
---

<img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/FRAPI-REST-API.jpg" alt="" align="right" />FRAPI is an <a href="http://getfrapi.com/" target="_blank">open source RESTful API framework</a> developed in PHP.   It can be used as the backbone of your RESTful web service.<p>
