...
image: http://kinlane-productions2.s3.amazonaws.com/publishing/pearson-publishing-logo.jpg
---

<img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/publishing/pearson-publishing-logo.jpg" alt="" width="250" align="right" />Publisher and ed-tech company Pearson <a title="announced a new initiative to build an API platform" href="http://www.pearson.com/media-1/announcements/?i=1432">announced a new initiative to build an API platform</a> that give developers access to the publisher's content.<p>
Pearson's Plug &amp; Play Platform claims to unlock the company's large content bank which ranges from <a title="Dorling Kindersley (DK) Publishing" href="https://us.dk.com/">Dorling Kindersley (DK) Publishing's</a> illustrated guides to Pearson Education textbooks.<p>
...
Pearson's Future Technologies Group Product Manager, <a title="Diane Stepner" href="https://www.linkedin.com/in/dianas">Diana Stepner</a>, says:
...
Pearson will be running initial platform tests using DK's Eyewitness Travel Guide material, then moving on to a wider range of subjects from science and natural history to gardening, parenting and early learning.<img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/publishing/dk-publishing.gif" alt="" width="175" align="right" /><p>
