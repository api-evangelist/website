...
image: https://s3.amazonaws.com/kinlane-productions2/api-stack/logos/the-api-stack-entities-snapshot.png
---

<p><img src="https://s3.amazonaws.com/kinlane-productions2/api-stack/logos/the-api-stack-entities-snapshot.png" width="45%" align="right" style="padding: 15px;" />
...
<p>I poll an API for at least 24-48 hours, and up to a week or two if possible. I’m looking to understand how large API responses are, and how often they change–taking notice of daily or weekly trends in activity along the way. The result is a set of scores that help me identify:
