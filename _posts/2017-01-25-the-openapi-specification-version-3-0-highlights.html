...
image: http://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/openapi_spec_structural_improvements.png
---

<p><a href="https://www.openapis.org/specification/v3insights"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/openapi_spec_structural_improvements.png" alt="" width="45%" align="right" /></a>
<p>I am impressed with the work that the Open API Initiative (OAI) working group has accomplished with the&nbsp;<a href="https://www.openapis.org/specification/v3insights">version 3.0 release of the OpenAPI Specification</a>. I have had zero involvement in moving the specification forward (something I'm changing), and after coming back to the effort I am impressed with what they've prioritized, and accomplished for this release.&nbsp;
<p>The highlights in version 3.0 of the OpenAPI Spec for me are:
<ul>
...
<p>I am impressed with what the OpenAPI Spec working group has gotten accomplished. I am optimistic about what is possible with OpenAPI Spec in 2017--something I'm going to be investing in heavily.
