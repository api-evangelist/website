...
<p><a href="https://openreferral.org/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/icarol-screenshot.png" alt="" width="40%" align="right" /></a>
...
<p><a name="human-services-data-specification"></a>
<p><strong>Human Services Data Specification (HSDS)</strong>
...
<ul>
<li><strong><a href="https://json-schema.org/">JSON Schema</a></strong>&nbsp;- Establish a set of JSON Schema for HSDS</li>
<li><strong><a href="https://github.com/apiaryio/mson">MSON</a></strong>&nbsp;- Establish a set of MSON definitions for HSDS</li>
</ul>
</li>
</ul>
</li>
<li><strong>Partners</strong>&nbsp;- Link to the Open Referral partner network.</li>
...
<p><a name="the-open-referral-organization"></a>
...
<p>Let's explore what is currently available for the Open Referral organization, and what is needed to help evolve it towards being a platform enabler. Here is what I have outlined so far:
<p><strong>Organizational<br /></strong>There is already a basic web presence for the organization, it just needs a little help to look as modern as it possibly can, and assume the lead role in getting folks aware, and involved with Open Referral and HSDS as possible.
<ul>
<li><a href="https://openreferral.org/">Website</a>&nbsp;- Having a simple, modern web presence for the Open Referral organization.</li>
</ul>
<p>OpenReferral.org is the tip of the platform, but if we want to increase the reach of the organization, and take the conversation to where people already exist, we'll need to think more multi-channel when it comes to the organizational presence.
<p><strong>Communications<br /></strong>There is already a great presence in place, an active blog, Twitter, and Google Group. Based upon the approach of other open formats, and software efforts, there are a number of other platforms we should be looking to spread the Open Referral presence to.
<ul>
...
<p><a href="/admin/blog/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/ohana-api.png" alt="" width="40%" align="right" /></a>
<p><a name="open-referral-demo-portal"></a>
...
<li><strong>Support</strong> 
<ul>
<li><strong>Github Issues -</strong>&nbsp;Provide platform support using Github issues, allowing for public support.</li>
...
<p>Here are some of the main areas I identified that would be be needed to help support core API implementations, as well as some of the web and mobile applications implementations that will use HSDS.
<ul>
...
<ul>
<li><strong>Swagger UI</strong>&nbsp;- An open source, interactive JavaScript UI for OpenAPI Spec.</li>
...
<p><strong>Open Definitions<br /></strong>HSDS is an open definition, built on the back of, and supporting other existing open definition formats. Let's showcase this heart of what Open Referral, and HSDS is, by providing an update to date list of all open definition formats, and standards in use.
<ul>
...
<li><strong>Schema.org</strong>&nbsp;- Civic Services Schema (<a href="https://www.w3.org/wiki/WebSchemas/CivicServices">at the W3C</a>)</li>
<li>The National Information Exchange Model - via<a href="https://www.acf.hhs.gov/initiatives-priorities/interoperability">&nbsp;the National Human Services Information Architecture</a>&nbsp;- logic model<a href="http://https//raw.github.com/hserv/open-human-services/master/doc/NHSIA_conceptual_data_model.jpeg">&nbsp;here</a>.</li>
</ul>
...
<p><a name="platform-monetization"></a>
...
<li><strong>Partners</strong>&nbsp;- What partnerships have been established as part of operations.</li>
...
<p><img src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/open-referral/pricing-mapbox.png" alt="" width="100%" />
<p><a name="platform-api-plans"></a>
...
<p><strong>Resources<br /></strong>These are mostly the resources that currently exist on the public website, but I wanted to also make sure and provide other details about the organization, the team behind the efforts. &nbsp; These are a few other resources that shouldn't be forgotten.
<ul>
...
<p><a href="http://ohanapi.org/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/icarol-screenshot.png" alt="" width="40%" align="right" /></a>
