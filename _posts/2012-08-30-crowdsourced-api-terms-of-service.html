...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/developer-rights.jpeg
---

<p><img src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/terms-of-service/developer-rights.jpeg" alt="" width="150" align="right" />
...
<p>To seed the process, we went out and reviewed a number of the popular API terms of service and identified seven categories that really affect developers:
<ul class="mainlist">
<li>Business model (include pricing, rate limits and quotas)</li>
<li>Terms change conditions</li>
<img style="display: block; margin-left: auto; margin-right: auto;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/terms-of-service/API-Terms-of-Service-Didnt-Read.png" alt="" width="300" align="right" />
