...
<p><a href="http://www.database.com/es/howitworks"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/salesforce/Database-Com-Open.png" alt="" width="300" align="right" /></a>
<p>I&rsquo;m working on reviewing various APIs as part of my <a title="database industry overview" href="/industries/databases.php">database industry overview</a>, where I&rsquo;m trying to understand the different approaches to delivering database platforms using web APIs as the primary interface.
...
<p>Anyone has access to use and contribute to Freebase, as well as use any programming language or platform to access the data available on the platform.  Access to data is only one aspect of "open", developers must also be freely open to use and contribute to it, as the community sees fit.
<p>As much as I love and evangelize the power of the API, an API alone does not make systems or data open.
