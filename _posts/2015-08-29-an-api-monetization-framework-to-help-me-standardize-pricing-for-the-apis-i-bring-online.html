...
<p><a href="http://monetization.apievangelist.com/"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-api-monetization.png" alt="" width="250" align="right" /></a>
<p>I'm almost to the point with <a href="https://kin-lane.github.io/master/">my API stack</a>, where I can start plugging in new APIs I have planned. Up until now, the APIs i have deployed, are of little use to a wider commercial audience. However some of the APIs I have planned for the next year, I'm looking to monetize their usage, and operate as part of a larger commercially viable API stack. (practice what I preach baby!)
<p>To run this stack, I need a plug and play way to define what an API is costing me, and potentially how much revenue I am generating from each API. With this in mind, here is my draft look at an API monetization framework, that I am employing across my API Stack.&nbsp;
<p><strong>Acquisition</strong> (One Time or Recurring)
<p><strong> </strong>
<ul>
<strong> </strong> 
</ul>
...
<p><strong>&nbsp;Development</strong> (One Time or Recurring)<strong>&nbsp;</strong>
<ul>
...
<p><strong><strong><strong>Operation</strong></strong></strong> (Recurring)
<ul>
...
<p><strong><strong><strong><strong>Pricing </strong></strong></strong></strong>(Recurring)
<ul>
...
<p><strong><strong><strong><strong>Revenue </strong></strong></strong></strong>(Recurring)
<ul>
...
<p>As with most of my work, I'm going to be very transparent about my pricing, making sure it is indexed within each APIs.json file, and available alongside each APIs Swagger, API Blueprint, Postman Collection, and API Science monitor--encouraging wider consumption, and processing.
<ul>
<strong><strong><strong> </strong></strong></strong> 
</ul>
