...
<p><a href="http://low.hanging.fruit.apievangelist.com/"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-grapes.png" alt="" width="150" align="right" /></a>
...
<p>P.S. Please make sure you have the legal right to spider the website in this way. I'm only looking to consider the low hanging fruit of your own organization, ad better understand how to jumpstart an official API effort -- we are just doing this from the outside-in.
