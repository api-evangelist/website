...
image: https://s3.amazonaws.com/kinlane-productions2/intrinio/intrinio-app-showcase.png
---

<p>I am profiling financial market data APIs currently, and as I’m doing my work profiling APIs, I’m always on the hunt for interesting elements of their API operations that I can showcase for my readers. While looking at the financial market data API from Intrinio, I found that <a href="https://intrinio.com/marketplace/apps">I really, really like their application showcase</a>, which providers a pretty attractive blueprint for how we can showcase what is being develop on top of our APIs.

<p>The Intrinio application showcase is just clean looking, and has the bells and whistles you’d expect like categories, search, detail or list view, and detail pages providing you all the information you need about the application, and where you can find tutorials, code, and other relevant resources.

<p align="center"><a href="https://intrinio.com/marketplace/apps"><img src="https://s3.amazonaws.com/kinlane-productions2/intrinio/intrinio-app-showcase.png" /></a>
