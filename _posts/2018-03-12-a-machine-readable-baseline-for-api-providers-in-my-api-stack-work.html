...
<p><img src="https://s3.amazonaws.com/kinlane-productions2/api-definitions-api-stack.png" width="45%" align="right" style="padding: 15px;" />
...
<p>Each repository contains three main API definitions, using <a href="https://github.com/api-stack-providers/paralleldots">the ParallelDots machine learning API</a> as an example:
