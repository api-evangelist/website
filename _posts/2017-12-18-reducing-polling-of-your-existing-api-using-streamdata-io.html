...
image: https://s3.amazonaws.com/kinlane-productions2/streamdata/cloud-architecture-1024x519.png
---

<p><a href="https://streamdata.io"><img src="https://s3.amazonaws.com/kinlane-productions2/streamdata/cloud-architecture-1024x519.png" align="right" width="45%" style="padding: 15px;" /></a>
<p><a href="https://streamdata.io">I’ve partnered with Streamdata.io</a>, resulting in me getting more acquainted with their API solutions, and telling the story of that process here on API Evangelist. I figured I would dive right in and start with the basics of what Streamdata.io does–turning your existing web API into a real-time stream. Streamdata.io acts as a reverse proxy that translates REST API polling into a stream of data. Instead of constantly polling your API for changes, your API clients will poll Streamdata.io and get a <a href="https://tools.ietf.org/html/rfc6902">JSON Patch update</a> if anything has changed, and reducing the impact of the requests your clients will make to your API.
...
<p><em><strong>Disclosure:</strong> <a href="https://streamdata.io">Streamdata.io</a> is the primary partner for the API Evangelist website.</em>
