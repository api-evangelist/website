...
image: http://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/portal_screenshot.jpg
---

<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/portal_screenshot.jpg" alt="" width="45%" align="right" />
...
<p>In the short term, the goals are to engage these groups around the API resources:
<ul>
...
<p>While incentivizing the following things between engaged stakeholders:
<ul>
...
<p>Next, I want to make sure <a href="http://portal.minimum.apievangelist.com/">my minimum viable API portal definition</a> speaks to the widest possible audience, and not just to developers. Then I will get to work on setting up the first version of the portal for use in this API project, and we'll consider what's next.
