...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/Intel-IESG-Logo.png
---

<p><a title="REST Web Services &amp; API Security" href="http://cloudsecurity.intel.com/solutions/rest-web-services-api-security"><img src="https://s3.amazonaws.com/kinlane-productions2/api-service-providers/intel/Intel-IESG-Logo.png" alt="" align="right" /></a>
<p>When it comes to <a title="API Service Providers" href="http://apievangelist.com/2012/06/15/api-service-provider-roundup-for-2012/">API service providers</a>, there is one brand that I would say is widely known, but when we are talking about APIs, often gets overlooked.  That company is Intel.
...
<p>The Intel REST Web Services Gateway provides:
<ul class="mainlist">
...
<p><a title="REST Web Services &amp; API Security" href="http://cloudsecurity.intel.com/solutions/rest-web-services-api-security"><img style="display: block; margin-left: auto; margin-right: auto;" src="https://s3.amazonaws.com/kinlane-productions2/api-service-providers/intel/intel-rest-security.gif" alt="" width="500" /></a>
...
<p>If that isn&rsquo;t enough!  I will also be doing some workshops with Intel at the <a href="https://www.gartner.com/technology/summits/na/applications/">Gartner AADI conference in Las Vegas</a>, the end of November. &nbsp;So you will have another opportunity to speak with both of us.
<p>If you can&rsquo;t make to either New York or Las Vegas, drop me an email and I&rsquo;ll get you in touch with Intel.
