...
image: http://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/box_incubator_construction.jpg
---

<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/box_incubator_construction.jpg" alt="" width="40%" align="right" />
<p>Building on <a href="http://apievangelist.com/2016/08/10/investing-in-your-api-community-like-amazon-and-slack/">my earlier coverage of how API providers are investing in their API community like Amazon and Slack</a>, I wanted to document the <a href="https://developer.box.com/incubator">incubator over at Box</a>. Acknowledging that <em>"the enterprise applications of the future will be cloud-based and massively scalable"</em>, and to <em>"support the development of these applications, Box Platform and Amazon Web Services are teaming up to provide you with everything you need to build and scale your business."</em> Providing yet with another (AWS-powered) partnership and API community investment blueprint to put on the shelf.
