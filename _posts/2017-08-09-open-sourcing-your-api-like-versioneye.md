...
image: https://s3.amazonaws.com/kinlane-productions2/versioneye/version-eye-containers.png
---

<p><img src="https://s3.amazonaws.com/kinlane-productions2/versioneye/version-eye-containers.png" align="right" width="40%" style="padding: 15px;" />
...
<p>One very useful API that notifies you about security vulnerabilities, license violations and out-dated dependencies in your Git repositories, <a href="https://www.versioneye.com/api/">has a nice approach to delivering their API</a>, as well as <a href="https://github.com/versioneye">the other components of their stack</a>. You can either use VersionEye in the cloud, or you can deploy on-premise:
