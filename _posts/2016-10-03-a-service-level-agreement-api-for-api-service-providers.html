...
image: https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-service-level-agreements.png
---

<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-service-level-agreements.png" alt="" width="30%" align="right" />
...
<p>An interesting API I came across during this work was from the <a href="https://www.site24x7.com">Site24X7 monitoring service</a>, specifically <a href="https://www.site24x7.com/help/api/#sla-settings">their service level agreement (SLA) API</a>. An API for adding, managing, and reporting against SLA's that you establish as part of the monitoring of your APIs. Providing a pretty interesting API pattern that seems like it should be part of the default API management stack for all API providers.
