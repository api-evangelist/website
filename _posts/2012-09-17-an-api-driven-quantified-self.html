...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/quantified-self/quantified-self.png" alt="" width="200" align="right" />
<p>I&rsquo;m immersing myself into the fascinating new world of the <a title="Quantified Self" href="http://quantifiedself.com/about/">Quantified Self</a> (QS).  If you are not familiar with what QS is, according to Wikipedia:
<p style="padding-left: 30px;"><em>Quantified Self is a movement to incorporate technology into data acquisition on aspects of a person's daily life in terms of inputs (e.g. food consumed, quality of surrounding air), states (e.g. mood, arousal, blood oxygen levels), and performance (mental and physical).</em>
...
<p>It is exciting to think about the possibilities around QS.  New ways to gather data about our health and the environment around us in real-time, but also be able to understand this data in the most meaningful way possible, in a way that impacts the most important thing to us--our health!
<p><strong>Devices + APIs + Cloud = Exciting Opportunities!</strong>
