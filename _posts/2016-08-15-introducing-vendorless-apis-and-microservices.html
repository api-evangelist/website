...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-vendorless.png" alt="" width="32%" align="right" />
<p>I'm a big fan of the concept of <a href="http://serverless.apievangelist.com">serverless</a> APIs and <a href="http://microservices.apievangelist.com">microservices</a>, but not so much of the name. I get it, the space needs new concepts to rally around, and I'm the first to admit even the concept of an API is bullshit, but when people say serverless, it always makes me chuckle--especially when people work so hard to sell it (who am I to make fun of that).
