...
<p><a href="http://swagger.io/"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/swagger/swaggerLogo360.png" alt="" width="200" align="right" /></a>
<p>I was having one of my long overdue check ins with API godfather John Musser today, and it reminded me of an idea I wanted to put out there, so while it was fresh in my mind, I wanted to share. I&rsquo;m applying this to my <a href="http://swagger.io/">Swagger</a> driven world, but should be applied to all of the common API definition formats like API Blueprint, and RAML.
...
<p>Not sure how much time I will have for this in 2014, but figured I'd put out there, and see if I've missed something already existing in the space. Also, once something lives on my blog, it becomes a little more real, and the chances increase that I will actually move it forward at some point.
