...
<p><a href="https://apiary.io/" target="_blank"><img src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/apiary/apiary-logo-300x93.png" alt="" width="250" align="right" /></a>
<p>I spent some time developing a <a href="http://apievangelist.com/2014/03/08/hello-world-product-api-with-blueprint-raml-and-swagger/">hello world product API with Blueprint, RAML And Swagger</a> this last week, and along the way I had several experiences that I think are influential in the API design process. One of these was while I was designing my product API using <a href="https://apiary.io">Apiary.io</a>.
...
<p><img style="display: block; margin-left: auto; margin-right: auto;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/apiary/apiary-preview-code.png" alt="" width="550" />
<p>Just like interactive API documentation has been important in teaching developers about an API interface, it will also assist API providers in understanding their own interface throughout the design process, and be able to better articulate the interface to developers.
...
<p>Anything we can do to expand the horizons of API developers during the API design process, helping them see the wider world they are entering into by exposing their API, is a good thing.
