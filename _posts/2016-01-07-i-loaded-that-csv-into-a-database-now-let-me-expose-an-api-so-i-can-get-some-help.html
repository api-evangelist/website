...
<p><img style="padding: 10px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-api-help.png" alt="" width="35%" align="right" />
...
<p>As part of this round of housecleaning I aggregated the schedule of speakers from all six events into a single spreadsheet, which ended up on my desktop as a CSV file. As I was talking this morning with the rest of the @APIStrat team about the 2016 schedule, I shared the CSV in Slack, as I also uploaded to a MySQL database (yeah I'm new / old school like that). I was talking with my partner in crime Nicolas Greni&eacute; (<a href="https://twitter.com/picsoung?lang=en">@picsoung</a>) shortly after, and he wanted to help me push forward the list of speakers, expand the speaker and company info, as well as connect it up with sponsor info.
<p>I then responded, as Steve Willmott (@njyx) points out on Twitter (is nothing private these days!!!):
<blockquote class="twitter-tweet" lang="en">
<p dir="ltr" lang="en">APIer's at work <a href="https://twitter.com/kinlane">@kinlane</a> "I may take you up on that sir. loaded into DB. Let me expose an API on it I&rsquo;ll ping you for some help" <a href="https://twitter.com/picsoung">@picsoung</a>
...
<p>I went ahead and exposed an API of all of the 351 speakers who have participated in @APIStrat since <a href="http://newyork2013.apistrat.com/">the first edition in New York in February 2013</a>--you can access the endpoints, publicly at:
<ul>
<li><a href="http://api.apistrat.com/speakers/">http://api.apistrat.com/speakers/</a></li>
</ul>
<p>I also added the ability to pull a single speaker as well:
<ul>
...
<p>As APIs should be, the speakers API for @APIStrat is a work in progress. We are just going to be a little more transparent about the journey. BTW....if you want some "partner in crime" API access, let me know. ;-)
