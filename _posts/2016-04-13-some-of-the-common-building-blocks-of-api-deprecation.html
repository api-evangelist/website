...
<p>Sadly, there very few "good approaches" to shutting down your APIs in the wild. Luckily there are quite a number of very bad approaches available, that we can reverse engineer, and begin putting together a scaffolding for what might be some possible best practices, when it comes to API deprecation.&nbsp;
<p>I went through <a href="http://deprecation.apievangelist.com/news/">what I had curated as part of my API deprecation research</a>, and assembled these common building blocks:
