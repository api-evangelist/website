...
<p>The API Report is brand new, and looking to be the place where the community can publish their own stories about providing, consuming, or delivering services to the API space, and provide a regular news heartbeat for the API community, by the API community.
<p>Get involved as early as you can, I'd love your feedback.
