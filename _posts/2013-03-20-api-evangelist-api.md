...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/kin-lane-gartner-aadi.jpg
---

<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/kin-lane/kin-lane-gartner-aadi.jpg" alt="" width="250" align="right" />
<p>It was inevitable.  <a href="https://apievangelist.3scale.net/">API Evangelist now has its own API</a>.  I had a couple partners ask for more sophisticated access than provided by RSS or JSON dumps out of my platform. &nbsp;So I launched a handful of API endpoints, allowing you to get at information from my world.
<p>I currently have 13 endpoints providing access to the core of my platform, in 8 key areas:
<ul class="mainlist">
