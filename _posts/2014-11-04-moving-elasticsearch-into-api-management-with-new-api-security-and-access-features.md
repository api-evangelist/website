...
image: https://s3.amazonaws.com/kinlane-productions2/api-evangelist/elasticsearch/elastic-search-logo.jpg
---

<p><a href="http://www.elasticsearch.org/"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/elasticsearch/elastic-search-logo.jpg" alt="" width="250" align="right" /></a>
...
<p>The security Elasticsearch is bringing to the table reflects the core features you see in the API space from&nbsp;<a href="https://www.3scale.net/">API infrastructure providers like 3Scale</a>--providing the basics of what you need to secure access to API endpoints:
<ul class="mainlist">
