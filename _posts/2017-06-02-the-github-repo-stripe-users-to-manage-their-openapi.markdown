...
<p><a href="https://github.com/stripe/openapi"><img src="https://s3.amazonaws.com/kinlane-productions/stripe/stripes-openapi-specification-on-github.png" align="right" width="40%" style="padding: 15px;" /></a></p>
I'm beating a drum every time I find a company managing their OpenAPI on Github, like we would the other code elements of our API operations. Today's drumbeat comes from my friend Nicolas Grenié ([@picsoung](https://twitter.com/picsoung)), who posted [Stripe's Github repository](https://github.com/stripe/openapi) for their OpenAPI in our Slack channel for the super cool API Evangelists in the sector. ;-)
