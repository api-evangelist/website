...
<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/screen_shot_2016_10_20_at_7.37.43_pm.png" alt="" width="35%" align="right" />
...
<p>It seems obvious to me but I'm looking to provide a simple checklist that other API service providers can consider as they craft their strategy. My goal is to help make sure each stop along the lifecycle can be orchestrated in a programmatic way like Tyk.
<p><strong>Disclosure:</strong> <a href="https://tyk.io/">Tyk</a> is an API Evangelist partner.
