...
<p>Context--something that is so important, and is often lost in translation, or forgotten entirely when APIs are purely an IT or developer led initiative. As a developer I can easily see the many uses of an API, but articulating to someone who is actually living within one of these use-case scenarios, is very difficult&mdash;something that takes a lot of practice.
<p>You can see SiftScience working to provide context to its users via its <a href="https://siftscience.com/">website</a>, <a href="http://blog.siftscience.com/">blog</a>, <a href="https://twitter.com/siftscience">twitter</a>, and other <a href="https://siftscience.com/resources/tutorials/integration.html">tutorials and resources</a>. As API providers, this is why we provide essential storytelling building blocks like a blog, tutorials, and other resources&mdash;to provide the critical context someone needs to understand the value that our APIs deliver.
<p>Are you providing enugh context for your users?
