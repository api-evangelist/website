...
<img style="padding: 20px;" src="https://kinlane-productions2.s3.amazonaws.com/ebay/ebay-developer-program-history.png" alt="" width="350" align="right" />On November 20, 2000, eBay launched the <a href="https://developer.ebay.com/common/api/" target="_blank">eBay Application Program Interface</a> (API) , along with the <a href="https://developer.ebay.com/" target="_blank">eBay Developers Program</a>.<p>
