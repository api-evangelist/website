...
<p><img src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-open.png" alt="" width="150" align="right" />
...
<p>The largest concern I hear from people who don't fully understand API, is the perceived loss of control, from putting things up on the open Internet. When you don't understand <a href="https://3scale.net">modern API management infrastructure</a>, and the nuance of API service composition, what an API does can seem pretty scary. The first lesson around me exposing of an API, from the <a href="https://twitter.com/APIStrat">@APIStrat</a> speaker database, was about soliciting help from <span>Nicolas Greni&eacute; (</span><a href="https://twitter.com/picsoung?lang=en">@picsoung</a><span>)</span>, and the second lesson is centered around how I used a combination of public / private endpoints to make this work.
<p>The first two endpoints or methods I published from my speaker databases, were simple GETs:
<ul>
...
<p>This is APIs in action, and how they actually give you more control over the digital resources that are fueling your daily operations.
<ul>
</ul>
