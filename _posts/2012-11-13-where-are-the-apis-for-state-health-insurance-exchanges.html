...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/State-Healthcare-Insurance-Exchanges.png
---

<p><img src="https://s3.amazonaws.com/kinlane-productions2/State-Healthcare-Insurance-Exchanges.png" alt="" width="250" align="right" />
<p>I was listening to a story about <a href="http://www.npr.org/2012/11/13/165057222/nevada-quietly-starts-implementing-obamacare">Nevada quietly starting their implementation of health insurance exchanges</a>, as part of what everyone loves to call Obamacare.  I&rsquo;m not even going to get involved in the politics and merit of making sure everyone is insured--I want to focus on the execution of it.
<p>Immediately I think:  <em><strong>Where is the state health insurance exchange platform API?</strong></em>
<p>According to healthcare.gov an exchange is:
...
<p>And the principles and priorities of state health insurance exchanges are:
<ul class="mainlist">
...
<p>If you are going to successfully implement 50 state health insurance exchanges that meet the definition, principles and priorities of the federal government objectives, you will need an open source platform, complete with a robust API strategy.  Maybe it exists, and I&rsquo;m unaware of it.
<p>If you know more about current initiatives in this area, please let me know.
