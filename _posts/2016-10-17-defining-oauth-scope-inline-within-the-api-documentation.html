...
image: http://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/screen_shot_2016_10_16_at_2.35.09_pm.png
...
<p>To kick off my education of the YouTube API I started playing with <a href="https://developers.google.com/youtube/v3/docs/search/list">the search endpoint for the Youtube Data API</a>. As I was playing with I noticed the had an API explorer allowing me to call the search method and see the live data.
<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/screen_shot_2016_10_16_at_2.35.09_pm.png" alt="" width="100%" />
<p>Once I clicked on the "Authorize requests using OAuth 2.0" slider I got a popup that gave me options for selecting OAuth 2.0s copes, that would be applied by the API explorer when I make API calls.
<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/screen_shot_2016_10_16_at_2.34.01_pm.png" alt="" width="100%" />
...
<p>I'm adding YouTube's approach to OAuth to my list of approaches to a modular approach to delivering interactive API documentation, for use in future storytelling.
