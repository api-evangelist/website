...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-transparency.jpg" alt="" width="200" align="right" />
<p>When I talk about companies using APIs to be more transparent, one of the immediate comments I receive from folks is that "not everyone can be public by default". I agree with this situation, but I always counter with an introduction to the concept that transparency can be applied in strictly internal or partner situations as well--public is not the only type of transparency out there.
...
<p>How could API driven transparency break down the silos in your organization, and help things operate a little more efficiently?
