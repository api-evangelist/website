...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/twilio-connect-button.png
---

<p>
     <a title="Twilio" href="https://www.twilio.com"><img class="c1" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/twilio/Twilio-Logo.png" alt="" width="250" align="right" /></a>

<p>
     <a title="Twilio" href="https://www.twilio.com">Twilio</a> just announced a new API billing solution called Twilio Connect.  The new billing solution enables developers to offload charges for Twilio API usage to their application users, rather than their own Twilio accounts, and billing customers separately.
...
<p>
     <img class="c2" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/twilio/twilio-connect-button.png" alt="" align="right" />
