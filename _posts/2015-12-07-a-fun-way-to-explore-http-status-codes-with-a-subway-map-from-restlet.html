...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/restlet-http-status-codes.png
...
<p><a href="http://restlet.com/http-status-codes-map"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/restlet-http-status-codes.png" alt="" width="100%" /></a>
<p>The subway map they provide is currently a static map, but this is one of the biggest potential areas in using this analogy for me, is that with the right JavaScript + JSON voodoo, you can make it real-time, and interactive. This is something I'm working on to bring the entire lifecycle to the forefront this month.&nbsp;
<p>Nice work Restlet team, I enjoy these efforts by providers to help educate the space, especially when they do it in creative and fun ways like this.
