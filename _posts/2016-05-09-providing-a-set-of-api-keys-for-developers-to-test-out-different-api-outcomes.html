...
<p><img src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-outcomes.png" alt="" width="250" align="right" />
<p><a href="http://apievangelist.com/2016/05/07/twilio-provides-test-api-credentials-with-magic-phone-numbers/">I wrote a post about Twilio using magic phone numbers that let their developers test out functionality without incurring any charges for deploying live phone numbers, making calls, and sending SMS</a>. After publishing my post, Runscope CEO, John Sheehan (<a href="https://twitter.com/johnsheehan">@johnsheehan</a>) said he was behind the original spec for the Twilio magic numbers.
<blockquote class="twitter-tweet" data-conversation="none">
<p dir="ltr" lang="en"><a href="https://twitter.com/kinlane">@kinlane</a> ha I wrote the magic numbers spec. The implementation was better than my design but it&rsquo;s funny to see it recognized so much later
&mdash; John Sheehan (@johnsheehan) <a href="https://twitter.com/johnsheehan/status/729822645613531136">May 9, 2016</a></blockquote>
<p>John&nbsp;continued to share some of the logic that went into his original spec:
<blockquote class="twitter-tweet" data-conversation="none">
<p dir="ltr" lang="en"><a href="https://twitter.com/kinlane">@kinlane</a> I borrowed the idea from payment processors using magic numbers to generate specific kinds of outcomes like declines
