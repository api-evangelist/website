...
image: https://s3.amazonaws.com/kinlane-productions2/api-evangelist/redoc/redoc-demo.png
---

<p><a href="https://github.com/Rebilly/ReDoc"><img src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/redoc/redoc-demo.png" alt="" width="45%" align="right" /></a>
...
<p>ReDoc is deployable to any web page with just two tags--with the resulting documentation looking attractive on both web and mobile devices. Now you can have it all, your API documentation looking good, interactive, and driven by a machine-readable definition that will help you keep everything up to date.
<p>All you need to fire up ReDoc is two lines of HTML on your web page:
...
<p>There is a handful of APIs who have put ReDocs to use as API documentation for their platform:<br class="kix-line-break" />
<ul>
...
<p>There also <a href="https://rebilly.github.io/ReDoc/">provide a live demo of ReDoc</a>, allowing you to kick the tires some more before you deploy, and make sure it does what you will need it to before you fork.
...
<p>ReDoc is available on Github: <a href="https://github.com/Rebilly/ReDoc">https://github.com/Rebilly/ReDoc</a>, as an open source solution brought to you by <a href="https://www.rebilly.com/">Rebilly</a>, &ldquo;the world's first subscription and recurring profit maximization company".
