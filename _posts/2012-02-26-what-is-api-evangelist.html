...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/Tag-Cloud-API-Evangelist.png
---

<p>
     <img class="c1" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/Tag-Cloud-API-Evangelist.png" alt="" width="350" align="right" />
...
<p>
     This was my angle. I would focus on the <a title="Business of APIs" href="/business_of_apis.php">business of APIs</a>, and study the approach, and building blocks that were used by successful API owners. By the end of 2010, I had my focus, and in 2011 I spent a lot of time getting to know the space, and the key players in the API industry. I met influencers such as John Musser(<a title="John Musser" href="https://twitter.com/#!/johnmusser">@johnmusser</a>) of <a title="ProgrammableWeb" href="http://programmableweb.com/">ProgrammableWeb</a>, Daniel Jacobson(<a title="Daniel Jacobson" href="https://twitter.com/#!/daniel_jacobson">@daniel_jacobson</a>) of Netflix, Steven Willmott(<a title="Steve Willmott" href="https://twitter.com/#!/njyx">@njyx</a>) of <a title="3Scale" href="https://3scale.net/">3Scale</a> and Sam Ramji(<a title="Sam Ramji" href="https://twitter.com/#!/sramji">@sramji</a>) of <a title="Apigee" href="https://apigee.com/">Apigee</a>.

<p>
     Throughout 2011 I developed my voice and approach to the space by blogging on <a title="ProgrammableWeb" href="http://programmableweb.com/">ProgrammableWeb</a> and API Evangelist and being the API Evangelist for <a title="Mimeo.com" href="http://www.mimeo.com">Mimeo.com</a>. In 2012 I feel this has moved beyond research and out of the PHD period, after 2 years exclusively focusing on the space, i feel like its a full-time career now. My role is <span class="c2">not</span> as "API Guru" as many people are quick to say, I see it as "API Luminary". All I do is shine light on what other really smart people are doing in the space, and thanks to my girlfriend Audrey Watters (<a title="Audrey Watters" href="https://twitter.com/#!/audreywatters">@audreywatters</a>), I’m learning to shine the light by telling stories. Stories about the power of web APIs, and how they are transforming businesses and entire industries.
...
<p>
     If you are an aPI evangelist, developer evangelist or developer advocate, and would like to share your story, email me at <a title="info@apievangelist.com " href="/cdn-cgi/l/email-protection#6a03040c052a0b1a030f1c0b040d0f0603191e44090507"><span class="__cf_email__" data-cfemail="bbd2d5ddd4fbdacbd2decddad5dcded7d2c8cf95d8d4d6">[email&#160;protected]</span></a> and I’ll publish your story here.
