...
<img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/sunlight-labs/sunlight-labs-112th-congress.jpg" alt="" width="250" align="right" /> <strong>District</strong>
<ul class="mainlist">
...
Sunlight Labs provides official code libraries in <a href="https://github.com/sunlightlabs/python-sunlightapi/" target="_blank">Python</a> and <a href="http://sunlight.rubyforge.org/" target="_blank">Ruby</a> and gives links to other PHP and Java code libraries.<p>
In addition to using the API, you can also <a href="https://github.com/sunlightlabs/apidata/raw/master/legislators/legislators.csv" target="_blank">download a full dump of all the congressional data</a>, as well as photos of the <a class="zem_slink" title="112th United States Congress" rel="wikipedia" href="https://en.wikipedia.org/wiki/112th_United_States_Congress">112th Congress</a>.
