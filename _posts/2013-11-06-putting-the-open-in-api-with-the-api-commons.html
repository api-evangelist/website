...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/api-commons-logo.png
---

<p><a href="http://apicommons.org"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/api-commons/api-commons-logo.png" alt="" width="275" align="right" /></a>
<p>Steve Willmott(<a href="https://twitter.com/njyx">@njyx</a>) from API infrastructure provider <a title="API infrastructure provider" href="https://3scale.net">3Scale</a> and API Evangelist launched a new partner project yesterday at <a href="http://defragcon.com/">Defrag</a>, that we are calling <a href="http://apicommons.org">API Commons</a>.  The mission with API commons is to provide a simple and transparent mechanism for the copyright free sharing and collaborative design of API specifications, interfaces and data models.
...
<p>3Scale and I strongly believe that API Commons is what the API industry needs to help deal with some of the clutter in the number of API designs, incentivize the development of open and common tooling around the best API designs and bring reuse, collaboration and copyright concerns out into the open.
<p>Also check out some of the great news coverage of API Commons over the last 24 hours:
<ul class="mainlist">
...
<li><a href="https://www.zdnet.com/at-last-an-api-commons-7000022849/">At last, an API Commons</a></li>
<li><a href="https://www.forbes.com/sites/benkepes/2013/11/05/solving-the-tragedy-of-the-api-commons/">Solving The Tragedy Of The API Commons</a></li>
<li><a href="https://www.wired.com/wiredenterprise/2013/11/api-commons/">Oracle Sued Google Over Android. But There&rsquo;s Hope For the Future</a></li>
</ul>
