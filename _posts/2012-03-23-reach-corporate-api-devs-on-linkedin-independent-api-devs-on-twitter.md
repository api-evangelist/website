...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/linkedin-logo.png
---

<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/linkedin/linkedin-logo.png" alt="" width="200" align="right" />
<p>Every Monday I generate a list of all new API developer who registered for the&nbsp;<a href="http://developer.citygridmedia.com/">CityGrid&nbsp;API</a>&nbsp;the week before.  This list has the name and email address for each developer, and I manually go down the list, and email them individually, letting them know I&rsquo;m here to help.
...
<p>After 3 months of doing this, I&rsquo;ve noticed that developers who work for larger companies have LinkedIn profiles and developers who either are freelance, own or work with a smaller development shop tend to have Twitter.
<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/twitter/twitter-logo-puffy-border.png" alt="" width="200" align="right" />
<p>It makes sense.  Twitter is a more public forum, and smaller companies tend to need to market their skills and services and actively engage the world around them.  While established companies tend to keep their developers in a more closed environment, suitable for the business social network LinkedIn.
