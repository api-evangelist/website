...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/Get_Started_Constant_Contact_Developer.png
---

<p><a href="http://developer.constantcontact.com/get-started.html"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/Get_Started_Constant_Contact_Developer.png" alt="" width="45%" align="right" /></a>
<p>I was going through the getting started pages for the APIs that I keep an eye on, pulling together an outline of what I'd consider to be some of the best elements across all the API providers. Then I came across the <a href="http://developer.constantcontact.com/get-started.html">getting started page from Constant Contact</a>, and I'd say they win for being the clearest and concise API getting started page of them all.&nbsp;
...
<p>With the next release of my API portal, I'll have a good example of a getting started page, which will be heavily influenced by <a href="http://developer.constantcontact.com/">Constant Contac</a>t.
