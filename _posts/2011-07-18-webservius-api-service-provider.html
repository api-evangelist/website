...
image: http://kinlane-productions2.s3.amazonaws.com/api-service-providers/webservius/webservius-logo.png
---

<a title="WebServius" href="http://www.webservius.com/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-service-providers/webservius/webservius-logo.png" alt="" width="300" align="right" /></a><a title="WebServius" href="http://www.webservius.com/">WebServius</a> provides a self-service tool for deploying, managing and monetizing datasets using an API.<p>
...
<a title="WebServius" href="http://www.webservius.com/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-service-providers/webservius/piggybank-monetize-api.png" alt="" width="300" align="right" /></a>Users can then register, and subscribe to specific plan for any published API,then access data via the API or a full data download.<p>
