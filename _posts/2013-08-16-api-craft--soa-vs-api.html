...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/api-craft-logo.jpg
---

<p><a title="API Craft Forum" href="https://groups.google.com/forum/#!forum/api-craft"><img src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/api-craft/api-craft-logo.jpg" alt="" width="225" align="right" /></a>
<p>This is from a question I answered on the <a title="API Craft Forum" href="https://groups.google.com/forum/#!forum/api-craft">API Craft Forum</a> tonight titled: <a href="https://groups.google.com/forum/#!topic/api-craft/IgPZ5mWAsVE">SOA vs API</a>?
<p><em>I happened to look at the <a href="http://www.slideshare.net/apigee/apis-inside-enterprise-soa-displacement">slide and also related video</a> but unfortunately still do not have&nbsp;&nbsp;a crystal clear view.</em><br /><br /><em>Is my understanding correct?</em>
<ol>
