...
image: http://kinlane-productions2.s3.amazonaws.com/SOAP.png
---

<a href="https://oreilly.com/catalog/9780596000950"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/SOAP.png" alt="" width="250" align="right" /></a>SOAP, or <a class="zem_slink" title="SOAP" rel="wikipedia" href="https://en.wikipedia.org/wiki/SOAP">Simple Object Access Protocol</a>, is an XML-based protocol that allows applications to exchange information over the Internet using <a class="zem_slink" title="Hypertext Transfer Protocol" rel="wikipedia" href="https://en.wikipedia.org/wiki/Hypertext_Transfer_Protocol">HTTP</a> or <a class="zem_slink" title="Remote procedure call" rel="wikipedia" href="https://en.wikipedia.org/wiki/Remote_procedure_call">RPC</a>.<p>
...
SOAP was originally designed in 1998 as a Microsoft project and became a <a href="https://www.w3.org/TR/soap/" target="_blank">W3C Recommendation</a> in June 2003.<p>
