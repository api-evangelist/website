...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/Tag-Cloud-REST-URL.png
---

<p>
     <img class="c1" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/Tag-Cloud-REST-URL.png" alt="" width="325" align="right" />
...
<ul class="mainlist">
     ...
     <li>
          ...
          <ul class="mainlist">
               <li>
                    <a href="https://api.peoplebrowsr.com/v1/"><span>https://api.yourdomain.com/v1/</span></a>
               </li>
               <li>
                    <a href="https://api.peoplebrowsr.com/2011/11/"><span>https://api.yourdomain.com/2011/11/</span></a>
               </li>
          </ul>
     </li>
     <li>
          ...
          <ul class="mainlist">
               <li>
                    <a href="https://api.yourdomain.com/v1/articles/"><span>https://api.yourdomain.com/v1/</span><span>article/</span></a>
               </li>
               <li>
                    <a href="https://api.yourdomain.com/v1/users/"><span>https://api.yourdomain.com/v1/</span><span>user/</span></a>
               </li>
          </ul>
     </li>
</ul>
