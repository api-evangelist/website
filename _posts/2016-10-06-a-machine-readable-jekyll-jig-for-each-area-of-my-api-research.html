...
<p style="white-space: normal;">An example of this can be seen with <a href="http://monitoring.apievangelist.com/">my API monitoring research</a> (the most up to date) with the following machine-readable&nbsp;components:
...
<p style="white-space: normal;">I also have several machine readable elements available which use&nbsp;<a href="https://jekyllrb.com/">Jekyll</a> to drive the content for each research project:
<ul>
