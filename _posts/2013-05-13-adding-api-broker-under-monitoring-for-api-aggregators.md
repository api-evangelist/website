...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/payments-api-broker-spreedly.png
---

<p><img src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/payments-api-broker-spreedly.png" border="0" width="325" align="right" />
...
<p>API aggregators like <a href="http://singly.com">Singly</a> are providing personal data access to popular SaaS platforms by aggregating APIs.  You can pull a list of photos from Singly, for a user, and it could pull photos from Flickr, Instagram and Facebook.  This is pretty straightforward API Aggregation.
...
<p>Not all APIs can be brokered, and maybe Spreedly is unique, but I bet I will find more of this behavior from other companies, once I start looking.  Let me know if you know of any companies who broker API resources in a similar way to Spreedly.
