...
image: https://s3.amazonaws.com/kinlane-productions2/guides/security/api-evangelist-api-security-industry-guide-screenshot-2017-11-08.png
---

<p><em>This edition of my API security industry guide has been underwritten by <a href="http://apis.how/elasticbeam">ElasticBeam</a>, who provides next generation API security, leveraging machine learning, and behavorial analysis that works with the existing web and API management solutions you already have in place across your API operations.</em>

<p><a href="https://gum.co/UOBZd"><img src="https://s3.amazonaws.com/kinlane-productions2/guides/security/api-evangelist-api-security-industry-guide-screenshot-2017-11-08.png" align="right" width="40%" style="padding: 15px;" /></a>
