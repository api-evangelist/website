...
<p>Currently the core four API paths accept and return the following schema:
...
<p>To ensure that all sub-resource area available as part of each of the requests and responses for all core API paths, we are going to have to evolve the HSDS schema to be:
