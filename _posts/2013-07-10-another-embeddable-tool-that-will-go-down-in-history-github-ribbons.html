...
<p><a href="https://github.com/blog/273-github-ribbons"><img style="padding: 10px;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/github/forkme-right-red.png" alt="" align="right" /></a>
<p>Simple, embeddable tools can be one of the most powerful tool in an API evangelists toolbox.  While there was a wide variety of forces that were at play in the social API evolution, contributing to the success of Twitter and Facebook, embeddable buttons, badgers widgets definitely played a leading role.
...
<p>Even without the tracking and API integration, Github Ribbons is an extremely powerful approach to branding, and great example of using embeddable tools in the wild.
