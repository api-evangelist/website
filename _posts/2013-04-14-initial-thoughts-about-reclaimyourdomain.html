...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/person-spider-web.jpg
---

<table cellpadding="5" width="280" align="right">
<tbody>
<tr>
<td align="center"><img src="https://s3.amazonaws.com/kinlane-productions2/reclaimyourdomain/person-spider-web.jpg" alt="" width="275" align="right" /></td>
</tr>
<tr>
<td align="center">
<p>Obligatory spider web photo, because Jim and Audrey did too!
</td>
</tr>
</tbody>
</table>
...
<p>The focal point of#ReclaimYourDomain is a simple, six step wizard that will walk any user through owning their own domain:&nbsp;
<ol class="olist">
...
<p>The goal is to successfully setup a domain, landing page and blog for a user, but the mission is to educate the user about the process ,different resources, location configurations by providing a series of learning objects and migration paths which will allow users to make educated decisions about which options are best for them.  If you want to understand more about why this is important read Audrey's <a href="http://hackeducation.com/2013/04/11/reclaim-your-domain/">Reclaim Your Domain: A #ReclaimOpen Hackathon Project</a> and Jim's <a href="http://bavatuesdays.com/reclaim-open-learning/">Reclaim Open Learning</a>, located at their domain blogs.
<p><a title="Brain Gears" href="http://fineartamerica.com/featured/4-brain-design-by-cogs-and-gears-setsiri-silapasuwanchai.html" target="_blank"><img style="pading: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/gears-brain.jpg" alt="" width="250" align="right" /></a>
<h3>Learning Objects</h3>
<p>With digital literacy the mission, #ReclaimYourDomain will provide a series of structured learning objects that will educate users at every step of the setup, configuration and management of their domain.
<p>Learning objects will be available via a centralized help center, while also being linked individually throughout the domain setup wizard and management process so users can access whenever needed, at just the right moment.
<p>As Audrey says, the goal of #RelcaimYourDomain is not just to provide an easy button for buying a domain and setting up a blog, it is to actually educate users about the process, equipping them with essential web literacy skills along the way.
<h3>Domain</h3>
<p>Each #ReclaimYourDomain user will be given their own domain, complete with a static home, about and contact pages.  The domain will always provide a user with a single landing page that will represent their online persona. A #ReclaimYourDomain domain site will provide users with two key services:
<p><a title="Sir Edmund Hilary - Mount Cook by Vanessa (EY), on Flickr" href="https://www.flickr.com/photos/vanchett/424399237/"><img src="https://farm1.staticflickr.com/174/424399237_b60c7e1732.jpg" alt="Sir Edmund Hilary - Mount Cook" width="225" align="right" /></a>
<ul class="mainlist">
...
<p>#ReclaimYourDomain is designed to educate users about all the services we depend on, while providing the knowledge and tools to incrementally take control over their:
<ul class="mainlist">
<li><strong>Online Domain</strong></li>
<li><strong>Critical Services</strong></li>
<li><strong>Personal Data</strong></li>
</ul>
<p>The process of educating average Internet users about taking control of their worlds in these three essential areas is no easy task, it will be a process that will never fully be complete--requiring a constant flow of open educational resources to empower domain owners about our ever changing digital worlds.
<h3>Dashboard</h3>
...
<p><a title="Reclaim" href="http://reclaimyourdomain.org" target="_blank"><img style="pading: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/reclaimyourdomain/puzzle-cloud-services.png" alt="" width="325" align="right" /></a>
...
<p>Each domain module will come complete with setup, management, migration and even backup, storage and syndication options allowing each module to work independently while providing domain owners with the largest amount of control. &nbsp;
<p>All domain modules will have their own learning objects to support educating users about all the parts and pieces of domain literacy, exposing the technology, business and political layers each resource and its underlying services possess. &nbsp;
<h3>Next Steps</h3>
<p><a title="Reclaim" href="http://reclaimyourdomain.org" target="_blank"><img style="pading: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/fist.png" alt="" width="200" align="right" /></a>
...
<p>#ReclaimYourDomain is not just about setting up a domain and blog.  It is much more than that.  It is meant to be a hands on, digital literacy platform to teach anyone about reclaiming, owning and managing their online domain.
...
<p>Stay tuned for more on #ReclaimYourDomain, and if you&rsquo;d like to get involved feel free to <a href="http://kinlane.com/contact/">contact me</a> directly or stay tuned and I&rsquo;ll have the Github project up shortly.
