...
---
{% include JB/setup %}
<a title="Seevl" href="seevl.net"><img src="http://kinlane-productions.s3.amazonaws.com/api-evangelist/seevl_logo1.png"  align="right" /></a><a title="Seevl" href="seevl.net">Seevl</a>, a music discovery service that provides anew way to explore the cultural and musical universe of various artists, just launched an API with the assistance of <a title="3Scale" href="http://www.3scale.net">3Scale</a>.
