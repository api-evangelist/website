...
<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/sunlight_foundation.png" alt="" width="40%" align="right" />
...
<ul>
<li><strong><a href="https://sunlightlabs.github.io/Capitol-Words/">Capital Words API</a></strong> - The Capitol Words API is an API allowing access to the word frequency count data powering the Capitol Words project.</li>
...
<li><strong><a href="https://sunlightlabs.github.io/openstates-api/">Open States API</a></strong> - Information on the legislators and activities of all 50 state legislatures, Washington, D.C. and Puerto Rico.</li>
<li><strong><a href="https://sunlightlabs.github.io/partytime-docs/">Political Party Time API</a></strong> - Provides access to the underlying, raw data that the Sunlight Foundation creates based on fundraising invitations collected in Party Time. As we enter information on new invitations, the database updates automatically.</li>
<li><strong><a href="https://sunlightlabs.github.io/realtime-docs/">Real-Time Federal Campaign Finance API</a></strong> - A JSON and CSV API that delivers up-to-the-minute campaign finance information on federal candidates, committees, PACs and other groups that file electronically with the Federal Election Commission. Summary information for Senate candidate committees, which file on paper, is available as soon as they have been digitized by the FEC.</li>
</ul>
<p class="p2">Next, I wanted to go through <a href="https://github.com/sunlightlabs">their Github repositories</a> and identify any repos that contained data, server, and client code that is API related. In doing this I also found some interesting visualizations built on top of their work, that I think are worthy of showcasing and preserving:
<ul>
