...
image: http://kinlane-productions2.s3.amazonaws.com/basic-auth.png
---

<img style="padding: 10px;" src="https://kinlane-productions2.s3.amazonaws.com/basic-auth.png" alt="" width="250" align="right" />Basic Auth is a way for a web browser or application to provide credentials in the form of a username and password.<p>
Because Basic Auth is integrated into <a class="zem_slink" title="Hypertext Transfer Protocol" rel="wikipedia" href="https://en.wikipedia.org/wiki/Hypertext_Transfer_Protocol">HTTP protocol</a> it is the easiest way for users to authenticate with a <a class="zem_slink" title="Representational State Transfer" rel="wikipedia" href="https://en.wikipedia.org/wiki/Representational_State_Transfer">RESTful API</a>.<p>
Basic Auth is easily integrated, however if <a class="zem_slink" title="Transport Layer Security" rel="wikipedia" href="https://en.wikipedia.org/wiki/Transport_Layer_Security">SSL</a> is not used, the username and password are passed in plain text and can be easily intercepted on the open Internet.<p>
