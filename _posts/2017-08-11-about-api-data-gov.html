...
image: https://s3.amazonaws.com/kinlane-productions2/api-data-gov/9299911959_bdc195fb56_o.png
---

<p><a href="https://api.data.gov/about/"><img src="https://s3.amazonaws.com/kinlane-productions2/api-data-gov/9299911959_bdc195fb56_o.png" align="right" width="40%" style="padding: 15px;" /></a>
...
<p>Here are the features of api.data.gov:
...
<p><a href="https://api.data.gov">api.data.gov</a> handles the API keys for you:
...
<p><a href="https://api.data.gov">api.data.gov</a> tracks all the traffic to your API and give you tools to easily analyze it:
...
<p><a href="https://api.data.gov">api.data.gov</a> helps with publishing documentation for your API:
...
<p><a href="https://api.data.gov">api.data.gov</a> helps you rate limit because you might not want to allow all users to have uncontrolled access to your APIs:
