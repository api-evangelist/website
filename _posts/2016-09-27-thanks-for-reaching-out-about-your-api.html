...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-email.png" alt="" width="30%" align="right" />
...
<p>Here is one basic email I crafted today, in response to a pretty slick API provider that I will be writing about shortly:
<p class="p1" style="padding-left: 30px;"><em>Hi There,</em>
<p class="p1" style="padding-left: 30px;"><em>I received your email. Thanks for the kind words.&nbsp;Appreciate you introducing me to your [API / API related service]. I'm going to have to pass on the posting of the [guest post, infographic, white paper, case study, etc] to apievangelist.com, but I'm happy to keep an eye on what you are up to as part of my regular work.</em>
<p class="p1" style="padding-left: 30px;"><em>I visited your site and see that you have a blog (with feed), Twitter, and a Github account. These are the channels I&rsquo;ll be keeping an eye on, and when you post a&nbsp;blog post or press release, Tweet something out, or I see a Github repo or commit of interest, I'll definitely include in my research, and craft a story for the blog.</em>
<p class="p1" style="padding-left: 30px;">I have also added your company, blog, feed, twitter, and Github accounts to my monitoring system. Keep on doing interesting things with APIs and I'll make sure it becomes part of my storytelling in the space.
<p class="p1" style="padding-left: 30px;"><em>So far, and reviewing your web site and developer, your API efforts [looked pretty polished / could use some work / is not very modern] I&rsquo;ll keep digging around and publish anything interesting that I find.</em>
<p class="p1" style="padding-left: 30px;"><em>Thanks!</em>
<p class="p1" style="padding-left: 30px;"><em>Kin Lane<br />@kinlane</em>
