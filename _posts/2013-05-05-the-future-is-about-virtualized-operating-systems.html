...
<p>BaaS stacks have the potential to be the operating of the next generation of computing. BaaS has a lot of the characteristics of what we have historically defined as an OS, but tailored for apps that run on devices and in the clouds vs the desktop.
<ul>
...
<p>BaaS will allow us to keep much of the potential delivered by a hardened set of resources we become accustomed to with desktop and server OS's, but also realize the agility and flexibility that is delivered by loosely coupled, individual API resources. &nbsp;Allowing for a new approach to app design, development, deployment and life-cycle management that is much more organic and alive.
