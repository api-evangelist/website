...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-check3.png" alt="" width="30%" align="right" />
...
<li><a href="https://jasmine.github.io/">Jasmine</a> - <span style="background-color: rgba(243, 168, 163, 0.952941);">A</span><span>&nbsp;behavior-driven development framework for testing JavaScript code. It does not depend on any other JavaScript frameworks.&nbsp;</span></li>
<li><a href="https://mochajs.org/">Mocha</a> -&nbsp;<span>Mocha is a feature-rich JavaScript test framework running on&nbsp;</span><a href="https://nodejs.org/">Node.js</a><span>&nbsp;and in the browser, making asynchronous testing&nbsp;</span><em>simple</em><span>&nbsp;and&nbsp;</span><em>fun</em><span>.</span></li>
...
<li><a href="http://blog.postman.com/2015/09/29/writing-a-behaviour-driven-api-testing-environment-within-postman/">Postman</a> - Discussing BDD using Postman API client.</li>
</ul>
