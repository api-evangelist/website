...
image: https://s3.amazonaws.com/kinlane-productions2/charles-to-openapi/har-conversion.png
---

<p><a href="https://twitter.com/jpmonette/status/885545611906428928"><img src="https://s3.amazonaws.com/kinlane-productions2/charles-to-openapi/har-conversion.png" align="right" width="25%" style="padding: 15px;" /></a>
...
<p>Here is what you do. Fire up Charles Proxy:

<p align="center"><img src="https://s3.amazonaws.com/kinlane-productions2/charles-to-openapi/charles-session.png" align="center" width="80%" style="padding: 15px;" />

<p>Then open up Postman, and make any API calls. Of course you could also proxy mobile application or website API calls through your Charles Proxy, but Postman is a great way to for a majority of the APIs I depend on.

<p align="center"><img src="https://s3.amazonaws.com/kinlane-productions2/charles-to-openapi/postman-apis-how.png" align="center" width="80%" style="padding: 15px;" />

<p>After you’ve made the calls to all the APIs you are looking to generate an OpenAPI for, save your Charles Proxy session as a .har file, which is the last option on the dropdown menu available while saving. Then you head over <a href="https://apimatic.io/transformer">to API Transformer</a> and upload your .har file, and select OpenAPI (Swagger) 2.0 as the output–push convert.

<p align="center"><img src="https://s3.amazonaws.com/kinlane-productions2/charles-to-openapi/api-transformer-convert.png" align="center" width="80%" style="padding: 15px;" />

<p><a href="https://apimatic.io/transformer">API Transformer will then push a fresh OpenAPI to your desktop</a>, or allow you to publish via a portal, and generate an SDK using <a href="https://apimatic.io">APIMATIC</a>. Automated (mostly) generation of OpenAPI definitions from API traffic you generate through your browser, Postman, Restlet Client, mobile application, or other tooling.
