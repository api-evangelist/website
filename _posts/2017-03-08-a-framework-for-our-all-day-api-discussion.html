...
<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/api_discussions_copper_circuit.jpg" alt="" width="40%" align="right" />
<p><em>This is an outline I pulled together for a potential project I am working on this week. It's derived from my research, and previous workshops I've done with companies, organizations, institutions, and government agencies in the past. I wanted to share here, in hopes it would stimulate API-focused conversations with some interesting folks.</em>
...
<p>Before we dive into the details of modern API operations I want to make sure we have a solid base for understanding why your company should be investing APIs. Then we can talk about what else will be needed to do this successfully.
...
<p>All of these areas touch on&nbsp;and will guide our discussions throughout the day. The definitions will guide our conversation, and then also become a core outline for governing API operations at every stage of its development--defining the design, deployment, management, and every other area of operations.
<p><strong>Design<br /></strong>A design first strategy is needed to achieve consistency, and maturity before we enter the more costly phases of development and deployment. There are many common approaches to API design on the web, and these are the common areas I'd like to discuss as part of your operations.&nbsp;
<ul>
...
<p>It is necessary to discuss versioning in a technical and business sense. Better understanding how things will change and evolve, and being truthful and honest about how this change impacts operations, integrations, and each application that touches API operations.
<p><strong>DNS<br /></strong>You already have DNS in place for your web operations. We will be taking a look at what is in place, as well as discuss the front line for API operations. DNS provides the base URL for API access, as well as human access for the overall API operations.&nbsp;
<ul>
...
<p>There is already DNS infrastructure in place, this is a discussion around what is required to deliver and support API operations. As with the web, DNS is the frontline for the&nbsp;presence of the API operations, and we need a snapshot of the role it will play in API operations.
<p><strong>Data<br /></strong>I would like to learn more about all of the data sources for your operations. Where is data stored? Where does it come from? What is the complete picture when it comes to data and content accessibility?&nbsp;We can cover a handful of areas to help paint a picture of what is currently&nbsp;behind&nbsp;operations.
<ul>
...
<p><strong>Deployment<br /></strong>Next up is the actual deployment of APIs. Discussing how APIs are deployed, building from the database backend that is available, and moving forward to look at many of the common ways APIs are being deployed today. These are some of the common areas we'll discuss:
<ul>
...
<p>This are might seem like a nice to have a category,&nbsp;but in reality, API and data virtualization can significantly lower the cost of deployment and management&nbsp;and rapidly increasing the rate of maturation of API resources. Different APIs will have varying virtualization needs, let's consider what is needed, based upon your goals with API enablement.
<p><strong>Authentication<br /></strong>Let's take a quick look at what is needed regarding platform authentication. Looking at internal and partner needs first, but then also considering the 3rd party, and authentication using popular social platforms like Facebook, Instagram, or even Github for developers and more technical user.&nbsp;
<ul>
...
<p><strong>A Portal&nbsp;</strong><br />Where will internal, partner, and public users find API resources? It is common to have a central portal to find all APIs and supporting resources can be found. Providing a focused presence and voice for an API, encouraging the awareness and usage of common APIs across company operations.
<ul>
...
<p>Documentation is always identified as the number one pain point for developers when it comes to putting APIs to work in web, mobile, and device applications. I will walk you through the advancements made in the area of documentation, minimizing it as a pain point for both API providers and consumers.
...
<li><strong>Single Page Applications (SPA)</strong>&nbsp;- Will there be single page application libraries and scaffolding available for API consumers to use as a start for delivering storefronts, and other deliverables?</li>
...
<p>As with other areas of IT and web operations, API support will overlap with existing services. However, because of the technical nature of API integration, support should include a heightened level of technical expertise, understanding the challenges of API consumers.
<p><strong>Communication<br /></strong>Complimenting support, let's talk about the communication strategy for API operations. This should overlap with existing communication efforts, but if the resources are available, it can be beneficial to have a dedicated API operations strategy and presence.
<ul>
...
<p>If API resources are to be monetized upstream or downstream they will have to meet the expected level of reliability. Meeting the API contracts in place for accessing and consuming data, content, and algorithmic resources, and justify the money being exchanged for services.
...
<p>We can expand on this area if needed, but I prefer to address a well-defined API strategy as the first step in platform security. APIs help standardizes how resources are accessed and put to use, which goes a long way to help secure valuable corporate interests and protect valuable corporate assets.
<p><strong>Legal Department<br /></strong>Let's make sure and cover the legal side of operations lightly. As with security, we will lightly cover the legal department&nbsp;and stay out of the weeds. There are a handful of areas I'd like to discuss, just to make sure we have this side of operations in order.&nbsp;
<ul>
...
<p><strong>Branding<br /></strong>As an extension of the legal department, let's also discuss branding for API operations. This is one of the most important of API operations but is often overlooked and under invested in when it comes to execution. Let's talk about a few of the common areas I'm seeing API providers deal with branding.
<ul>
...
<p>Much of API discovery will depend on the approach we take to define and design APIs deployed as part of API operations. API discovery is critical to this working, allowing internal, partner, and public consumers to find what they need, and properly integrate into their applications.
<p><strong>Embeddable<br /></strong>Defining where the code meets branding, I'd like to spend some time talking about embeddable tooling available as part of API operations. These are usually JavaScript goodies that leverage the API to help extend the reach of the platform.&nbsp;
<ul>
...
<p>Webhooks help in&nbsp;alleviating the strain on API resources, reducing the number of calls an application will be making. Allowing applications to define and subscribe to events, and receive webhook notifications occur, such as new product shows up in catalog&nbsp;or a purchase is made.
...
<p><strong>Logging<br /></strong>A structured approach to logging of all API activity is essential to management, security, and the health of operations. It can also become another layer to API operations, as well as monetization, providing access to valuable aggregate, trending, and other valuable data derived from the exhaust of API operations.
<ul>
...
<p>With this layer is developed as part of the overall embeddable API strategy for the platform, all the analysis, and visualizations will be embeddable in emails, other web or mobile applications, delivering insight, awareness, and intelligence wherever it is needed.&nbsp;
...
<ul>
<li><strong>Overview -&nbsp;</strong>Let's spend some time discussing how API plans operate. Thinking about the variety of ways APIs can be mixed, matched, and a variety of access levels can be defined to maximize access and usage, while also generating revenue in a sensible way.</li>
...
<p><img src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/t-shirts/KL_InApiWeTrust-1000.png" alt="" width="30%" align="right" />
<ul>
