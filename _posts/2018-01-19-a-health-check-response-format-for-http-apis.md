...
image: https://s3.amazonaws.com/kinlane-productions2/irakli/health-check-response-format-for-http-apis.png
---

<p><img src="https://s3.amazonaws.com/kinlane-productions2/irakli/health-check-response-format-for-http-apis.png" align="right" width="45%" style="padding: 15px;" />
...
<p>I am going to just share the introduction from Irakli’s draft, as it says it all:
...
<p>Here is an example JSON response, showing the standard in action:
