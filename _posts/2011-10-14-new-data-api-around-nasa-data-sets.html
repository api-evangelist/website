...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/open-nasa.png
---

<p>
     <a title="NASA just launched a new Data API" href="http://open.nasa.gov/blog/2011/10/12/announcing-the-data-nasa-gov-api/"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/nasa/open-nasa.png" alt="" width="225" align="right" /></a>

<p>
     <a title="NASA just launched a new Data API" href="http://open.nasa.gov/blog/2011/10/12/announcing-the-data-nasa-gov-api/">NASA just launched a new Data API</a> around its online archive of <a title="NASA data sets" href="https://data.nasa.gov/">NASA data sets</a>, that they launched back in August. The data.nasa.gov API provides a RESTful interface, with responses in JSON for the NASA data archives.

<p>
     The new <a title="NASA Data API" href="https://data.nasa.gov/api-info/">NASA Data API</a> is part of the ongoing <a title="NASA Government Data Plan" href="https://www.nasa.gov/open/plan/index.html">NASA Open Government Plan</a>, providing access to data sets in a variety of categories including aeronautics, climate, earth science, engineering, institutional, life sciences, operations and space sciences.
...
<p>
     <a title="NASA just launched a new Data API" href="http://open.nasa.gov/blog/2011/10/12/announcing-the-data-nasa-gov-api/"><img class="c1" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/nasa/nasa-data-gov-old-computer.png" alt="" width="225" align="right" /></a>
