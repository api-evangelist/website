...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-building-blocks-design.png" alt="" width="30%" align="right" />
<p><a href="http://partners.apievangelist.com/">I've been tracking on how API providers operate their partner programs for a while now,</a> in hopes of pulling together some sort of blueprint that other API providers can follow. I'm always happy to find stop along the API life cycle where an API provider has already developed a robust operational API, like the <a href="https://developers.google.com/partners/">Google Partner API</a>.
