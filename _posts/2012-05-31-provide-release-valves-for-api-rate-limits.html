...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/teapot-steaming.jpg
---

<p><img src="https://kinlane-productions2.s3.amazonaws.com/teapot-steaming.jpg" alt="" width="200" align="right" />
...
<p>As I continue to understand the impact of rate limits on developers it&rsquo;s becoming clearer that for an API to successfully impose rate limits, you should also be offering rate limit release valves in the following ways:
<ul class="mainlist">
...
<p><a title="API Console" href="https://code.google.com/apis/console/"><img src="https://kinlane-productions2.s3.amazonaws.com/google/Google-APIs-Console-Rate-Limits.png" alt="" width="250" align="right" /></a>
<p>There are many points of friction for developers trying to integrate with an API. In my research, one of the ongoing complaints of developers regarding an API is around rate limits. Many of these complaints are directed at APIs who impose rate limits without any clear path beyond the default limits.
...
<p>While I&rsquo;m still unsure about API rate limits in general, it seems clear that if you are going to limit, make sure and provide a release valve in some way, so developers understand what the options are when they hit the ceiling, and that there are opportunities to grow.
