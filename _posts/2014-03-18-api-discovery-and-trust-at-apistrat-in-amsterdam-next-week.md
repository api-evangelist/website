...
<p><a href="http://discovery.apievangelist.com/" target="_blank"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/services/api-discovery.png" alt="" width="200" align="right" /></a>
...
<p>Speakers for the API discovery and trust session are:
<ul class="mainlist">
...
<p>It will be tough to decide between the API design and development and this one in the first session, on Day 1 for me. Thankfully that everything is recorded!
<p><a href="http://discovery.apievangelist.com/">API discovery</a> is an area we have a lot of work to do to prepare for the explosive growth in the space. It is tough to find quality APIs, understand the differences between APIs, and know who you can really depend on after you&rsquo;ve integrated into your applications.  This will be an important session.
