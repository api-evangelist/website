...
image: https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-data-distillation.png
---

<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-data-distillation.png" alt="" width="200" align="right" />
<p><a href="http://martinfowler.com/bliki/Datensparsamkeit.html">I am borrowing from the very prescient post from Martin Fowler</a>, an older post, but is a topic that should be revisited regularly. Google translate tells me Datensparsamkeit means "data minimization". I prefer Fowler's translation:
<p style="padding-left: 30px;"><em>It's an attitude to how we capture and store data, saying that we should only handle data that we really need.</em>
