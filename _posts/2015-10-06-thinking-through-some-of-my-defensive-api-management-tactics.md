...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-defensive-tactics.png" alt="" width="250" align="right" />
<p>As I add each <a href="https://kin-lane.github.io/master/">API to my stack</a>, I consider security along the way. I require an API key to access all of my APIs using my <a href="https://3scale.net">3Scale API management infrastructure</a>, and I also have different tiers of access, and while defining this management layer my first impulse is always put POST, PUT, and DELETE methods into the most trusted tiers.
...
<p>With this in mind I'm carefully evaluating a couple of defensive API management tactics I can employ:
<ul>
