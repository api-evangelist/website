...
image: https://s3.amazonaws.com/kinlane-productions2/google-sheets/google-sheets-icon.jpg
---

<p><img src="https://s3.amazonaws.com/kinlane-productions2/google-sheets/google-sheets-icon.jpg" align="right" width="30%" style="padding: 15px;" />
...
<p>Articles I curate, the companies, institutions, organizations, government agencies, and everything else I track on lives in Google Sheets that are published to the web in this way. When you are viewing any Google Sheet in your browser you are viewing it using a URL like:

<p>https://docs.google.com/spreadsheets/d/[sheet_id]/edit

<p>Of course, [sheet_id] is replaced with the actual id for your sheet, but the URL demonstrates what you will see. Once you publish your Google sheet to the web you are given a slight variation on that url:

<p>https://docs.google.com/spreadsheets/d/[sheet_id]/pubhtml

<p>This is the URL you will share with the public, allowing them to view the data you have in your spreadsheet in their browsers. In order to get at a JSON representation of the data you just need to learn the right way to craft the URL using the same sheet id:

<p>https://spreadsheets.google.com/feeds/list/[sheet_id]/default/public/values?alt=json
