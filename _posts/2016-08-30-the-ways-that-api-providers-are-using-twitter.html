...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-twitter-icon.png" alt="" width="25%" align="right" />
...
<p>I'm seeing several benefits of this approach, but one of them is getting a feel for some of the common patterns around how API providers are putting Twitter to work. So far I am seeing some pretty distinct approaches emerge:
<ul>
