...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-device-data.png" alt="" width="40%" align="right" />
...
<p class="p1">DJI provides four methods for managing the drone data transfer control:
<ul>
