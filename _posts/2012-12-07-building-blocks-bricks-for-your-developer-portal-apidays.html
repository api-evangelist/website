...
<p>I discussed 5 main areas to consider when building your API developer portal:
<ul class="mainlist">
...
<p>My goal is to keep organizing and sharing my view on API design, planning, development and evangelism so my readers can put to use in their own API efforts.
...
<p>You can view my <a title="Building Blocks (Bricks) for your Developer Portal" href="/talks/apidays/building-blocks/" target="_blank">Building Blocks (Bricks) for your Developer Portal</a> from #APIDays, I hope to recreate as a Google Hangout Video and publish to YouTube as soon as I make time.
