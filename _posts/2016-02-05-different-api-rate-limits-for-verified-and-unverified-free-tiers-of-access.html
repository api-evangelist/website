...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/factual-developers.png
---

<p><a href="http://developer.factual.com/data-docs/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/factual-developers.png" alt="" width="35%" align="right" /></a>
<p>One of the approaches to <a href="http://plans.apievangelist.com/">API plans</a> I was studying recently is from the data provider <a href="http://developer.factual.com">Factual</a>, who provides access to places, products, and other valuable data-sets. I felt Factual had a pretty straightforward approach to the free tier of access for their platform, that was worthy of sharing.
<p><a href="http://developer.factual.com/data-docs/">When you visit the page for the Factual data services</a>, they offer two distinct levels of free access to data resources:
<ul>
...
<p><a href="http://developer.factual.com/data-docs/"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/factual-data-services-overview.png" alt="" width="100%" /></a>
