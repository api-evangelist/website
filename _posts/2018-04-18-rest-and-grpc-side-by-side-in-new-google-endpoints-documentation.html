...
image: https://s3.amazonaws.com/kinlane-productions2/google-cloud-platform/google-cloud-endpoints-portal-docs.png
---

<p><img src="https://s3.amazonaws.com/kinlane-productions2/google-cloud-platform/google-cloud-endpoints-portal-docs.png" width="45%" align="right" style="padding: 15px;" />
...
<p>When you are using Google Cloud Endpoints to deploy and manage your APIs, you can choose to offer a more RESTful edition, as well as a more advanced gRPC edition. They’ve continued to support this approach across their service features, and tooling, by now also documenting your APIs. <a href="https://cloudplatform.googleblog.com/2018/03/now-you-can-automatically-document-your-API-with-Cloud-Endpoints.html">As part of their rollout of a supporting API portal and documentation for your Google Cloud Endpoints, you can automatically document both flavors of your APIs</a>. Making a strong case for considering to offer both types of APIs, depending on the types of use cases you are looking to solve, and the types of developers you are catering to.
