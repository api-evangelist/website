...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/google-affiliate-network.jpg
---

<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/google/google-affiliate-network.jpg" alt="" width="250" align="right" />
<p>In my quest to understand the monetization opportunities via APIs, I&rsquo;m studying the possibilites around tracking, and now monetization of content and URL&rsquo;s served up via APIs.
...
<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/google/google-url-shortener.jpg" alt="" width="250" align="right" />
<p>In either case, API owners or API consumers could replace any URLs in content or URLs directly served up via APIs with a Google Affiliate Network generated URL with specific conversion events defined, then shortened using <a title="Google URL Shortener API" href="https://developers.google.com/url-shortener/">Google URL Shortener API</a>.
