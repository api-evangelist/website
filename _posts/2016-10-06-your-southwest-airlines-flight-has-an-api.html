...
<p>The API is available at&nbsp;<span style="text-decoration: underline;">getconnected.southwestwifi.com/current.json</span> when you are on the planes local network, and I'd consult Roger's post if you want more details about how to sniff it out using your browser. Anytime I am on a guest network on a plane or in a hotel, I enjoy turning on my <a href="https://www.charlesproxy.com/">Charles Proxy</a> to log a list of all the domains and IP address in use.
...
<p>Thanks to my friend Jason for pinging me with this. From reading up on it, it is nothing new, but still worthy of noting, and talking about. I love learning about all the APIs that exist in the cracks.
