...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/apittie-node-endpoints.png
---

<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/apittie-node-endpoints.png" alt="" width="300" align="right" />
...
<p>I know this is simplified, and some tech pundits will love to poke holes in it, but when you are explaining the API opportunity to business leaders, as well as the average business user, this has worked well for me.&nbsp;
