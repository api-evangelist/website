...
image: https://s3.amazonaws.com/kinlane-productions2/api-evangelist/tag-cloud-api.png
---

<img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/tag-cloud-api.png" alt="" width="275" align="right" />An <a href="http://www.apievangelist.com/">Application Programming Interface</a> (API) is a way for websites, programs, and <a href="http://www.kinlane.com/category/mobile/">mobile</a> applications to talk to each other.<p>
...
Every time you use your credit card, an API is used. When you visit a website, it often gets information and delivers its functionality through APIs, such as the latest articles from <a href="https://www.nytimes.com/" target="_blank">NY Times</a>.  Mobile apps on your phone use APIs.<p>
