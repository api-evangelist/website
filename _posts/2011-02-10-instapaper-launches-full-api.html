...
<a href="https://www.instapaper.com/" target="_blank"><img style="padding: 10px;" src="https://kinlane-productions2.s3.amazonaws.com/instapaper.png" alt="" width="175" align="right" /></a><a href="https://www.instapaper.com/" target="_blank">Instapaper</a> just launched a <a href="https://www.instapaper.com/api/full" target="_blank">Full API</a> giving developers access to web pages that Instagram users have saved to read later.<p>
The API provides full Instapaper account access, but can only access web page bookmarks from paid-subscriber accounts.<p>
Those who haven't paid the $1/month fee for an Instapaper account will still be able to submit to Instapaper using the <a href="https://www.instapaper.com/api/simple" target="_blank">Instapaper Simple API</a>.<p>
...
The first application developed using the Full API is <a href="https://wp7wonders.wordpress.com/stacks-for-instapaper/" target="_blank">Stacks for Instapaper</a>, a Windows Phone 7 client. developed by Matthieu Guyonnet-Duluc.  More applications are sure to come.
