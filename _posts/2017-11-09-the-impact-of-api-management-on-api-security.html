...
image: https://s3.amazonaws.com/kinlane-productions2/guides/security/api-security-guide-api-management.png
---

<p><a href="http://apis.how/security/"><img src="https://s3.amazonaws.com/kinlane-productions2/guides/security/api-security-guide-api-management.png" align="right" width="45%" style="padding: 15px;" /></a>
<p><em>This is a story from my latest <a href="http://security.apievangelist.com/#Guide">API Evangelist API security industry guide</a>. My partner <a href="http://apis.how/elasticbeam">ElasticBeam</a> has underwritten my API security research, allowing me to publish a formal PDF of my guide, providing business and technical users with a walk-through of the moving parts, tools, and companies doing interesting things with API security. When I publish each guide, I publish each story here on the blog, helping build awareness around my research–this is a short one on API management.</em>
