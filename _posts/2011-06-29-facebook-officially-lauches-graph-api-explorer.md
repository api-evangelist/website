...
image: http://kinlane-productions2.s3.amazonaws.com/facebook/facebook-graph-API-explorer-bubbles.png
---

<img src="https://kinlane-productions2.s3.amazonaws.com/facebook/facebook-graph-API-explorer-bubbles.png" alt="" width="300" align="right" />Facebook just <a title="officially launched the Graph API Explorer" href="https://developers.facebook.com/blog/post/517/">officially launched the Graph API Explorer</a>, a tool allowing developers to quickly explore the social graph of people, photos, events, pages and the relationships between them, via the <a title="Facebook Graph API" href="https://developers.facebook.com/docs/reference/api/">Facebook Graph API</a>.<p>
