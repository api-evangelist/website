...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/landsat-api.jpg
---

<p><a href="https://www.astrodigital.com/api/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/landsat-api.jpg" alt="" width="40%" align="right" /></a>In 2006 Amazon introduced me to the idea that you could deploy global infrastructure using web APIs. This was when web APIs went from the hobby level (ie. photos, social, links) workbench, and became a tool I could actually use in my business toolbox. Web APIs weren't just used or fun and games anymore, opening up my eyes to the endless possibilities when you make the web programmable using APIs.&nbsp;
<p>In 2016, I see a number of APIs show up on my monitoring radar, and honestly, most of them are not that notable--then you come across the solutions like the dead simple <a href="https://www.astrodigital.com/api/">satellite imagery API from Astro Digital</a>. I'm increasingly finding myself tracking on the collision APIs are having with our physical world, so I see a lot of interesting (and some not so) APIs, but I find the notion that you can get the latest picture of a specific place on earth is a pretty significant milestone for web APIs.
