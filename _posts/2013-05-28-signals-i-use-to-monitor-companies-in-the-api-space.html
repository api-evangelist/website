...
<p><a href="http://theapistack.com" target="_blank"><img style="padding: 10px;" src="https://kinlane-productions2.s3.amazonaws.com/api-stack/api-stack-logo.png" alt="" width="350" align="right" /></a>
...
<p>The API Stack Ranking is <span style="text-decoration: underline;">not meant </span>to be a top 25 list, it is meant to be a ranking that I can sort companies by each week, giving me a meaningful stack of companies, who are doing interesting things in the API space.
...
<p>In addition to sharing my stack each week, I'd like to also share the criteria I use to determine my stack. &nbsp;Currently I bundle my signals into three areas:
<ul class="mainlist">
...
<p>My API Stack Ranking is always in flux.  I'm considering other signals like job postings, events as well as sentiment analysist, but this listing represents what I'm currently evaluating to generate my stack each week.
<p>While internal signals give me a good idea of what a company is up to, and the external signals give me some idea regarding what the open developer community is saying, it all really comes down to the analyst part of the algorithm. &nbsp;A company may tweet a lot, but its up to me to decide if those tweets are valuable.
<p>The API Stack Ranking isn't perfect. &nbsp;But it has allowed me to quadruple the amount of information I take in, and surface what I feel are the real stories and reflect the companies that are truly impacting the API space each week.
...
<p>Feel free to contact me directly about the API Stack, and the data and content I produce each week. &nbsp;I'd love to hear your thoughts.
