...
<p><a href="http://apievangelist.com/2010/09/25/the-api-economy/" target="_blank"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/api-economy.png" alt="" width="200" align="right" /></a>
...
<p><img style="display: block; margin-left: auto; margin-right: auto;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/into-the-api-economy.png" alt="" width="575" />
<p><strong>On-Boarding</strong> - How you get consumers up and running with an API
<ul class="mainlist">
...
<p><strong>Service Composition</strong> - How are API resources organized and made accessible to all groups of consumers
<ul class="mainlist">
...
<p><strong>Partner</strong> - Verified and certified levels of relationships with API consumers
<ul class="mainlist">
...
<p><strong>Legal</strong> - The legal definitions and protections for API consumers and providers
<ul class="mainlist">
...
<p><strong>Communication</strong> - External and internal communication with API consumers and stakeholders
<ul class="mainlist">
...
<p><strong>Support</strong> - What type of, and how much support is offered to API consumers
<ul class="mainlist">
...
<p><strong>Resources</strong> - Code and content resources that help API consumers put resources to work
<ul class="mainlist">
...
<p><strong>Updates</strong> - Regular updates around API operations
<ul class="mainlist">
...
<p><strong>Stability</strong> - What is the overall stability of an API platform
<ul class="mainlist">
