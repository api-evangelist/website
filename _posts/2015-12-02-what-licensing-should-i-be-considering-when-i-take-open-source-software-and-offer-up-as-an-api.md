...
image: https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-open-source.png
---

<p><img style="padding: 5px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-open-source.png" alt="" width="175" align="right" />
<p>I've done this a couple of times now. I took&nbsp;<a href="http://phantomjs.org/">PhantomJS</a>, and created my Screenshot API, and used&nbsp;<a href="https://www.imagemagick.org/script/index.php">ImageMagick</a> to create my Image Manipulation API. These are two openly licensed software solutions, which I took, and am using as an API.&nbsp;
...
<p>Just putting it out there to the universe, and curious to see what comes back.
