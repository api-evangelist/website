...
<ul>
     ...
     <li>
          <strong>Products</strong> - Virtual products you create, which allow access to various combinations of API resources and operations
     </li>
     <li>
          <strong>Apps</strong> - Applications that are registered with the platform, and consuming APIs via various product subscriptions
     </li>
</ul>
<p>
...
<p>
     <strong>Portal Management System</strong><br />
...
<ul>
     ...
     <li>Activity - By developer, product, API and operations
     </li>
</ul>
<p>
