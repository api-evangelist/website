...
image: http://kinlane-productions2.s3.amazonaws.com/mashape-logo.png
---

<img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/mashape-logo.png" alt="" align="right" /><a title="Mashape" href="http://www.mashape.com/">Mashape</a> provides tools that enable developers to quickly deliver and consume <a href="http://www.apievangelist.com">APIs</a> and offers a marketplace for listing APIs to buy and sell.<p>
...
<ul class="mainlist">
	<li>JavaScript / <a class="zem_slink" title="JSON" rel="homepage" href="https://json.org">JSON</a></li>
	<li>PHP</li>
	<li>Ruby</li>
	<li>Obj-C</li>
	<li>Java</li>
