...
<p><a href="http://apievangelist.com/2016/08/19/providing-an-anonymous-layer-to-your-api-provider-service-like-stoplightio/">I wrote a post the other day about Postman.io having a limited, anonymous&nbsp;version of their API modeling tool</a>. I stumbled across it while I was trying to upgrade my Stoplight.io account. Shortly after I tweeted out the blog post, John Sheehan (<a href="https://twitter.com/johnsheehan">@johnsheehan</a>) from <a href="https://www.runscope.com/">Runscope</a> chimed in with some wisdom on the subject.
<blockquote class="twitter-tweet" data-conversation="none">
<p dir="ltr" lang="en"><a href="https://twitter.com/kinlane">@kinlane</a> we had a &lsquo;one-click trial&rsquo; 24-hour account once, no email required. i regret the hours i wasted building it.
...
<blockquote class="twitter-tweet" data-conversation="none">
<p dir="ltr" lang="en"><a href="https://twitter.com/kinlane">@kinlane</a> was basically just used for abusive cases. only one ever converted to a real user
...
<blockquote class="twitter-tweet" data-conversation="none">
<p dir="ltr" lang="en"><a href="https://twitter.com/kinlane">@kinlane</a> hurl.it and requestb.in have the same problem. have to hamper them (captcha, cloudflare) to keep up
...
<blockquote class="twitter-tweet" data-conversation="none">
<p dir="ltr" lang="en"><a href="https://twitter.com/kinlane">@kinlane</a> if it gets any popularity, you&rsquo;re screwed
...
<blockquote class="twitter-tweet" data-conversation="none">
<p dir="ltr" lang="en"><a href="https://twitter.com/kinlane">@kinlane</a> so i love this idea but i will probably never have a no-signup-required service again
...
<blockquote class="twitter-tweet" data-conversation="none">
<p dir="ltr" lang="en"><a href="https://twitter.com/kinlane">@kinlane</a> pretty sure the example from your post could be used as an open proxy (like hurl.it was before recaptcha)
...
<p>I'll keep an eye out for other anonymous apps built on top of API service providers, or individual APIs--maybe there are other successful models out there, or maybe there is also some other cautionary tales we should hear.
