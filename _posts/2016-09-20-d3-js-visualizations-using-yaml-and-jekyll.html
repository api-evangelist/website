...
<p><a href="http://d3.js.yaml.jekyll.apievangelist.com/bar-chart/"><img style="padding: 15px;" src="http://d3.js.yaml.jekyll.apievangelist.com/images/d3-js-bar-chart.png" alt="" width="40%" align="right" /></a>
<p>I am increasingly using <a href="https://d3js.org/">D3.js</a> as part of my storytelling process. Since all my websites run using Jekyll, and published entirely using Github repositories wich are shared as Github Page sites, it makes sense to standardize how I publish my visualizations.
<p>Jekyll provides a wealth of data management tools, including the ability to manage YAML dta stores in the _data folder. An approach I feel is not very well understand, and lacks real world examples regarding how to use when managing open data--I am looking to change that.
...
<p>The problem with using D3.js visualization&nbsp;is that I need it in JSON format. Thankfully, using Jekyll and Liquid, I can easily establish dynamic versions of my data in JSON, XML, or any other format I need it in. I place these JSON pages in a separate folder I am just calling /data.
<script src="https://gist.github.com/kinlane/148fd30889a79d324bd21e7c271cbb5b.js"></script>
<p>Now I have the JSON I need to power my D3.js visualizations. To share the actual visualization, I created separate editions for my bar and pie charts, and have the HTML, CSS, and JavaScript for each chart, in its own file.
