...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/zapier-zaps-orchestration.png
---

<p><a href="https://zapier.com"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/zapier-zaps-orchestration.png" alt="" width="45%" align="right" /></a>I'm spending some time going through <a href="https://zapier.com/developer/documentation/v2/reference/">v2 docs for the Zapier API</a>, following the release of <a href="https://zapier.com/blog/workflow-automation/">multi steps work flow</a>s, and code steps for calculating, converting, and manipulating data and content, last week. While IFTTT gets a significant amount of the attention of the API reciprocity platforms I track on, I feel like Zapier is the most successful, and reflects most of what I'd lie to see in an API driven integration, and automation platform--specifically, the fact they have an API.
