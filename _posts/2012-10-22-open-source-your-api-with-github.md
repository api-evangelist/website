...
<p><a title="Github" href="https://github.com/">Github</a>&nbsp;is a frequently used service in the toolbox of API owners.  The most common use of Github is for publishing API SDKs in a variety of languages and platforms.  But when it comes to truly being an "open API", some API owners are actually open sourcing their API design using Github.
...
<p>Not all APIs are created equal. &nbsp;Consider the possibility of actually open sourcing your API, the benefits it might bring to others, as well as your organization--they might exceed keeping it closed and proprietary.
<p>This approach to using Github, is by far the truest meaning of the word, "Open API".
