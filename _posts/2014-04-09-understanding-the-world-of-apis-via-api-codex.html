...
<p>If you need an introduction to APIs or need to find the best technical articles on APIs, visit <a href="https://apicodex.3scale.net/">API Codex</a>.
<p><em>Disclosure: API Codex is operated by 3Scale, an API Evangelist partner.</em>
