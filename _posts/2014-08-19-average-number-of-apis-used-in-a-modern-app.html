...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-app-apis.png" alt="" width="325" align="right" />
<p>I had someone ask me the other day if I had any numbers on how many APIs are used in a modern web or mobile applications--great question! I often refer to the growth in the number of APIs we use, but this is really just anecdotal, and not based on any real facts.
<p>In August, as part of the&nbsp;lead up to&nbsp;<a href="https://twitter.com/APIStrat">@APIStrat</a>&nbsp;I am spending more time reaching out to dev shops in Chicago, with the most recent talks with <a href="http://apievangelist.com/2014/08/18/how-are-dev-shops-in-chicago-using-apis-a-talk-with-bryson-pouw-at-blaze-portfolio/">Bryson Pouw at Blaze Portfolio</a>, and <a href="http://apievangelist.com/2014/08/11/how-are-mobile-dev-shops-in-chicago-using-apis-a-talk-with-dave-devitt-at-sydcon/">Dave Devitt at SYDCON</a>. In future conversation I will make sure and ask the dev shops how many APIs they use in the average app they deliver.
