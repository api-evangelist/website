...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/Socrata-Data-Overview.png
---

<p><a href="http://www.socrata.com/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/socrata/Socrata-Open-Data-Company.png" alt="" width="250" align="right" /></a>
...
<p>Socrata says it best:  <em>&ldquo;Social Data Discovery Solution Promotes Civic Engagement, Improves Decision and Policy Making, and Achieves Government Transparency.&rdquo;</em>
<p>Socrata defines "<a title="Social Data Discovery" href="http://www.socrata.com/discover/">Social Data Discovery</a>" as a solution for public and private institutions to transform raw data, contained in large departmental databases, and deploy using the latest web and API technologies. &nbsp;According to Socrata:
<p style="padding-left: 30px;">&nbsp;<em>&ldquo;Social Data Discovery promotes civic engagement, enabling an online community of journalists, policy makers, scientists/domain experts, and citizens to visualize data and engage in discussion with one another. Together, audiences with disparate viewpoints  can analyze and discover insights from datasets, improving decision and  policy making.&rdquo;</em>
<p>They seems to get the political, technical and economic challenges faced when delivering government data solutions, and provide a very comprehensive solution for city, county, state and federal agencies to manage their data:
<ul class="mainlist">
...
<p><a href="http://www.socrata.com/"><img style="display: block; margin-left: auto; margin-right: auto; padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/socrata/Socrata-Data-Overview.png" alt="" width="550" /></a>
