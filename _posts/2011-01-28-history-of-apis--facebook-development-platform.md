...
<p>The&nbsp;<a href="http://www.apievangelist.com/">API</a>&nbsp;used a&nbsp;<a href="http://www.kinlane.com/">Restful</a>&nbsp;protocol and responses were in an&nbsp;<a href="http://www.apievangelist.com/definition-xml.php">XML</a>&nbsp;format.
<p>Almost immediately, developers began to build social applications, games, and mashups with the new development tools.
<p>The Facebook Development Platform gave Facebook an edge over then popular competitor&nbsp;<a href="http://www.myspace.com">MySpace</a>, and established itself as the top social gaming platform with games like&nbsp;<a href="http://www.farmville.com/" target="_blank">Farmville</a>.
