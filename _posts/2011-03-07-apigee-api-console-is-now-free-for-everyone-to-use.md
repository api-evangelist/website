...
image: http://apigee.com/about/img/create_console_screen.png
---

<img style="padding: 15px;" src="https://apigee.com/about/img/create_console_screen.png" alt="" align="right" />Apigee has <a title="API Console Release" href="http://blog.apigee.com/detail/apigee_to_go/">released its API Console as a free</a>, publicly available tool for use by any API provder.<p>
The <a title="API Console" href="https://apigee.com/about/products_togo.html">API Console</a> allows developers to view an API, authenticate with the API and begin making requests and seeing responses from an API.<p>
...
The API console assists developers with authentication by handling <a class="zem_slink" title="OAuth" rel="homepage" href="https://oauth.net">OAuth</a> 1.0 and OAuth 2.0 access to APIs.<p>
