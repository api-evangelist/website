...
<p><a href="http://apidays.io/" target="_blank"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/events/api-days-paris-france/api-days-logo.png" alt="" width="200" align="right" /></a>
...
<p><a href="http://apidays.io/" target="_blank">API Days</a>&nbsp;sees the API economy the same way I do:
...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/events/api-days-paris-france/API-Days-Kin-Lane.png" alt="" width="150" align="right" />
<p>The API event is hosting over 50 sessions from over 30 speakers--including two of my own talks:
<ul class="mainlist">
<li>The Secret to a Successful API is Internal</li>
<li>Business models for your API as a start-up</li>
</ul>
<p>I&rsquo;m excited to see APIs getting interest in Europe.  And after working with the Webshell team for several months and learning more about FaberNovel, I'm excited to be working with both of them to drive API adoption in Europe.
<p>If you are planning on going to <a href="http://apidays.io/" target="_blank">API Days</a>, let me know and I&rsquo;ll make time to talk.  If you aren&rsquo;t, I will publish more info about the event and my talks here on <a title="API Evangelist" href="http://apievangelist.com">API Evangelist</a>, when it is all wrapped up.
