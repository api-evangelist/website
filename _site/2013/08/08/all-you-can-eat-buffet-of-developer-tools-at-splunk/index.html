...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/splunk-logo.gif
---

<p><a href="http://www.splunk.com/" target="_blank"><img src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/splunk/splunk-logo.gif" alt="" width="250" align="right" /></a>
<p>During my monitoring of the API space this week, I came across an interesting blog post from data platform <a href="http://www.splunk.com/">Splunk</a>, <a href="http://blogs.splunk.com/2013/08/06/a-developers-smorgasbord/">showcasing the tools they provide for developers</a> who are putting their real-time data platform to use.
<p>Splunk has an amazing smorgasbord of developer tools, but there are a handful that I feel need highlighting, so that other data API providers can consider as part of their own offerings:
<ul class="mainlist">
...
<p>Obviously Splunk is a big data platform, so the idea of custom search and other building blocks, may not work for all API providers. Regardless this list provides some thought provoking implementations that other data API providers should look as part of their own roadmap.
<p>Make sure and head over to the <a href="http://blogs.splunk.com/2013/08/06/a-developers-smorgasbord/">blog post that sparked this story,</a> they have other goodies like App Frameworks, and specific connectors for Apache, Spring, Flurry and a long-tail of API integration building blocks.
