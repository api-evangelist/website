...
<p><a href="https://intel.com"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/api-service-providers/intel/Intel-logo.jpg" alt="" width="175" align="right" /></a>
<p><a href="http://readwrite.com/2013/04/17/intel-acquires-mashery">Intel is reportedly buying API service provider Mashery for &ldquo;a range of $120 million to $180 million&rdquo;</a>, according to ReadWrite(Web). As I reflect on this, two main questions come to mind:
<ol class="mainlist">
...
<p>Next is this a logical move for Intel?  They are maker of physical things like  motherboard chipsets, network interface controllers and integrated circuits, flash memory, graphic chips, embedded processors, not of things virtual like APIs.
<p>Intel is known for making the thing essential ingredients &ldquo;inside&rdquo; our PCs, laptops, servers, smart phones and digital devices.  They have been the driving force of &ldquo;compute&rdquo; for the last 40 years, basically my entire life.  I&rsquo;ve heard lots of chatter today that Intel moving from building the physical ingredients, to virtual APIs is too big of a switch for Intel, and they will fail.
<p><a href="http://cloudsecurity.intel.com/" target="_blank"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/api-service-providers/intel/intel-Expressway-Service-Gateway-Whiteboard.png" alt="" width="300" align="right" /></a>
...
<p>Intel will not be building and deploying APIs for fun and games on the Internet.  Intel will be the gateway of the essential resources that are driving our mobile apps like SMS, voice, video encoding, etc, all the way to vital healthcare, climate monitoring and military grade API resources that will drive everything from the private sector to governments and NGOs worldwide.
<p>I feel the Intel vision of APIs won&rsquo;t and shouldn&rsquo;t apply to all aspects of web APIs, open data, and various aspects of the open web. But I think Intel has what it takes to deliver the hardened and secure compute resources we are going to need to drive the next 40 years of web enabled technology.
<p><strong>Disclaimer:</strong> Intel is a partner of API Evangelist and Mashery has never been a partner of API Evangelist. :-)
