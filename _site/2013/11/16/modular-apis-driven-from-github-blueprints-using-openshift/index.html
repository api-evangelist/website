...
<p><a href="https://www.openshift.com/"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/openshift/openshift-logo.png" alt="" width="200" align="right" /></a>
...
<p>While I'm heavily using Github as the primary place to deploy <a href="http://spa.apievangelist.com/">single page applications</a>, that are completely written in HTML, CSS, JavaScript and JSON, I still need server side locations to rapidly deploy API driven resources in PHP, Python, Ruby and Node.  OpenShift is a much more modular approach that AWS, and while I'll still be using Amazon for many of my deployments I'm going to play around more with what is possible on OpenShift.
<p>What I really like about this approach, in addition to the modular design is that I can maintain blueprints for common APIs on Github and reference these designs when deploying APIs via OpenShift. This matches up well with what I'm doing with <a title="api.ongithub.com " href="http://api.ongithub.com">api.ongithub.com</a> and <a title="data.ongithub.com" href="http://data.ongithub.com">data.ongithub.com</a> where I working to define simple Git driven approaches to open data and APIs.
<p>Good stuff, I look forward to playing around more.
