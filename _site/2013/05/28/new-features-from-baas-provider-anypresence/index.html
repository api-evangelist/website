...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/anypresense-logo.png
---

<p><a href="http://www.anypresence.com/" target="_blank"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/company/anypresense_logo_New.png" alt="" width="250" align="right" /></a>
...
<p>It can be difficult to interpret each BaaS provider's products and services, and establish any sort of common definition, but applicaiton cloning, automated testing, custom server extensions and enterprise app stores are pretty straight-forward and powerful BaaS features.
<p>I'm curious to see where AnyPresence goes with their custom extensions. &nbsp;I think whoever can do this part of BaaS correctly will win the BaaS world championships! (That is an award, right?)
<p>Lot's of exciting stuff coming from the BaaS sector lately! &nbsp;Fun space to watch.
