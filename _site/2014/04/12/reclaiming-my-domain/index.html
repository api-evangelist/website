...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-fist.png" alt="" width="175" align="right" />
<p>After the recent heartbleed security fiasco, I&rsquo;m spending my weekend going through <a href="http://kinlane.reclaimyourdomain.org/2014/04/12/which-online-services-do-i-depend-on/">my list of online services that I depend on</a>, changing my passwords, and along the way I&rsquo;m going to reclaim as much of my domain as I can.
...
<p>I produce a lot of content each day, and on the surface it seems like I maintain control over most of this, but in reality my content resides in online services like Twitter, LinkedIn, and other places that I frequent daily.
<p>I do a pretty good job of centrally managing the blog content I generate each day. I have a central CMS where I create my blog entries, and then syndicate to my network of 60+ Github repositories, that use Github Pages + Jekyll.
<p>When it comes to my social media streams, I do a very poor job of maintaining control over my network. I do not store my Tweets, Facebook, Linked or other social streams anywhere. I don&rsquo;t centrally sync my network of friends and business contact, until recently. I now have a central CRM alongside my blog CMS, but I&rsquo;m just getting started there.
...
<p><em><strong>Photo Credit </strong>- <a href="https://commons.wikimedia.org/wiki/File:Fist.png">Wikimedia Commons</a></em>
