...
<p><a href="https://www-01.ibm.com/software/websphere/events/impact/"><img src="https://s3.amazonaws.com/kinlane-productions2/events/ibm-impact-2014/ibm-impact-logo.png" alt="" width="250" align="right" /></a>
<p>The biggest impact APIs will have at your company will be the internal, cultural change regarding how you do business. We are in the middle of an explosion of APIs, and while there are many new public APIs emerging, the majority of growth is coming from the deployment of internal APIs.
<p>There is a lot that companies can learn from the open API movement over the last fourteen years, with many <a href="http://management.apievangelist.com/building-blocks.html">building blocks</a>, and healthy practices that can be applied when internally deploying APIs.
<p>This is a topic I will be exploring on <a href="http://apievangelist.com">API Evangelist</a>, and at the <a href="https://www-01.ibm.com/software/websphere/events/impact/">IBM Impact conference at the Venetian in Las Vegas, NV</a>&mdash;April 27th through May 1st. The abstract from my talk, titled "Business of Internal APIs&rdquo; is:
