...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-white-label.png" alt="" width="225" align="right" />
<p>I had someone ask me, if out of the 3<a href="http://reciprocity.apievangelist.com/companies.html">0 API reciprocity providers I track on</a>, if I knew if one of them offered white or private label services. I couldn&rsquo;t confidently say whether or not any of them did, and as I do with my other questions, the best way to find out, is to put it out into the universe, and see whether or not one of the providers will let me know, or one of them will do it.
<p>It would make sense for companies like <a href="https://zapier.com/">Zapier</a> to offer a solution that would allow for any company to resell their services, and offer specialty versions of their API reciprocity, interoperability, and automation services. As more companies are operating online, spread across various cloud environments, the need for ETL in the cloud, or like I prefer to call them, <a href="http://reciprocity.apievangelist.com/">API reciprocity services</a>, is only going to increase.
