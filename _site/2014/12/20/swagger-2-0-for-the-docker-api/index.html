...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/docker-swagger.png
---

<p><a href="http://theapistack.com/data/docker/docker-remote-api-swagger.json"><img style="padding: 5px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/docker-swagger.png" alt="" width="225" align="right" /></a>
<p>I&rsquo;m developing a common API for all the APIs I deploy via Docker containers, meaning that each API that I design as a Docker image, will have an API to control all aspects of deployment, and its operations. I will be keeping most of the surface area available in <a href="https://docs.docker.com/reference/api/docker_remote_api/#v116">current version of the Docker API</a>, but I'm thinking I will add a handful of endpoints, and maybe alter a couple of the existing Docker defined endpoints to better meet my needs.
<p>To support my work, I need a Swagger 2.0 definition for the v1.16 of the Docker API. I wish everyone would create machine readable API definitions for their APIs by default, but until that is the norm, I will be creating myself. I&rsquo;m getting pretty good at writing scrape scripts for harvesting API documentation (if they are well formed).
