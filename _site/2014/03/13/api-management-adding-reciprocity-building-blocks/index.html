...
image: https://s3.amazonaws.com/kinlane-productions2/api-evangelist/trends/reciprocity-trends.png
---

<p><a href="http://apievangelist.com/trends/reciprocity.php"><img src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/trends/reciprocity-trends.png" alt="" width="200" align="right" /></a>
<p>I&rsquo;m adding a new grouping to my list of <a href="http://management.apievangelist.com/building-blocks.html">API management building blocks</a>, called reciprocity. If you want to know what I mean by reciprocity check out my earlier post <a href="http://apievangelist.com/2013/02/28/from-etl-to-api-reciprocity-looking-at-20-service-providers/">From ETL to API Reciprocity, Looking at 20 Service Providers</a>.
<p>As I was working with Nimble the CRM system last night, and I was planning out some workflows associated with keeping contact data up to date, and noticed that Nimble provides access to <a href="https://zapier.com">Zapier automation tools</a> directly from their interface, using an iframe.
<p>Providing access to API automation tools for your developers, and end-users, is an important piece of a larger reciprocity puzzle. As an API provider you should allow for developers and end-users to access, migrate, download, and orchestrate the flow of their own data.
<p>With this in mind I&rsquo;m adding four building blocks for reciprocity as part of my API management recommendations:
<ul class="mainlist">
...
<p>Reciprocity is not just about users getting the ability to download their data, so they can leave a platform. Reciprocity is about using APIs to empower everyone to maximize the exchange of resources. If a users is given a chance to use their data in other applications, and back again, the more valuable a resource will become, and the more likely a user will continue using a service&mdash;it is just good business.
<p><img style="padding: 10px; display: block; margin-left: auto; margin-right: auto;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/nimble/nimble-zapier-integration.png" alt="" width="575" />
...
<p>None of this would be possible without reciprocity. Using Gmail, Facebook, Twitter, LinkedIn, Nimble and my own custom APIs, I am able to improve on how I manage my daily operations. This is why reciprocity is a pretty critical building block in how all of this is going to work. I put reciprocity in that space that is the overlap between the business and politics of APIs&mdash;that dark matter that helps make all of this API shit work.
