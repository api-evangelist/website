...
image: https://s3.amazonaws.com/kinlane-productions2/api-evangelist/flowdock/flowdock-logo.png
---

<p><a title="flowdock" href="https://www.flowdock.com" target="_blank"><img style="padding: 10px;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/flowdock/flowdock-logo.png" alt="" width="250" align="right" /></a>
...
<p>Flowdock is right, we all depend on open-source software to make our increasingly API driven world go around. Whether it's the language(s) we program in, server OS, database platform, or the code libraries we use for API integration, open source software is an essential element of the API economy.
