...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-politics.png" alt="" width="200" align="right" />
...
<p>The technical building blocks of APIs are pretty clear at this point, and the business of APIs has been being hammered out over the last five or so years, by <a href="https://bit.ly/13esk6Q">API infrastructure providers like 3Scale</a>, but the politics of APIs are an aspect of the API economy we are going to see become more and more of a hot topic as the space continues its growth.
<p>There are a handful of building blocks that are clearly driving how APIs are used (or not used):
<p><span><strong>Legal</strong></span>
...
<tr>
<td width="60" align="center" valign="top"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-brand.png" alt="" width="50" align="left" /></td>
...
<tr>
<td width="60" align="center" valign="top"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-privacy.png" alt="" width="50" align="left" /></td>
...
<tr>
<td width="60" align="center" valign="top"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-handshake.jpg" alt="" width="50" align="left" /></td>
...
<tr>
<td width="60" align="center" valign="top"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-data-license.png" alt="" width="50" align="left" /></td>
...
<tr>
<td width="60" align="center" valign="top"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-mit-code-license.png" alt="" width="50" align="left" /></td>
...
<tr>
<td width="60" align="center" valign="top"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-deprecation.png" alt="" width="50" align="left" /></td>
...
<p>These building blocks are the acting as the control valve for API ecosystems, setting the tone for how much access, control and influence both developers and end-users wil have when it comes to API operations.
<p>There are other elements that will affect an API, and its community, like the amount of transparency a provider embraces, and externally from laws and regulation from the government, but these seven building blocks will have the biggest impact on what is possible when integrating with an API.&nbsp;
<p>The interesting thing about the politics of APIs is the overlap with the business and tech of APis. There are political building blocks that are more technical:
...
<p>Then there are building blocks that have more to do with business, than the tech, but go along way in influencing the politics of an API:
<ul>
<li>Self-Service</li>
<li>Communication</li>
<li>Support</li>
...
<p>These are all related to busines operations but will all play important role in the internal and external politics of API operations. While every API building block contributes to overall politics in some way there are a small group that I think truly overlap the tech, business and politics of APIs:
<ul>
<li>Github</li>
<li>Consistency</li>
<li>Security</li>
