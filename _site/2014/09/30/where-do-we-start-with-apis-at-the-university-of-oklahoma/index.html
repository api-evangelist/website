...
<p><a href="https://www.ou.edu/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/the-university-of-oklahoma.png" alt="" width="190" align="right" /></a>
...
<p>My efforts are beginning to pay off, and I was recently contacted by two friends, Mark Morvant (<a href="https://twitter.com/MarkMorvant">@MarkMorvant</a>) and Adam Croom (<a href="https://twitter.com/acroom">@acroom</a>), at the <a href="https://www.ou.edu/">University of Oklahoma</a>. They had seen my&nbsp;<a href="http://university.apievangelist.com/">University research</a>, and read my white paper, but what really lit their fire was the <a href="https://www.nytimes.com/2014/08/28/nyregion/students-inventing-programs-to-streamline-their-colleges-data.html?_r=3">piece in the NY Times about student-built apps teaching colleges a thing or two</a>&mdash;after reading that, they decided to give me a call to discuss APIs more.
<p>I started with the two approaches to using APIs that I am seeing at <a href="http://university.apievangelist.com/universities.html">universities</a>:
<ul class="mainlist">
...
<p>Then I discussed the different approaches to introducing APis on campus that I've come across so far:
<ul class="mainlist">
...
<p>Without any clear place to start, I&rsquo;m exploring the <a href="https://www.ou.edu/">ou.edu website</a> looking for any spreadsheets, CSV files, or obvious tables that could contain some easy data or content that I could easily turn into APIs--pulling ideas from my <a href="http://university.apievangelist.com/building-blocks.html">university API building blocks list</a> in my research. Once I have a few targets established, I will then setup a basic developer portal to house all of the early API efforts.
