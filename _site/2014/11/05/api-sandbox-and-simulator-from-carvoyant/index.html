...
<p><a href="https://developer.carvoyant.com/"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/carvoyant/carvoyant-logo.png" alt="" width="250" align="right" /></a>
<p>I&rsquo;m digging deeper into my Evernote lately, getting back to those half written stories I have laying around, and next up is about the Carvoyant API sandbox and simulator. I came across their <a href="https://www.carvoyant.com/2014/10/31/free-connectedcar-data-candy-in-the-sandbox/">Free #connectedcar data candy in the Sandbox blog post</a>, and was intrigued by the concept of a simulator, not just for IoT related APIs, but potentially for any API.
