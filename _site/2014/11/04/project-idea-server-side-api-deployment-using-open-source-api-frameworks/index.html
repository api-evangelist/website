...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/bw-stack-api-frameworks.png
---

<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/bw-stack-api-frameworks.png" alt="" width="200" align="right" />
<p>As I write up a <a href="http://apievangelist.com/2014/11/03/the-expanding-api-universe-more-api-sdk-focused-services-emerge/">story on Magnet</a>, another one of the API SDK service providers to emerge in the space, I can't help but evaluate what other building blocks have the potential to evovolve, and be offered as a specific service. Machine readable API definition formats like <a href="https://bitly.com/1tnYxV8">Swagger</a> and <a href="https://bit.ly/1cl8tCc">API Blueprint</a> make services like <a href="https://bit.ly/1qnXcI0">Apimatic</a> and Magnet possible, and I enjoy thinking about other potential services that could be easily generated from definitions in this way.
...
<p>I&rsquo;ll keep sharing these ideas that are generated from my monitoring of the API space, in hopes some of you take advantage of them, and bring them to life.
