...
<p><img src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-dictionary.png" alt="" width="150" align="right" />
...
<p>I generated Swagger specs for the 10 following APIs:
<ul class="mainlist">
...
<p><img style="display: block; margin-left: auto; margin-right: auto;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/utility-stack-dictionary.png" alt="" width="550" />
<p>In a perfect world, APIs would use commonly established vocabularies like <a href="https://schema.org">schema.org</a>, but in the imperfect API world we are given, I&rsquo;m enjoying taking a look at the sort of API slang that has emerged across the various types of popular APIs we are adopting.  API definition formats like Swagger give me a great way to define the surface are of APIs, and these exercises allow me to push forwards tools and approaches to understanding this new landscape.
<p>The more APIs I generate Swagger definitions for, and the more tools I develop to analyze the landscape, the better I will get at communicating the interesting patterns I&rsquo;m seeing across the API space, and hopefully extract some blueprints that I can follow in my own API design work.
