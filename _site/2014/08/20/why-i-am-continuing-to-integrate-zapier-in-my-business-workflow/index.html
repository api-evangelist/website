...
<p><a href="https://zapier.com"><img src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/zapier/zapier-logo.jpeg" alt="" width="225" align="right" /></a>
<p>I depend on a <a href="http://kinlane.reclaimyourdomain.org/2014/04/14/details-about-the-52-online-services-i-depend-on/">number of cloud services to make my personal and business world go round</a>. Even as a programmer, who can hand code just about any script to integrate, automate, and orchestrate my world, I find myself using more reciprocity services like <a href="https://ifttt.com">IFTTT</a> and <a href="https://zapier.com">Zapier</a>.
...
<p>Zapier has a pretty straightforward <a href="https://zapier.com/app/pricing">pricing framework</a>, giving you just enough room to get hooked, then you can pay for more usage as needed. Having a free tier for any cloud service is essential, but having a tiered business model, and <a href="http://monetization.apievangelist.com/">clear monetization strategy</a>, so I know that you will be around in the future, is a requirement.
<p>I will keep my IFTT account to play with, but when it comes operating my business, continuing to integrate Zapier into my workflow makes sense as they have a clear business model that fits my needs. Plus <a href="https://zapier.com/developer/">Zapier has an API</a>. Ummmm&hellip;hello? An API for your automation and integration layer across all the services you depend on, via their APIs--how cool is that!
<p>When launching your own APIs, make sure it has a clear, visible, intuitive and ascendable service framework--it is something that will go a long way in helping companies decide if they will use your APIs, or not.
