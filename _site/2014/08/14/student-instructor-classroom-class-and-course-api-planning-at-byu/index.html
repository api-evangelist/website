...
<p><a href="https://developer.byu.edu/wiki/display/SOA/Web+Services+Programmer+Documentation" target="_blank"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/company/logos/brigham-young-university.jpeg" alt="" width="210" align="right" /></a>
<p>I spoke with Phil Windley (<a href="https://twitter.com/windley">@windley</a>) over at <a href="https://byu.edu">Brigham Young University (BYU)</a> about their API strategy this morning. BYU is bringing together API providers and consumers, to establish a coordinated strategy for delivering designing, deploying, managing, and integrating with APIs across campus--an effort being led by <a href="http://cio.byu.edu/">CIO Kelly Flannagan</a> (<a href="https://twitter.com/kelflanagan">@kelflanagan</a>).
<p>As part of their latest API effort, BYU is focusing in on the lowest hanging fruit when it comes to campus resources:
<ul class="mainlist">
<li>Students</li>
<li>Instructors</li>
<li>Classrooms</li>
...
<p>Look for any stories out of BYU, here on API Evangelist, or over at my <a href="http://university.apievangelist.com/">university API research site</a>, and if you are doing any API work at your school, I'd love to know more about it.
