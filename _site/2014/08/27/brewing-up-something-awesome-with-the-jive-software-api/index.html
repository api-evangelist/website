...
<p><a href="https://developer.jivesoftware.com/"><img style="padding: 10px;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/jive-software/jive.png" alt="" width="175" align="right" /></a>
...
<p>I would put Jive Software into the category of more making a first impression, than providing a short description of what the API does:
<p><a href="https://developer.jivesoftware.com/"><img style="padding: 10px; display: block; margin-left: auto; margin-right: auto;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/jive-software/brew-up-something-awesome.png" alt="" width="550" /></a>
<p>I wouldn&rsquo;t recommend this approach for every API provider, but if you can do it right, and make a solid first impression&mdash;run with it! As an <a href="http://apievangelist.com">API Evangelist</a>, and <a href="http://ipaevangelist.com">IPA Evangelist</a>, I can seriously get behind a message like &ldquo;brew up something awesome&rdquo;. +1
<p>I like how they have apps, docs, APIs, and IPAs as taps, and the taps even work when you mouseover!  Seriously, all of this API shit is hard to make entertaining (trust me I know), and when you can provide this human touches while inciting innovation, they can go a long way in breaking the ice with consumers.
