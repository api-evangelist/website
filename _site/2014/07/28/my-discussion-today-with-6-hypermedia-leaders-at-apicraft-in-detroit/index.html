...
<p><a href="http://api-craft.org/"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/events/api-craft/api-craft-logo.png" alt="" width="225" align="right" /></a>
...
<p>To help guide the conversation, I've asked each panelists to give me two things that they want the audience at API Craft to walk away with:
<ul class="mainlist">
...
<p>The panel kicks off today around 1PM (we may start late, as some panelists hit flight troubles), and the <a href="http://www.ustream.tv/channel/api-craft">conversation is being live streamed via UStream</a>.
