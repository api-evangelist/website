...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-onion.png" alt="" width="25%" align="right" />
...
<tbody>
<tr>
<td width="50%" align="center" valign="top"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/contact_point_data.png" alt="" width="95%" align="right" /></td>
<td style="text-align: left;" width="50%" align="center" valign="top">
<p><strong>Your Valuable Data</strong><br />This is an example point of contact record. I've worked hard to create this bit of data (not really), and maintain a relationship with this point of contact. It takes time to validate that their record is up to date, always relfecting reality in my database.
...
<p>In an online, always on, digital environment, you want data accessible, but to be able to do this you need to think critically about how you peel back the licensing onion when it comes to this data.
</td>
</tr>
<tr>
<td width="50%" align="center" valign="top"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/contact_point_schema.png" alt="" width="95%" align="right" /></td>
<td style="text-align: left;" width="50%" align="center" valign="top">
<p><strong>The Schema For Your Data</strong><br />The first layer to peel back when you are looking to make data more accessible with APIs is at the schema level. This is the names, description, data type, and other details about the meta layer of your valuable data--it isn't the data, but the description of the structure of your data.
<p>Ideally, your schema already employs predefined schemas like we find at <a href="https://schema.org">Schema.org</a>, or <a href="http://openreferral.org">Open Referral</a>. Following common definitions will significantly widen the audience for any dataset, allowing data to seamlessly be used across a variety of systems. These forms of schema or openly licensed, usually putting into the public domain.
...
<p>Data is often more ephemeral than the schema. Ideally, schemas do not change often, are shared and resused, as well as free from restrictive licensing. For system integrations to work, and for partnerships to be sustainable, we need to speak a common language, and schema is how we describe our data so it can be put to use outside our firewall.
<p>Make sure the schema for your data is well-defined, machine readable, and openly licensed for the widest possible use.
</td>
</tr>
<tr>
<td width="50%" align="center" valign="top"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/contact_point_api.png" alt="" width="95%" align="right" /></td>
<td style="text-align: left;" width="50%" align="center" valign="top">
<p><strong>Defining Access To Data Using OpenAPI&nbsp;</strong><br />The third layer of this licensing onion is the API layer, which governs access to data, defining how requests are made upon data, and how responses are structured. Many API providers are putting <a href="http://openapis.org">OpenAPI</a> to work to define this layer of data operations.
<p>As with the schema layer of data operations, you are hoping that other companies, organizations, institutions, and government agencies will integrate this layer into their operations. This layer is much more permanent than the ephermeral data layer, and should be well defined, ideally sharing common patterns, and free from restrictive licensing.
...
<p>The API layer is not your data. It defines how data will be accessed, and put to use. It is important to separate this layer of your data operations, allowing it to shared, reused, and implemented in many different ways supporting web, mobile, voice, bot, and a growing number of API driven applications.
<p>Make sure the API layer to data operations is well-defined, machine readable, and free from restrictive licensing when possible.&nbsp;
<p>&nbsp;
</td>
</tr>
</tbody>
