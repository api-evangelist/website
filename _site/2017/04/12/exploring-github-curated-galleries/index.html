...
<p><a href="https://github.com/explore"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/github_explore_showcases.png" alt="" width="50%" align="right" /></a>
...
<p>I feel that these nine areas reflect the top uses for Github in 2017:
<ul>
...
<p>It is important to also note that the first area on this list is policies. Providing some important leadership for city, state, and federal government agencies to follow when it comes to crafting policy in an observable way via Github. While not an antidote for all the illnesses of government, it provides an environment where the sunshine&nbsp;can be let in to disinfect the process just a bit.
