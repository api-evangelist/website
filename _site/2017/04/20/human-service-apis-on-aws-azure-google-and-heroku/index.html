...
image: http://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/open_referral_aws_google_azure_heroku.png
---

<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/open_referral_aws_google_azure_heroku.png" alt="" width="30%" align="right" />
<p><a href="https://openreferral.github.io/api-specification/definition/">I have several&nbsp;volunteers available to do work on Open Referral's Human Services Data Specification (API)</a>. I have three developers who are ready to work on some projects, as well as an ongoing stream of potential developers I would like to keep busy working on a variety of implementations. I am focusing attention on the top four cloud platforms that companies are using today: AWS, Azure, Google, and Heroku.&nbsp;
<p>I am looking to develop a rolling wave of projects that will run on any cloud platform, as well as taking advantage of the unique features that each provider offers. I've setup Github projects for managing the brainstorming and development of solutions for each of the four cloud platforms:
<ul>
...
<p>Ideally, we focus on single API implementations, until there is a complete toolbox that helps providers of all shapes and sizes. Then I'd love to see administrative, web search, and other applications that can be implemented on top of any HSDS API. I can imagine the following elements:
<ul>
