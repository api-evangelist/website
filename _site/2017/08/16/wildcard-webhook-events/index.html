...
<p><a href="http://webhooks.apievangelist.com"><img src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-asterisk.png" align="right" width="30%" style="padding: 15px;" /></a>
...
<p>With his round of research, Github has provided me with several webhook nuggets for my API storytelling notebook. One of their web features I though was the notion of a wildcard webhook event:

<blockquote>
  <p><a href="https://developer.github.com/webhooks/">Wildcard Event</a> - We also support a wildcard (*) that will match all supported events. When you add the wildcard event, we’ll replace any existing events you have configured with the wildcard event and send you payloads for all supported events. You’ll also automatically get any new events we might add in the future.
</blockquote>
