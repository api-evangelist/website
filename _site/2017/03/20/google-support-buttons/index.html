...
image: http://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/screen_shot_2017_03_20_at_9.47.56_am.png
...
<p>While there are many Google APIs that still have sub-standard support for their APIs, <a href="https://developers.google.com/sheets/api/support">when you look at Google Sheets you start seeing evidence of their evolved approach to support</a>, with a consistent set of buttons that tackle many of the common areas of <a href="http://support.apievangelist.com">API support</a>. For general questions, Google provides two buttons linked to StackOverflow:
<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/screen_shot_2017_03_20_at_9.41.01_am.png" alt="" width="90%" />
<p>The search just drops you into Stack Overflow, with the tag "google sheets api", and the ask a new question drops you into the Stack Overflow submit new question form. For bug reporting, they provide a similar set of buttons:
<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/screen_shot_2017_03_20_at_9.45.01_am.png" alt="" width="90%" />
...
<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/screen_shot_2017_03_20_at_9.47.56_am.png" alt="" width="90%" />
