...
image: https://s3.amazonaws.com/kinlane-productions2/twitter/twitter-account-activity-api-.png
---

<p><a href="https://dev.twitter.com/webhooks/account-activity"><img src="https://s3.amazonaws.com/kinlane-productions2/twitter/twitter-account-activity-api-.png" align="right" width="40%" style="padding: 15px;" /></a>
...
<p>The Twitter Account Activity API Callback request contains three level of details:
...
<p>The Twitter Account Activity API provides a nice blueprint other API providers can follow when thinking about their own solution. While the schema returned will vary between providers, it seems like the API definition, and the webhook driven process can be standardized and shared across providers.
