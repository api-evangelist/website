...
<p><a href="https://www.zendesk.com/blog/keeping-word-support-sla/"><img src="https://s3.amazonaws.com/kinlane-productions2/zendesk/keeping-your-word-the-support-sla.png" align="right" width="40%" style="padding: 15px;" /></a>
<p>Zendesk gave me some valuable building blocks to add to both my <a href="http://support.apievangelist.com/">API support</a> and API service level agreement research, with <a href="https://www.zendesk.com/blog/keeping-word-support-sla/">their support SLA</a>. This is why I keep an eye on not just how API providers are handling their support, but also how leading support software as a service API providers are setting the bar for how we do support.
