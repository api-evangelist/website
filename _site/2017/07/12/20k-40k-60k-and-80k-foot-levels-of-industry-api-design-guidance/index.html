...
<p><img src="https://s3.amazonaws.com/kinlane-productions2/definition-of-high-altitude.jpg" align="right" width="40%" style="padding: 15px;" />
...
<p>The most prominent discussion in the move from version 1.1 to 1.2 centers around scope of API design at four distinct levels of this work, where we are looking to move forward a variety of API design concerns for a large group of API consumers:
