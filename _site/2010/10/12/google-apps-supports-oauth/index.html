...
<img src="https://kinlane-productions2.s3.amazonaws.com/OAuth.png" alt="" width="250" align="right" /><a href="https://www.google.com/a/">Google Apps</a> recently began supporting OAuth authorization when connecting to the <a href="https://code.google.com/googleapps">Google Apps API</a>.<p>
...
To learn more about the OAuth standard, visit <a href="https://oauth.net">http://oauth.net</a>.
