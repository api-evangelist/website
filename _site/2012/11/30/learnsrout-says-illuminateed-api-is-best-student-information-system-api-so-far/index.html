...
<p><a href="http://learnsprout.com/#home"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/learnsprout/learnsprout-logo.jpg" alt="" width="275" align="right" /></a>
<p>I got an email from Anthony Wu over at <a href="http://learnsprout.com/#home">LearnSprout</a> yesterday.  If you are not following what LearnSprout is up to, they are bridging legacy student information systems (SIS) and providing easy to use web APIs that application developers can use to build educational apps.
<p>The email from Anthony was in regards to a SIS LearnSprout was integrating with, which he said:
...
<p>Even though the API isn&rsquo;t perfect LearnSprout says it is better than:
<ul class="mainlist">
