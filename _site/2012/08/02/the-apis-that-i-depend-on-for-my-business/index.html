...
<p>First I depend on a couple of key Google APIs:
...
<p>I&rsquo;m sure I depend on a lot of APIs, partly because this is my game, I&rsquo;m an API Evangelist.  But it is also because APIs provide me with the data and resources I need to operate, and as a programmer I&rsquo;m able to quickly put APIs to use for my business.
<p>Tracking on the APIs I depend will be a regular part of my IT strategy, and I&rsquo;m even going to publish this as a public page on my websites--showcasing what APIs have done for my business.
