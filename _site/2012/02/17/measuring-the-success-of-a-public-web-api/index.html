...
<p><a href="https://groups.google.com/group/api-craft"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/API-Craft-Logo.png" alt="" align="right" /></a>I'm a member of a Google group called <a title="API Craft" href="https://groups.google.com/group/api-craft">API Craft</a>.  There are some really smart API folks talking about everything from API deployment to API business strategies there. &nbsp;
<p>The other day someone in the groups asked:
...
<p>Scott Regan (<a href="https://twitter.com/#!/scottregan">@scottregan</a>) of <a title="Apigee" href="https://www.apigee.com">Apigee</a> gave a great response, and I wanted to share with everyone here.  Scott&rsquo;s suggestions for measurements were:
<ul class="mainlist">
...
<p>Each API could potentially have different success factors depending on the type of API or the goals of a company.  But revenue, reach, partnerships, apps, traffic and increased brand awareness are good places to start. &nbsp;Thanks Scott.
