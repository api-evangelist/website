...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/CityGrid-Getting-Started.png
---

<p><a title="CityGrid API" href="http://developer.citygridmedia.com"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/citygrid/CityGrid.png" alt="" width="250" align="right" /></a>
<p>Much of the work I get as an <a title="API Evangelist" href="http://www.apievangelist.com">API Evangelist</a> starts with a review of an API area.  I have evolved a way to look at API areas, and identify which building blocks are present or missing, all contributing to the success or failure of an API.
...
<p>When I first started working with <a title="CityGrid" href="http://www.citygrid.com">CityGrid</a> I reviewed their API area, which contained the following building blocks:
<ul class="mainlist">
...
<p><a href="http://docs.citygridmedia.com/display/citygridv2/Getting+Started"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/citygrid/CityGrid-Getting-Started.png" alt="" width="300" align="right" /></a>
...
<p>An API has to have a getting started page as well as a place for frequently asked questions.  Developers have to find the information they need to go from evaluation to integration without asking for help.
