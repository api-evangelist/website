...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/APIphany-Logo.png
---

<p><a title="APIPhany" href="http://www.apiphany.com/"><img src="https://s3.amazonaws.com/kinlane-productions2/api-service-providers/apiphany/APIphany-Logo.png" alt="" width="250" align="right" /></a>
...
<p>I&rsquo;ve been watching their progress and they have 3 very cool projects made public so far:
<ul class="mainlist">
<li><strong><a href="https://developer.washingtonpost.com/">Washington Post</a> -</strong> Developer area for Washington Post, providing some endpoints including an Issue Engine API, White House Visitors Log API,  and the Campaign Finance API</li>
...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/api-service-providers/apiphany/apiphany-team.jpg" alt="" width="300" align="right" />
<ul class="mainlist">
...
<p>APIphany also gives you the ability to host the API in a variety of cloud providers, and my favorite is they provide you with an API to manage your API.  The team has been building and managing web APIs for government, enterprise, and non-profit customers since 2006--so they get it.
