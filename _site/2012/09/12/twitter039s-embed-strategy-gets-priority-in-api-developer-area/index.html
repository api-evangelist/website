...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/twitter-bird-light.png
...
<p>I noticed that Twitter gave it&rsquo;s embeddable tools feature status in the <a href="https://dev.twitter.com/">Twitter developer area</a>:
<p><a href="https://dev.twitter.com/" target="_blank"><img style="display: block; margin-left: auto; margin-right: auto; padding-top: 10px; padding-bottom: 10px;" src="https://s3.amazonaws.com/kinlane-productions2/twitter/Twitter-Developers-Embed.png" alt="" width="600" /></a>
...
<p>Twitter&rsquo;s move is similar to that of <a href="/2011/04/13/linkedin-api-platform-and-the-evolution-of-the-api/">LinkedIn, who also de-emphasized their API interfaces and offered various embeddable tools, badge and widget builder tools</a> that help extend the API across the interwebz.
