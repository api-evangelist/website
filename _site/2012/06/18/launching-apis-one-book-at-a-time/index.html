...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/pearson-nursing-guide.jpg
---

<p><a href="http://developer.pearson.com/api/nursing-health-survival-guides-api/apimethod/get-article/189/overview" target="_blank"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/pearson/pearson-nursing-guide.jpg" alt="" width="175" align="right" /></a>
...
<p>Pearson is obviously being very cautious with their precious business assets. Taking time to do it right when bundling up these resources and making available for developers via a RESTful interface.
...
<p>It makes sense for Pearson to take it slowly and learn with each API implementation, making sure they do it right.  I think Pearson&rsquo;s simplistic approach to opening up their catalog is a great example for other publishers to follow.
