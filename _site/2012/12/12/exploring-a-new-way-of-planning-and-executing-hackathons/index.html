...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/oc-hackerz-logo.jpeg
---

<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/hackweekends/oc-hackerz/oc-hackerz-logo.jpeg" alt="" width="150" align="right" />
...
<p>The Hack Weekends guide provides a very detail guide to throwing a hackathon, and I also included a <a href="https://kinlane.github.com/hack-weekends-guide/">website template that runs on Github Pages</a> using Jekyll.  My goal is to make it a plug-n-play guide with all the tools and resources you need to be successful in your communities hackathon
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/hackweekends/hackathon-home-2.jpg" alt="" width="250" align="right" />
<p>Next I need to actually prove my &ldquo;open source&rdquo; approach to planning, designing and marketing hackathons.  I&rsquo;m planning several hackathons to make sure the process works.  The first hackathon I am planning is for <a title="OC Hackerz" href="https://www.meetup.com/OCHackerz/">OC Hackerz</a> in Orange County, California.  OC Hackerz is a big supporter of developers, and is in sync with my vision of what the hackathon space should look like, so they are a great partner to plan two initial hackathons:
<ul class="mainlist">
<li><a title="OC Hackerz Hackathon Los Angeles" href="https://kinlane.github.com/oc-hackerz-hackathon/">OC Hackerz Hackathon - Los Angeles - March 2013</a></li>
</ul>
<p>The planning of the OC Hackerz Hackathon is meant to be an exploratory deployment of the Hack Weekends Guide, intended to make hackathon planning an open and collaborative process between organizers, sponsors and the local stakeholders.
