...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/scripting-platforms.jpg
---

<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/scripting-platforms.jpg" alt="" width="300" align="right" />
...
<p>One trend I&rsquo;m tracking on is the emergence of API scripting platforms.  This is a difficult are to track on, because we script against APIs all the time, right? This is different.  Scripting platforms are providing platforms and libraries to support easily scripting against multiple APIs.
<p>To help me understand this new approach to using APIs I&rsquo;m studying three separate approaches:
<ul class="mainlist">
...
<p>All three of these platforms are bringing together valuable API resources, from multiple sources into not just a common interface, but providing a language library you can use to build apps efficiently across multiple API resources.
...
<p>Google Apps Script provides access to Google APIs and services, but recently opened up scripts to acts as connectors, that can be developed by 3rd party providers.  Temboo has over 100 APIs in its library, while Webshell is just getting going with less than 25.
...
<p>This area is new and emerging, and I&rsquo;m still working to understand the different approaches.  let me know if you if you have anything I should be looking at or other thoughts. &nbsp;
<p>More to come...
