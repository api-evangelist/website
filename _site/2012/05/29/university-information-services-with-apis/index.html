...
<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/universities/UW_W-Logo_RGB.gif" alt="" width="150" align="right" />
<p>APIs are making information more accessible across many industries and sectors, but one area I haven&rsquo;t seen a lot of movement, until recently, is at Universities.
<p>Last month, <a href="https://blogs.law.harvard.edu/pamphlet/2012/04/27/the-new-harvard-library-open-metadata-policy/">Harvard openly licensed their library meta data</a> and through a partnership with the <a title="Digital Public Library of America" href="https://cyber.law.harvard.edu/research/dpla">Digital Public Library of America</a>, made it <a href="http://openmetadata.lib.harvard.edu/content/digital-access-scholarship-harvard-dash-dataset">available via APIs</a>.  But today&rsquo;s story is more about APIs driving the operations side of higher ed at the <a title="University of Washington" href="http://webservices.washington.edu/">University of Washington.</a>
<p>Under the Universities of Washingtons web services site, you can learn, discover and connect to 29 separate University APIs:
...
<p>Its grest to see that the University is trying to create a single directory of all University web services, and even has an API suggestion service where students and faculty can submit and vote on ideas for new, useful campus APIs.
<p><a title="University of Washington" href="http://webservices.washington.edu/"><img style="padding: 15px; display: block; margin-left: auto; margin-right: auto;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/universities/UW-Web-Service-Registry.png" alt="" width="450" /></a>
