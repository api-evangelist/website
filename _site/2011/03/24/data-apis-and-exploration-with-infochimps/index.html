...
<p>You can search for data that is free or paid, available for download or through their API, alphabetically, or by upload date.
<p>Infochimps is also looking for suggestions for new APIs and datasets, you can submit ideas using the <a title="Infochimps UserVoice" href="https://infochimps.uservoice.com/forums/55516-infochimps-api-data-sets">Infochimps UserVoice</a> page.
