...
Apache Solr is one indexing tool you can deploy as part of your API area, but there are also lower impact solutions such as <a title="Google Custom Search" href="https://www.google.com/cse/">Google Custom Search</a> that can be deployed as an external service, without investing in costly equipment or software.<p>
