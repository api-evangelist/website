...
image: http://kinlane-productions2.s3.amazonaws.com/stack-overflow/Stack-Apps-Registration.png
---

<a href="http://www.stackapps.com"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/stack-overflow/Stack-Apps-Registration.png" alt="" width="350" align="right" /></a>You want to make it as easy as possible for developers to get up and running with your <a href="http://www.apievangelist.com/">API</a>.<p>
You don't want developers to fumble around with lengthy registrations and approval processes.<p>
Your API registration needs to be simple and self-service. <a href="https://openid.net" target="_blank">OpenID</a> is one way to do this.<p>
<a href="https://stackapps.com">StackApps</a>, the <a href="https://stackoverflow.com">Stack Overflow</a> API demonstrates this perfectly.<p>
