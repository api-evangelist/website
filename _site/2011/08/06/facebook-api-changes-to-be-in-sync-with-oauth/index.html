...
image: http://kinlane-productions2.s3.amazonaws.com/facebook/facebook-operation-developer-love.png
---

<img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/facebook/facebook-operation-developer-love.png" alt="" width="150" align="right" />In order to be compliant with the <a title="oAuth Spec" href="https://tools.ietf.org/html/draft-ietf-oauth-v2-20">OAuth spec</a>, <a title="Facebook is making changes to their auth APIs" href="https://developers.facebook.com/blog/post/533/">Facebook is making changes to their auth APIs</a>. As part of this update, they will be deprecating 'code_and_token' and need developers to use 'code%20token'. Everything else is identical, just replace '_and_' with encoded'%20'.<p>
...
Developers are required to make this change by November 5th, 2011, and Facebook has <a title="updated their roadmap" href="https://developers.facebook.com/roadmap/">updated their roadmap</a> to reflect this.<p>
