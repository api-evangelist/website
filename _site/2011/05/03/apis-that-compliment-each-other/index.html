...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist/Rdio-Logo-Gradient.png
---

<a href="http://rdio.com"><img style="padding: 10px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/Rdio-Logo-Gradient.png" alt="" width="200" align="right" /></a>I'm starting to see more API providers working together to attract developers to their platforms.<p>
...
They are partnering behind the scenes, but I'm sure the API is the driving force behind this relationship.<a title="The Echo Nest" href="http://the.echonest.com/"><img style="padding: 10px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/the-echo-nest.gif" alt="" width="200" align="right" /></a><p>
