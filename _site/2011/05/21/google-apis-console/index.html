...
<img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/google/Google-APIs-Console-1.png" alt="" width="375" align="right" />
<ul class="mainlist">
	<li><a title="Google Books API" href="https://code.google.com/apis/books/">Books API</a></li>
	<li><a title="Buzz API" href="https://code.google.com/apis/buzz/">Buzz API</a></li>
	<li><a title="Custom Search API" href="https://code.google.com/apis/customsearch/">Custom Search API</a></li>
	<li><a title="Diacritize API" href="https://code.google.com/apis/language/diacritize/overview.html">Diacritize API</a></li>
	<li><a title="Latitude API" href="https://code.google.com/apis/latitude/">Latitude API</a></li>
	<li><a title="Moderator API" href="https://code.google.com/apis/moderator/">Moderator API</a></li>
	<li><a title="Page Speed Online API" href="https://code.google.com/apis/pagespeedonline/">Page Speed Online API</a></li>
	<li><a title="Places API" href="https://code.google.com/apis/maps/documentation/places/">Places API</a></li>
	<li><a title="Prediction API" href="https://code.google.com/apis/predict/">Prediction API</a></li>
	<li><a title="Search API for Shopping" href="https://code.google.com/apis/shopping/search/">Search API for Shopping</a></li>
	<li><a title="Site Verification API" href="https://code.google.com/apis/siteverification/">Site Verification API</a></li>
	<li><a title="Storage API" href="https://code.google.com/apis/storage/">Storage</a></li>
	<li><a title="Tasks API" href="https://code.google.com/apis/tasks/">Tasks API</a></li>
	<li><a title="Translate API" href="https://code.google.com/apis/language/">Translate API</a></li>
	<li><a title="URL Shortener API" href="https://code.google.com/apis/urlshortener/">URL Shortener API</a></li>
</ul>
