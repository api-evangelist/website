...
<p><a title="Mimeo" href="http://www.mimeo.com"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/mimeo/mimeo-logo-250.jpg" alt="" width="200" align="right" /></a>
<p>At <a title="Mimeo" href="http://www.mimeo.com">Mimeo</a> we have demo Fridays where anyone can demo what they&rsquo;re working on.  For demo Fridays I tend to build prototypes showing different ways to integrate with the <a title="Mimeo Document Printing APIs" href="https://mimeoconnect.3scale.net/">Mimeo Document Printing APIs</a>.  As my schedule has gotten busier this fall, with more developer support, and attending hackathons and conferences, I don&rsquo;t always have time to polish a prototype for Friday demos.
<p>So this Fridays demo I started showcasing some of the ideas I&rsquo;m brainstorming with other developers, and the potential ways they might use our APIs.  Here are the four I demoed today:
<ul class="mainlist">
...
<p>Internal API evangelism is an ever increasing part of my API evangelist role.  Making everyone at Mimeo aware of what I am doing with our APIs, as well as what other types of platforms and APIs are available,  all contributes to more awareness and engagement across the company.
