...
<p><a title="Klout API" href="http://developer.klout.com/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/klout/Klout-API-Overview.jpg" alt="" width="300" align="right" /></a>
...
<p>The Klout API opens up a lot of opportunities for web and mobile app developers to enrich their understanding of their existing user base, identifying the users that are the biggest influencers, and may contribute to a larger network effect around their application.
<p>Klout has delivered their API using the <a title="Mashery API Platform" href="/serviceproviders/mashery.php">Mashery API platform</a>, you can register for an API key and learn more about the platform at <a title="developer.klout.com" href="http://developer.klout.com">developer.klout.com</a>.
