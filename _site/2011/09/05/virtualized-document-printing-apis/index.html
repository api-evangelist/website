...
<p><a href="https://mimeoconnect.3scale.net/wiki/poster-printing-api"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/mimeo/posters-sample.png" alt="" width="150" align="right" /></a> <span>These three areas proved to be the difference between some users adopting, and others walking away. &nbsp;There was too much work in navigating the world of Mimeo accounts and documents. &nbsp;This isn&rsquo;t hard if your already a Mimeo web to print user, but if your a developer you just want to print. &nbsp;</span><br /><br /><span>So I created four virtualized print APIs. &nbsp;&nbsp;I took a REST framework and deployed four separate &ldquo;<a title="Document Printing APIs" href="https://mimeoconnect.3scale.net/">document printing APIs</a>&rdquo;:</span>
<ul class="mainlist">
...
<p><span>Then using <a title="3Scale API Management Solution" href="../../serviceproviders/3scale.php">3Scale self-service API management solution</a> I deployed an API area to handle documentation, forum and developer registration and API key management. &nbsp;Each API has seven methods for ordering print documents:</span>
<ul class="mainlist">
<li>Proof (POST)</li>
<li>Proof (GET)</li>
<li>Quote (GET)</li>
...
<p><a href="https://mimeoconnect.3scale.net/wiki/spiral-notebook-printing-api"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/mimeo/Spiral-Notebook-Example-Image.png" alt="" width="150" align="right" /></a> <span>All a developer has to do is <a title="register for a set of keys" href="https://mimeoconnect.3scale.net/plans">register for a set of keys</a>, grab a code sample and get to work. &nbsp;They don&rsquo;t have to setup a Mimeo account or build the documents they want to use. &nbsp;If they want a poster, they use the <a title="Poster Printing API" href="https://mimeoconnect.3scale.net/wiki/poster-printing-api">Poster Printing API</a> and pass the size, paper, mounting and lamination settings, along with the URL of the PDF they want to print.</span><br /><br /><span>These four APIs represent a process I will use to virtualize other API instances on top of the Mimeo Connect REST API, and possibly other APIs too. &nbsp;It is pretty quick for me to bundle the data, settings, and code for a new virtualized API and deliver an entirely new type of document printing API. &nbsp;&nbsp;</span>
<p>This will give me an agile way to play around with new configurations of APIs, measure their response using the <a title="3Scale" href="https://www.3scale.net/">3Scale API</a> analytics, and decide whether or not I put more resources into an specific type of API.
