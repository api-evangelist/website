...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/transit-1.jpg
---

<p>
     <img class="c1" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/public-transit/transit-1.jpg" alt="" width="250" align="right" /><span id="internal-source-marker_0.029792157467454672">I’m working on some more stories around municipal data APIs, based upon two stories I found recently, where developers took it upon themselves to scrape data, launch APIs, and build mobile tools around local municipal transit data:</span>
...
<p>
     <span>I still haven't fully flushed out my stories around both these municipal APIs, but it sure smells like an opportunity for some tech companies to get involved.  You a captured audience of commuters across the globe, needing more information about their daily bus, train and subway.  This need is so great, tech savvy commuters are scraping and building their own systems to meet this need.  </span><br />
     <br />
     <img class="c1" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/public-transit/transit-2.jpg" alt="" width="250" align="right" /><span>I know Google is stepping up to serve this space with <a title="Google Maps API" href="https://code.google.com/apis/maps/index.html">Google Maps</a> and <a title="Google Transit" href="https://www.google.com/intl/en/landing/transit/#mdy">Google Transit</a>.  They even have released the <a title="Google Transit Feed Specification" href="https://code.google.com/transit/spec/transit_feed_specification.html">General Transit Feed Specification</a>, to help define a common format for public transportation schedules and associated geographic information.  But I think their are huge opportunities for companies to step up and coordinate transit APIs, at the country or regional level, and also for developers to provide local resources for "acquiring" of local data, understanding local constraints, and be the overall contact for a specific locale.</span><br />
     <br />
     <span>With a clear problem defined, a captured audience rapidly adopting mobile technology, and a developer resource that is willing to invest time and resources to build out APIs, mobile and web apps, and create data visualizations--it just seems like an API industry that is in need of some leadership and coordination.</span><br />
     <br />
     <span>Do you know of other municipal data API stories?  <a title="Let Me Know" href="/contact.php">Let me know</a>.</span>
