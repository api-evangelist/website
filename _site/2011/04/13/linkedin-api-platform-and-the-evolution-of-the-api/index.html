...
image: http://kinlane-productions2.s3.amazonaws.com/linkedin/LinkedIn-Developer-Network.png
---

<img src="https://kinlane-productions2.s3.amazonaws.com/linkedin/LinkedIn-Developer-Network.png" alt="" width="250" align="right" /><a title="LinkedIn" href="http://www.linkedin.com">LinkedIn</a> refreshed its <a title="LinkedIn Developer Platform" href="https://developer.linkedin.com/">developer platform</a> recently, updating its <a title="RESTful API" href="https://developer.linkedin.com/community/apis">RESTful API</a> and <a title="JavaScript API" href="https://developer.linkedin.com/community/jsapi">JavaScript API</a>.<p>
A noticeable change, was its continued evolution towards a more plug and play API environment.<p>
When you visit the <a title="LinkedIn Developer Area" href="https://developer.linkedin.com/index.jspa">LinkedIn developers area</a>, the first option on the menu is plug-ins, and the main page is totally dominated by embeddable profile tools.<p>
