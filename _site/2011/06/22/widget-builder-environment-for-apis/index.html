...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist/apigee-api-console.jpg
---

<a title="Apigee Console" href="https://apigee.com/about/products_togo.html"><img class="c1" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/apigee-api-console.jpg" alt="" width="250" align="right" /></a>There are many tools out there for working with Web APIs, but the one I am seeing used more and more is an API explorer. API explorers allow users to make calls and explore REST APIs using a Web interface -- all without writing code.
<p>These <a title="API explorers" href="http://blog.apievangelist.com/2011/03/24/explorers-open-api-access-beyond-developers/">API explorers</a> are making it a lot easier for developers to discover, learn, and integrate with Web APIs. I also think they have a lot more potential, beyond the developer community.
<p>Non-developers can use an API explorer to make calls against an API, retrieve JSON, and then use tools like Google Spreadsheets to process responses, building visualizations, and so on.
<p>There is a huge opportunity for API explorer providers to tap into the larger, non-developer community, and one of the easiest ways to do this may be by adding a widget layer to their applications.
<p>An API widget builder would have similar features to the <a title="Integrated Development Environment (IDE) for APIs" href="http://blog.apievangelist.com/2011/06/18/integrated-development-environment-ide-for-apis/">Integrated Development Environment (IDE) for APIs</a> I proposed last week:
<ul class="mainlist">
     <li>
...
</ul><a title="WolframAlphas widget builder" href="https://developer.wolframalpha.com/widgetbuilder/"><img class="c1" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/wolfram-alpha/wolfram-alpha-widget-builder.png" alt="" width="250" align="right" /></a>Then I would add a new layer to the environment:
<ul class="mainlist">
     <li>
...
<p>There are a couple of widget building platforms out there like <a title="Sprout Inc" href="http://sproutinc.com/">Sprout Inc</a> or <a title="Widgetbox" href="http://www.widgetbox.com/overview/">Widgetbox</a>, but I'm picturing something more like <a title="WolframAlphas Widget Builder" href="https://developer.wolframalpha.com/widgetbuilder/">WolframAlpha's widget builder</a>. Take <a title="Apigee Console" href="https://apigee.com/about/products_togo.html">Apigee Console</a> and add a widget builder like WolframAlpha's, and I think you'd have something close to what I'm envisioning.
<p>I hope some existing API service provider or IDE developer sees the opportunities within the API space and builds a developer IDE and widget builder for APIs.
