...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist/factual/factual-logo.png
---

<a href="http://www.factual.com/"><img class="c1" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist/factual/factual-logo.png" alt="" align="right" /></a><a href="http://www.factual.com/">Factual</a> is an open data platform and community, with a goal to maximize data accuracy, transparency, and availability. They provide a marketplace of evolving data on thousands of topics.
<p>Factual provides a RESTful API that returns JSON response, using an application key for authentication. Factual provides full data sets for download, Ruby Gem and IPhone SDK for development.
