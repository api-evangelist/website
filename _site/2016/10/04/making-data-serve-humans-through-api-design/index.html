...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-waiter.png" alt="" width="25%" align="right" />
...
<p>There is a great excerpt from a story by Sara M. Watson (<a href="https://twitter.com/smwat">@smwat</a>), called <a href="http://dismagazine.com/discussion/73298/sara-m-watson-metaphors-of-big-data/">Data is the New &ldquo;___&rdquo;</a>&nbsp;that sums up this for me:
<p style="padding-left: 30px;"><em>The dominant industrial metaphors for data do not privilege the position of the individual. Instead, they take power away from the person to which the data refers and give it to those who have the tools to analyze and interpret data. Data then becomes obscured, specialized, and distanced.</em>
<p style="padding-left: 30px;"><em>We need a new framing of a personal, embodied relationship to data. Embodied metaphors have the potential to bring big data back down to a human scale and ground data in lived experience, which in turn, will help to advance the public&rsquo;s investment, interpretation, and understanding of our relationship to our data.</em>
<p style="padding-left: 30px;"><em>DATA IS A MIRROR portrays data as something to reflect on and as a technology for seeing ourselves as others see us. But, like mirrors, data can be distorted, and can drive dysmorphic thought.</em>
