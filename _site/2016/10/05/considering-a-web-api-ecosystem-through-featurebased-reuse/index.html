...
image: http://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/screen_shot_2016_10_04_at_11.24.39_am.png
---

<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/screen_shot_2016_10_04_at_11.24.39_am.png" alt="" width="48%" align="right" />
...
<p style="padding-left: 30px;"><em>In order to evolve Web API design from an art into a discipline with measurable outcomes, we propose an ecosystem of reusable interaction patterns similar to those on the human Web, and a task-driven method of measuring those.</em>
...
<p>I support everything they propose. I cannot provide any critique on the technical merits of their vision. However, I find it lacks an awareness of the current business&nbsp;and political landscape that I find regularly present in the hypermedia, and linked data material I consume.
<p>Here are a few of the business and political considerations that contribute to the situation we find ourselves in that&nbsp;Verborgh and Dumontier are focused on, which will also work to slow the adoption of their proposed vision:
<ul>
