...
<p>It definitely sucks that Parse went away like they did, but you have to commend them on the <a href="https://www.parse.com/">page they left behind</a>. Facebook put up the download link to an open source version of Parse Server, and a link to the migration guide. I like that they also left up the blog, which I think is almost just as important as the code, telling the story of what happened, right up to the end.
<p><a href="https://www.parse.com/"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/parse-page.png" alt="" width="100%" /></a>
