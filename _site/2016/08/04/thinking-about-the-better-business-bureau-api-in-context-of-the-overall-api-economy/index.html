...
<p><a href="https://developer.bbb.org"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/bbb.jpg" alt="" width="35%" align="right" /></a>
...
<p>The Better Business Bureau&nbsp;provides five API endpoints for consumers:
<ul>
<li><strong><a href="https://developers.bbb.org/documentation/endpoints/organization-search/">Organization Search</a></strong> - This endpoint will allow you to search for Organizations that are known to the BBB. &nbsp;Organizations may include businesses or charities.</li>
<li><strong><a href="https://developers.bbb.org/documentation/endpoints/organization-collections/">Organization Collections</a> -</strong> BBB Partners will need to be able to identify collections of Organizations that they care about and be able to manage those collections and receive Organization info and updates on them as needed.</li>
<li><strong><a href="https://developers.bbb.org/documentation/endpoints/bulk-retrieval/">Bulk Retrieval</a> -</strong> This section defines the message specification that will be sent back to the API partners who request a bulk data transfer. &nbsp;</li>
<li><strong><a href="https://developers.bbb.org/documentation/endpoints/push-notifications/">Push Notifications</a> - </strong>BBB Partners have the need to be notified when BBB data updates occur for the records or a collection of records they are currently subscribed to.</li>
<li><strong><a href="https://developers.bbb.org/documentation/endpoints/bbb-investigation-application-for-accreditation/">BBB Investigation/Application for Accreditation</a></strong> - This endpoint allows submission of organizations for BBB investigation and application for BBB accreditation.</li>
</ul>
