...
image: http://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/materia_screen_entities.png
---

<p><a href="https://getmateria.com/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api_evangelist_site/blog/materia_screen_entities.png" alt="" width="40%" align="right" /></a>
<p>I was playing with a new API design and deployment solution, from some of my favorite developers out there this weekend called <a href="https://getmateria.com/">Materia</a>, which bills itself as <em>"a modern development environment to build advanced mobile and web applications"</em>--I would add, <em>"with an API heart"</em>.
...
<p>I know they are just getting going with developing Materia, but I can't help but share a couple things I'd like to see, that would make it continue to be the modern API driven application it is striving to be:
<ul>
...
<p>There are a number of other things I'd like to see, but I'm sensitive to the fact that they are just getting started. These three areas would significantly widen the initial audience for Materia beyond the developer class, which is who the application solution should be targeting. Like I said, it has the potential to be the Microsoft Access of APIs for small businesses, which isn't quite the Microsoft Excel of APIs, but a close second. ;-)
<p>Nice work guys! It is the another positive advancement in the world of API design alongside&nbsp;<a href="https://restlet.com/products/restlet-studio/">Restlet launched their API design studio</a>, and <a href="https://apiary.io">Apiary</a> setting&nbsp;<a href="http://apievangelist.com/2011/10/07/easy-api-development-with-apiaryio/">this modern era of API design into motion with Apiary</a>. I'll be tuning into Materia's evolution on <a href="https://twitter.com/MateriaHQ">Twitter</a>, and play more with the <a href="https://github.com/webshell/materia-server">server</a> and <a href="https://github.com/webshell/materia-designer">designer</a> editions available on Github.
