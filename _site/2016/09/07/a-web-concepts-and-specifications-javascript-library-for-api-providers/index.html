...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/tooltip-js-for-web-api-concepts.png
---

<p><a href="http://darsa.in/tooltip/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/tooltip-js-for-web-api-concepts.png" alt="" width="40%" align="right" /></a>
<p>One of the prototypes I am going to build on top of Erik Wilde's (@dret) <a href="http://webconcepts.info/">WebConcepts.info work</a>, is a simple JavaScript library that you can embed on any API documentation page, and point at the body, or any other element on the page and it will find and replace any keywords or phrases with popup &nbsp;showing a definition, with a link to Erik's work and the standard(s) home page.&nbsp;
