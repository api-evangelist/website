...
<p class="text-description" style="padding-left: 30px;"><em>Welcome to our hub for partner guidelines and assets. We want to make it easy for you to integrate Spotify in your app while respecting our brand and legal/licensing restrictions.</em>
...
<p>Additionally, I think the closing page for the Spotify design resources page has a couple more lessons:
<p style="padding-left: 30px;"><em>If you are having trouble with anything in this guide, you are missing brand elements from the brand package, or you are unsure if your communication best represents the Spotify brand, please contact the Spotify design team. </em>
<p><em> </em>
<p><em>I would add contact information, and suggestions, as two new elements to consider when crafting a branding page. I have a handful of other branding pages from the API providers to review. I'll continue posting stories about each one (if worthy), as I mine them for other helpful elements that API providers might want toÂ think about when crafting their own page.</em>
