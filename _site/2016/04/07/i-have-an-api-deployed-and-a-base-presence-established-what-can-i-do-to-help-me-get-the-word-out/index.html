...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-api-outreach.png" alt="" width="250" align="right" />
...
<p><strong>What Are The Goals</strong><br />What are the core goals of the API operation? These need to be precise, measurable, and obtainable goals. While there may be unique ones to your situation, these are some of the common ones I see employed regularly.
<ul>
...
<p><strong>Partner Storytelling Activities</strong><br />Your partners are always looking to get some special attention when it comes to blogging, storytelling, and outreach. &nbsp;What are some of the elements that can be considered when looping in partners into your outreach and engagement efforts.
<ul>
...
<p>Showcasing the right partners, in just the right way, can send the signals you need to potentially new customers, and partners. Make a regular habit of asking partners for quotes, testimonials, and to be able to use their logo. Maybe even make it a default requirement as part of the partner application process.
<ul>
</ul>
...
<ul>
<li><strong>Competition Monitoring -&nbsp;</strong>Who is the competition? What are they up to? How do we compare?</li>
...
<p>Landscape awareness isn't about the numbers, it is about awareness. It is about knowing what your industry is up to, what matters, and in tune with what the competition is up to. Most importantly, it is about picking up your head, and looking beyond your firewall, and seeing the bigger picture.
<ul>
</ul>
...
<p><strong>Support</strong><br />What role does support play in the overall evangelism workflow. Evangelism and outreach is not just about marketing and sales, with much of the tone of evangelism being set by the overall approach to support (or no approach).
<ul>
...
<p>I do not push every social network, in every scenario. Sometimes Facebook makes sense, and sometimes it doesn't. You will know your audience better than I will, but either way it shakes out, make sure and have a healthy, active, and valuable presence on social media to stay connected with your audience.
<ul>
</ul>
<p><strong>Social Bookmarking</strong><br />Beyond just social networks, some social bookmarking sites can also be important to the API evangelism workflow. Here are some of the social bookmarking sites in use today, that you should be considering.
<ul>
...
<p>Like other channels, these bookmarking sites are not just one way channels to share links out. The management of profiles, engagement with other users, and discovery of new sites, applications, APIs, and other interesting elements is a required part of the dance.
...
<li><strong>Bookmarklet -&nbsp;</strong>Are there bookmarklets available for consumers to embed on websites, that uses the API?</li>
</ul>
...
<p><strong>Events &amp; Gatherings</strong><br />Events are the in-person, retail face of any API platform. While much work can be done in an online environment, also make sure you are available at events where API consumers will already be. There are a number of proven types events, that work for API evangelism.
<ul>
...
<p>It can be easy to spend a lot of money in this area, in an effort to be everywhere. A successful, in-person API outreach strategy, is always in sync with a robust, active, online presence. &nbsp;Make sure you efforts here are genuine, and in alignment with the other virtual elements discussed here.
<ul>
</ul>
...
<p><strong>API Definition Formats</strong><br />A machine readable specification is designed to assist in the area of API discovery. This allows APIs, and their supporting operations to be described in a way that can ingested, and indexed by API search engines, and directories.
<ul>
...
<p>These formats make APIs discoverable by other systems, and tools, but also open them up for sharing, collaboration, and syndication. Think of these API definitions like little machine readable business cards, that can be left anywhere for potential consumers to find.
<ul>
</ul>
<p><strong>API Directories</strong><br />Next up, are some API directories that exist publicly, and provide directories that developers can browse, and search for APIs by keywords. There are a handful of examples of available when it comes to relevant API directories you should be considering today.
<ul>
...
<p>This are is meant to serve the public APIs that are embarking on this journey. These are the leading API directories out there, that allow API platforms to list their APIs, and benefit from discovery, and other network effects these platforms bring to the table.
<p><strong>API Search Engines</strong><br />Beyond just API directories, there are also a new breed of API search engines emerging, that allow for API discovery that goes beyond just static API browsing and search. Currently there is just one API search engine.
<ul>
...
<p><strong>Business Directories</strong><br />Business directories that allow for additional information related to APIs, as well as having APIs themselves, allowing for discovery of APIs from companies who list themselves in these directories.
<ul>
<li><strong>Crunchbase -&nbsp;</strong>Is the business and its public APIs documented with Crunchbase?</li>
