...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/api-image.png
---

<p><img src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-api-a.png" alt="" width="50" align="right" />
...
<p><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/api-image.png" alt="" width="50" align="right" />
...
<p><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/api-industry-icons.png" alt="" width="100%" />
<p>I would like to see a single universal, community driven icon to represent the concept of a web API. I would also like to see similar icons for formats used across the space, as well as vendor specific icons. If you look at <a href="http://stack.apievangelist.com/companies.html">my personal API stack</a>, as well as <a href="http://theapistack.com/companies.html">my overall stack</a>, you see me using a mix of format, and vendor icons to document a pretty complex assortment of API driven resources, and information. I'd like to step this up a bit, be able to standardize across not just my network of sites, but the overall API community.&nbsp;
