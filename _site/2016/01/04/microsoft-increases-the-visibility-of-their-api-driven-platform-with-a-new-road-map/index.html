...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/microsoft-cloud-platform-roadmap.png
---

<p><a href="https://www.microsoft.com/en-us/server-cloud/roadmap/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/microsoft-cloud-platform-roadmap.png" alt="" width="45%" align="right" /></a>
<p>A road map for your API, is one of those essential building blocks that can go a long way in building trust with your API consumers. Sharing your plans, helps developers prepare for the future, and better plan for their own road maps, keeping everything potentially in sync.&nbsp;
...
<p>Overall, I like the simplicity of the <a href="https://www.microsoft.com/en-us/server-cloud/roadmap/">Microsoft cloud platform road map</a>, and it is definitely a healthy building block I'd encourage other API providers to consider offering as well. I'm going to make sure Microsoft's roadmap is one of the examples I cite <a href="http://management.apievangelist.com/">along the API management line</a>, as part of my overall API life cycle map.&nbsp;
