...
<p><a href="http://tos.apievangelist.com/"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-terms-conditions.png" alt="" width="175" align="right" /></a>
<p><span>I am spending a significant amount of time looking through the pricing pages for leading API providers, working to get a sense for some of the common approaches to API monetization in use across the space. Along the way I am also finding some simple and unique approaches from API providers that I wanted to share as bit-size API planning stories here on the blog.</span>
<p>As I was working to understand the coupling between the <a href="https://www.box.com">Box SaaS business model</a>, and the one applied to their API, I noticed an interesting element, <a href="https://www.box.com/pricing/">that was part of their enterprise API plan--custom terms of service</a>. At first glance it doesn't seem like much, but making elements of your TOS dynamic, allowing them up to be used as a metric within your API plans, opens up a whole world of possibilities.&nbsp;
