...
<p><img style="padding: 5px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-getpostputdelete.png" alt="" width="200" align="right" />
...
<p class="p1" style="padding-left: 30px;"><a href="https://aws.amazon.com/s3/pricing/"><em>PUT, COPY, POST, or LIST Requests = $0.005 per 1,000 requests ,GET and all other Requests = $0.004 per 10,000 requests, with delete requests being free</em></a>
