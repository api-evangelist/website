...
<p><a href="http://monitoring.apievangelist.com/"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-heart-monitor.png" alt="" width="250" align="right" /></a>
...
<p>All I do, is craft an OADF file for each of the API service providers I track on, within each area of my research. I'm spending time tonight working on my <a href="http://monitoring.apievangelist.com/">API monitoring research</a>, so I look at three of the service providers I track on, who have APIs. The OADF specs are not complete, but provide me a baseline definition for the surface area of each API, something I'll round out with more use. Here are the endpoints I have from each provider so far.
<p><strong><a href="https://www.apiscience.com/docs/api">API Science Monitors API</a></strong>&nbsp;(<a href="http://theapistack.com/data/api-science/api-science-monitors-api-swagger.json">oadf</a>)
...
<p><strong><a href="https://www.runscope.com/docs/api/tests">Runscope API</a></strong>&nbsp;(<a href="http://theapistack.com/data/runscope/runscope-api-swagger.json">oadf</a>)
<ul id="runscope-api">
...
<p><strong><a href="https://apimetrics.readme.io/">APIMetrics Auth API</a></strong>&nbsp;(<a href="http://theapistack.com/data/apimetrics/apimetrics-workflows-api-swagger.json">oadf</a>)
...
<p><strong><a href="https://apimetrics.readme.io/">APIMetrics Calls API</a></strong>&nbsp;(<a href="http://theapistack.com/data/apimetrics/apimetrics-workflows-api-swagger.json">oadf</a>)
...
<p><strong><a href="https://apimetrics.readme.io/">APIMetrics Deployments API</a></strong>&nbsp;(<a href="http://theapistack.com/data/apimetrics/apimetrics-workflows-api-swagger.json">oadf</a>)
...
<p><strong><a href="https://apimetrics.readme.io/">APIMetrics Reports API</a></strong>&nbsp;(<a href="http://theapistack.com/data/apimetrics/apimetrics-workflows-api-swagger.json">oadf</a>)
...
<p><strong><a href="https://apimetrics.readme.io/">APIMetrics Tokens API</a></strong>&nbsp;(<a href="http://theapistack.com/data/apimetrics/apimetrics-workflows-api-swagger.json">oadf</a>)
...
<p><strong><a href="https://apimetrics.readme.io/">APIMetrics Workflows API</a></strong>&nbsp;(<a href="http://theapistack.com/data/apimetrics/apimetrics-workflows-api-swagger.json">oadf</a>)
