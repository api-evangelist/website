...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/slashdb-new-logo-sideways-medium.png
---

<p><a href="http://www.slashdb.com/"><img style="padding: 20px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/slashdb-new-logo-sideways-medium.png" alt="" width="250" align="right" /></a>
...
<p>As I was monitoring the space yesterday I came across the&nbsp;<a href="https://rankingdigitalrights.org/">Ranking Digital Rights 2015 Corporate Accountability Index</a>, which <em>"evaluates 16 of the world&rsquo;s most powerful Internet and telecommunications companies on their disclosed commitments, policies, and practices that affect users&rsquo; freedom of expression and privacy."</em>--<a href="https://rankingdigitalrights.org/index2015/download/">I saw there was an excel and CSV versions of the report</a>, but I didn't see an API, so I tweeted out:
<p><span><br /></span>
<blockquote class="twitter-tweet" lang="en">
<p dir="ltr" lang="en">Done <a href="https://twitter.com/kinlane">@kinlane</a> <a href="https://t.co/f69iFoYgDJ">https://t.co/f69iFoYgDJ</a>
...
<p>Victor Olex (<a href="https://twitter.com/agilevic">@agilevic</a>) from <a href="http://www.slashdb.com/">SlashDB</a>, turned around an API endpoint in a matter of a couple of hours. Here is what Victor sent me:
<p class="p1" style="padding-left: 30px;"><em><span class="s1">I took your Twitter challenge and created the API for Ranking Digital Rights data. The data model does not include scores for individual lines of business, but it does have all qualitative data needed to make sense of it. I did not write any data aggregation queries, but we can add those later. The whole thing works off a MySQL database model, which I designed and fed with data from the spreadsheet.</span></em>
<p><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/slashdb-ranking-digital-rights-diagram" alt="" width="100%" />
<p>Using SlashDB, Victor quickly generated the following endpoints for quick access to the digital rights data behind the report:
<ul>
...
<p>These are very resource oriented API endpoints, meaning they look like the raw resource they are generated from, but it demonstrates the value of using cloud services like SlashDB to do a lot of the heavy lifting for you when deploying an API. Getting an API up and running, so that you can start building web, mobile, data visualizations, and other tooling is an important first step--then you can also start iterating on, and begin the process of defining the next generation endpoints.
<p>As you can see the SlashDB interface allows me to dill down using the URL, referencing the databases, relationships, and other resources that are exposed. What I like about SlashDB, is it lets you navigate the resources and relationships through the generated HTML pages, and then retrieve the XML or JSON you will need.&nbsp;
...
<p>Thanks to&nbsp;Victor Olex (<a href="https://twitter.com/agilevic">@agilevic</a>) and&nbsp;<a href="http://www.slashdb.com/">SlashDB</a>&nbsp;more doing this important work--you guys rock!!
