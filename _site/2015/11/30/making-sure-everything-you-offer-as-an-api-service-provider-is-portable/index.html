...
<p><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/runscope-api-tests.png" alt="" width="325" align="right" />
<p><a href="http://blog.runscope.com/posts/manage-api-tests-your-way-with-seamless-new-import-export-features">Runscope added the ability to import and export your API tests as JSON</a>, helping make API monitoring a much more flexible and portable thing. You can import and export using the Runscope UI, as well as import via their API, help you automate the setup of your API tests.&nbsp;
