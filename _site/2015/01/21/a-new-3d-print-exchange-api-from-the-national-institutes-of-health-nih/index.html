...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/NIH-3D-Print-Exchange.png
---

<p><a href="https://niaid.github.io/3dpx_api/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/NIH-3D-Print-Exchange.png" alt="" width="250" align="right" /></a>
<p>There is an very interesting new 3D Print Exchange API from the <a href="https://www.nih.gov/">National Institutes of Health (NIH)</a>. The NIH 3D Print Exchange is designed for publishing "biomedically-relevant" 3D models, that anyone can download and use as blueprint for printing on a their 3D printer.
