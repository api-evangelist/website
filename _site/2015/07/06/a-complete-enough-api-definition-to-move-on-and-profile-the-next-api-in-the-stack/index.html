...
<p><a href="http://theapistack.com/"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-stacks.png" alt="" width="115" align="right" /></a>
...
<tbody>
<tr>
<td width="50" align="center"><a id="home-logo-link-152" href="http://www.alchemyapi.com/"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/company/logos/alchemy-api-logo.png" alt="" width="150" align="left" /></a></td>
<td align="left"><a id="home-name-link-152" href="http://www.alchemyapi.com/"><strong>AlchemyAPI</strong></a></td>
<td width="50" align="center"><a id="home-icon-152" title="Website" href="http://www.alchemyapi.com/" target="_blank"><img id="home-icon-img-152" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-home-icon.jpeg" alt="" width="18" align="middle" /></a></td>
<td width="50" align="center"><a id="blog-icon-152" title="Blog" href="http://blog.alchemyapi.com/" target="_blank"><img id="blog-icon-img-152" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-blog-icon.png" alt="" width="18" align="middle" /></a></td>
<td width="50" align="center"><a id="blogrss-icon-152" title="Blog RSS" href="http://blog.alchemyapi.com/rss.xml" target="_blank"><img id="blogrss-icon-img-152" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-rss-icon.png" alt="" width="18" align="middle" /></a></td>
<td width="50" align="center"><a id="twitter-icon-152" title="Twitter" href="https://twitter.com/alchemyapi" target="_blank"><img id="twitter-icon-img-152" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-twitter-icon.png" alt="" width="23" align="middle" /></a></td>
<td width="50" align="center"><a id="github-icon-152" title="Github" href="https://github.com/AlchemyAPI" target="_blank"><img id="github-icon-img-152" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-github-icon.png" alt="" width="25" align="middle" /></a></td>
<td width="50" align="center"><a id="apisjson-icon-152" title="APIs.json" href="http://theapistack.com/data/alchemyapi/apis.json" target="_blank"><img id="apisjson-icon-img-152" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-api-a.png" alt="" width="25" align="middle" /></a>(<a id="ask-swagger-link-152" title="Ask Swagger Questions" href="http://theapistack.com/ask-swagger-questions.html?apisjson_url=http://theapistack.com/data/alchemyapi/apis.json" target="_blank">swagger</a>) (<a id="ask-apisjson-link-152" title="Ask APIs.json Questions" href="http://theapistack.com/ask-apis-json-questions.html?apisjson_url=http://theapistack.com/data/alchemyapi/apis.json" target="_blank">apis.json</a>)</td>
<td width="50" align="center"><a id="sdksio-icon-152" title="SDKs.io" href="https://sdks.io/SDK/View/alchemyapi" target="_blank"><img id="sdksio-icon-img-152" src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/sdks-io/sdks-io-icon.png" alt="" width="25" align="middle" /></a></td>
<td width="50" align="center"><a id="sdksio-icon-152" title="Postman Collection" href="https://raw.githubusercontent.com/api-stack/api-stack/gh-pages/data/alchemyapi/alchemy-api-postman-collection.json" target="_blank"><img id="sdksio-icon-img-152" src="https://s3.amazonaws.com/kinlane-productions2/building-blocks/x-postman.png" alt="" width="25" align="middle" /></a></td>
</tr>
<tr>
<td width="50" align="center">&nbsp;</td>
<td colspan="4" align="left">Alchemy Author Extraction API</td>
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/author-extraction/" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
<td width="50" align="center"><a title="Swagger" href="http://theapistack.com/data/alchemyapi/alchemy-author-extraction-api-swagger.json" target="_blank"><img src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-swagger-round.png" alt="" width="25" /></a><a title="Edit Swagger" href="http://theapistack.com/editor-swagger-json.html?swaggerurl=http://theapistack.com/data/alchemyapi/alchemy-author-extraction-api-swagger.json" target="_blank">(edit)</a></td>
<td width="50" align="center">&nbsp;</td>
<td width="50" align="center">&nbsp;</td>
<td width="50" align="center">&nbsp;</td>
</tr>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/authors-extraction" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/combined-call" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/concept-tagging" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/entity-extraction" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/face-detection" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/feed-detection" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/image-link-extraction" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/keyword-extraction/" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/language-detection" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/microformats-parsing" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://docs.alchemyapi.com/" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/publication-date" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/relation-extraction" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/sentiment-analysis" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/taxonomy" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/text/urls.html#rtext" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/text-extraction/" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<td width="50" align="center"><a title="Documentation" href="http://www.alchemyapi.com/api/text/urls.html#title" target="_blank"><img src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/building-blocks/bw-list.png" alt="" width="25" /></a></td>
...
<p>My goal was to index the AlchemyAPI operations using an APIs.json file, while define each of the APIs using Swagger. I want each Swagger definition to be as complete as possible, so I can actually generate functional APIMATIC SDKs, and function Postman Collections--something I have achieved here.&nbsp;
...
<p>Each API could potentially be missing some parameters, and the definitions may still have some flaws (if you see any, feel free to fork and fix ;-). Shit, now I remembered I forgot to reference all the sub-models in some of the API data models. Oh well, will add to the list to be done, and get it tackled.&nbsp;
...
<p>Ok, well anyways..on to the next microproject (tm). I have an overhaul on my API Design white paper almost complete, and then I think I will tackle the profiling of Angelist and the Crunchbase API--two APIs I depend on to run API Evangelist. &nbsp;
<p><em>P.S. One thing I also liked about the Alchemy API, is how easy it was to break the APIs down into the small possible units of value, and provide a single Swagger definition for each API. I think I will also provide a single Swagger specification for all of them, but for now I'll rely on the APIs.json index to link them together.</em>
