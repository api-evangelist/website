...
<p><a href="http://design.apievangelist.com/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/api-design-guide.png" alt="" width="250" align="right" /></a>
<p><a href="http://design.apievangelist.com/">I recently went through my API design research</a>, updating and evolving it, to help me better understand changes in the API design space, while also sharing as much of the information as I can with my readers. <a href="http://design.apievangelist.com/tools.html">One of the resources I include under my tools section are the increasing number of API design guides being published</a>.&nbsp;
...
<p style="padding-left: 30px;"><em>Purpose of this style guide is to gather a list of rules, best practices, resources and our way of creating REST APIs in Haufe Group. The style guide addresses API Designers, mostly developers and architects, who want to design an API. Intention is to ease the design process by providing helpful rules to create a successful API that your customers will love.</em>
...
<p><span>The design guide leads with some very sound API wisdom:</span>
<ul>
