...
<p><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-questions-ask.png" alt="" width="250" align="right" />
...
<p>To begin with I compiled almost 60 of the most common questions I ask about APIs, and launched an API to support the adding, editing, and modifying of these questions. I broken these questions down into two groups:
<ul>
...
<p>I have started apply an api-questions approach to the APIs that I depend on to run API Evangelist. You can see this in action with the Alchemy API. I ask the same two groups of questions:
<ul>
...
<p>When applied to API operations, api-questions takes on a different lens when you are looking at external APIs, but when applied to your own internal APIs it changes views again, and helps you understand potentially where the gaps are, and helps you establish a checklist for overall operations.&nbsp;
