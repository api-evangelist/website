...
image: http://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/apimatic-sdks.png
---

<p><a href="https://apimatic.io/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/blog/apimatic-sdks.png" alt="" width="35%" align="right" /></a>
<p>One of the discussions we are having <a href="http://apiware.io/">behind the scenes at APIWare.io</a>, is whether we should be hand-crafting, or auto-generating SDKs for the clients we are working with on the design, deployment, and management of their APIs.&nbsp;
<p>The answer is easy--we do both!&nbsp;
<p>There are many situations where I would push for the <a href="http://sdk.apievangelist.com/">API SDKs</a> to be hand-crafted, and designed for a specific API, as well as specific language or platform. However, with the increase in the number of APIs, and simplicity of some of the APIs I work with, crafting an API definition, and <a href="https://apimatic.io/">auto-generating your SDKs using a service like APIMATIC</a>, makes sense.
...
<p>Are you trying to figure out the best path forward for providing high quality SDKs for your API?Llet me know how my APIWare team can help. They are willing to help you figure out the best route for providing the SDKs you need, but also help maintain them as part of the versioning, and overall roadmap for your API operatins. Even if you just need someone to talk through the pros and cons, I am here to help--let me know.
