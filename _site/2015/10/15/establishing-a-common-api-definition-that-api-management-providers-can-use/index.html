...
<p><a href="https://www.3scale.net/"><img style="padding: 15px;" src="https://kinlane-productions2.s3.amazonaws.com/api-evangelist-site/serviceproviders/3scale-logo.jpg" alt="" width="300" align="right" /></a>
<p class="p1"><a href="http://apievangelist.com/2015/10/13/bringing-api-building-blocks-to-life-as-the-apis-of-service-providers/">I mentioned the concept of what I call API building blocks coming to life by API service providers yesterday</a>. These are the features provided from API service providers that are made accessible via APIs. Mind blowing right? API service providers having APIs? Which then allows API providers to programmatically manage the operations of their own APIs? Who would have ever thought!! Actually it is a pretty clear example of API service providers who are kind of full of it, when they do not offer their own APIs--meaning they are telling you about the importance of APIs, but not actually practicing what they preach. It is kind of like API providers who do not use their own APIs in their applications (dogfooding).
<p class="p1">Anyhoo. <a href="http://apievangelist.com/">I have done a lot of work to define the common building blocks across API service providers, spanning over 17 stops along the API lifecycle</a>, and part of the next phase of my research is to connect these building blocks to actual API definitions that can help automate these vital API features. First up, <a href="https://support.3scale.net/reference/active-docs">I took the 3Scale API, and generated this list of common building blocks represented in the API for their API infrastructure</a>.
<p class="p1"><strong>Authorization</strong>
<ul>
...
<p><strong>Authorization + Reporting</strong>
<ul>
...
<p class="p1"><strong>Account Management</strong>
<ul>
...
<li><strong>Account Plan List</strong>(GET) - Returns the list of all available account plans</li>
...
<p><strong>Application Management</strong>
<ul>
...
<li><strong>Application key Delete</strong>(DELETE) - Deletes an key of an application (valid only on the authentication mode app_id/app_key or oauth)</li>
...
<p class="p1"><strong>User Management</strong>
<ul>
...
<li><strong>User Read</strong> (provider account)(GET) - Gets the user of the provider account by id</li>
...
<p class="p1"><strong>Analytics</strong>
<ul>
...
<p class="p1"><strong>Service Management</strong>
<ul>
...
<p class="p1"><strong>Billing Management</strong>
<ul>
<li><strong>Invoice List by Account</strong>(GET) - Returns the list of all invoices by account</li>
