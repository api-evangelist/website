...
<p><img style="padding: 10px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-two-way-arrows.png" alt="" width="150" align="right" />
...
<p>After spending a couple hours looking through my core research, I found the following service providers, in the follow areas, actually had web APIs available:
<table width="100%">
<tbody>
<tr>
<td valign="top">
...
<ul>
<li><a href="https://docs.aws.amazon.com/apigateway/api-reference/">Amazon API Gateway</a></li>
...
<li><a href="https://kubernetes.io/v1.0/api-ref.html">Kubernetes</a></li>
</ul>
</li>
...
<li><a href="https://docs.aws.amazon.com/Route53/latest/APIReference/Welcome.html">AWS Route 53</a></li>
...
<li><a href="https://apigee.com/docs/management/apis">Apigee</a></li>
<li><a href="https://tyk.io/advanced-api-v0-9/api-definitions/">Tyk</a></li>
...
<li><a href="https://doers.statuspage.io/">Status Page</a></li>
</ul>
</li>
...
<p>Every potential stage of the API life-cycle will have to be automated in the future, and ironically APIs will be how we do that.
