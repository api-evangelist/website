...
<p><a href="http://monetization.apievangelist.com"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-api-monetization-strategy.png" alt="" width="250" align="right" /></a>
...
<p>I need to keep hammering on this to help me operate my own infrastructure, but I am also partnering with <a href="http://apiware.io/">APIWare to help me deliver on much of the API design, deployment, and management</a>, so I need to have a good handle on my costs. As with all of my areas of research, within the area of <a href="http://monetization.apievangelist.com/">API monetization</a> I am just trying to get a handle on the common building blocks, and provide a checklist of considerations to be employed when I'm planning and operating my API infrastructure.
<p>To help me build a base, let's walk through some of the building blocks of my own API monetization strategy.
<p><strong>Acquisition</strong><br />What do I have invested into any single API. Even if I am building something from scratch, what went into it? Every API I possess has some sort of acquisition cost, even if it is just $14.00 for the two pints of beer I bought while I was brainstorming the idea.
<ul>
...
<p>Historically when it came to APIs, I just dove into writing code with little consideration for what went into it. I'd say this is one by-product of the microservices way of thinking, is that I decoupled the moving parts of each of my APIs, allowing me to approach development in this way. I'm sure I will keep slicing off other elements within the development process as I progress.
...
<li><strong>Partner</strong>&nbsp;- These are partners I have prearranged agreements with, something I will be transparent about, showcasing them on partner page.</li>
...
<p><strong>Indirect Value Generation<br /></strong>What value is generated via API operations that isn't directly monetized, but driving value in other ways. These indirect value generators are often overlooked, and under-showcased areas of operation, often resulting in API failure--always showcase the buzz.
<ul>
...
<p><strong>Partner Revenue Generation<br /></strong>Ideally any platform should be sharing the revenue and value exhaust generated via the ecosystem, providing revenue opportunities for web, and mobile application developers. There are a handful of ways revenue can be shared via API operations.
<ul>
...
<p><a href="http://monetization.apievangelist.com/building-blocks.html"><img style="padding: 15px;" src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-building-blocks-monetization.png" alt="" width="250" align="right" /></a>
