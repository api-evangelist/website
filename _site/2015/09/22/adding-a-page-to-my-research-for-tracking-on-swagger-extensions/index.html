...
<p><a href="http://swagger.io/"><img src="https://s3.amazonaws.com/kinlane-productions2/api-evangelist/swagger/bw-swagger-round.png" alt="" width="125" align="right" /></a>
<p><a href="http://swagger.apievangelist.com">I have a research project dedicated to trying to understand al things Swagger.</a> I try to add any new research, or tooling there when I can. The latest thing I added was a page to list out Swagger extensions that I find in the wild.
...
<p><a href="http://swagger.apievangelist.com/extensions/index.html">Hopefully we can start centralizing all the innovative extensions of Swagger into a single location</a>, helping us all not re-invent the wheel when it comes to extending the popular API definition format, affectionately known as Swagger.
