...
<p><img src="https://s3.amazonaws.com/kinlane-productions2/bw-icons/bw-testing.png" align="right" width="35%" style="padding: 15px" />
...
<ul>
  ...
  <li><a href="https://www.postman.com/docs/postman/scripts/test_scripts">Postman Testing</a> - With Postman you can write and run tests for each request using the JavaScript language.</li>
